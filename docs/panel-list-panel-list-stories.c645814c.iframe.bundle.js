"use strict";
(self["webpackChunkbrowser_storybook"] = self["webpackChunkbrowser_storybook"] || []).push([[4006],{
...
/* harmony export */ });
/* harmony import */ var _panel_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10815);
...
function openMenu(event) {
  if (event.type == "mousedown" || event.inputSource == MouseEvent.MOZ_SOURCE_KEYBOARD || !event.detail) {
...
const Template = ({
  ...
  return item == "<hr>" ? _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html` <hr /> ` : _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html`
              <panel-item
                ...
                ?badged=${item.badged}
                accesskey=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(item.accesskey)}
...
//# sourceMappingURL=panel-list-panel-list-stories.c645814c.iframe.bundle.js.map