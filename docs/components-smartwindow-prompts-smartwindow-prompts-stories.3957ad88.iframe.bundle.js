"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[751,6284,9240,9417],{
...
class SmartWindowPrompts extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  #scrollToAdjacentPill(toEnd) {
    ...
    const isAtOrPastStart = rect => isRtl ? rect.right <= startEdge + 1 : rect.left >= startEdge - 1;
    const currentIndex = pills.findIndex(pill => isAtOrPastStart(pill.getBoundingClientRect()));

    // Clamp at either end rather than wrapping.
    const targetIndex = Math.min(Math.max((currentIndex === -1 ? 0 : currentIndex) + (toEnd ? 1 : -1), 0), pills.length - 1);
    pills[targetIndex].scrollIntoView({
      inline: "start",
      block: "nearest"
    });
  }
  ...
  #promptDismissed(e, swPrompt) {
    e.stopPropagation();
    this.dispatchEvent(new CustomEvent("SmartWindowPrompt:prompt-dismissed", {
      detail: {
        memory: swPrompt.memory
      },
      bubbles: true,
  ...
  #renderFavicons(previewIcons) {
    ...
    const visibleIcons = previewIcons.slice(0, showOverflow ? MAX_VISIBLE_FAVICONS - 1 : MAX_VISIBLE_FAVICONS);
    const overflowCount = previewIcons.length - visibleIcons.length;
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <span class="sw-prompt-favicons">
        ${visibleIcons.map(icon => (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
            <img
      ...
      e.target.src = "chrome://global/skin/icons/defaultFavicon.svg";
            ...
            />
          `)}
        ${showOverflow ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<span class="sw-prompt-favicon-overflow"
              >+${overflowCount}</span
  ...
  #renderScrollButtons() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ${this.canScrollStart ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
            <moz-button
            ...
            ></moz-button>
          ` : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
      ${this.canScrollEnd ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
            <moz-button
  ...
  #renderPrompt(swPrompt) {
    const pillButton = (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <moz-button
  ...
  render() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      "can-scroll-end": this.canScrollEnd
        ...
        >
          ${this.prompts.map(swPrompt => swPrompt.type === "skeleton" ? this.#renderSkeletonPrompt() : this.#renderPrompt(swPrompt))}
        </div>
...
module.exports = __webpack_require__.p + "smartwindow-prompts.5eff0bbd9f085c52545b.css";
...
/* harmony export */   FullpageScrollableOverflow: () => (/* binding */ FullpageScrollableOverflow),
/* harmony export */   FullpageWithFavicons: () => (/* binding */ FullpageWithFavicons),
...
const manyPrompts = [{
  ...
  text: "Proofread a message",
  type: "chat"
}, {
  text: "Simplify a topic",
  type: "chat"
}, {
  text: "Help make a plan",
  type: "chat"
}, {
  text: "Find tabs in history",
  type: "chat"
}, {
  text: "Compare tabs",
  type: "chat"
...
const FullpageWithFavicons = Template.bind({});
...
const FullpageScrollableOverflow = Template.bind({});
...
//# sourceMappingURL=components-smartwindow-prompts-smartwindow-prompts-stories.3957ad88.iframe.bundle.js.map