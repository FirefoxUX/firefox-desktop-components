...
module.exports = __webpack_require__.p + "ai-sff-tab-selector.6590bc2202a93a1a852e.css";
...
class AiSffTabSelector extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.MozLitElement {
  ...
  #renderTabList(tabLabelFluentId, tabs, selectedTabCount, scrollable = false) {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
      <moz-box-group
        type="list"
        class=${scrollable ? "tab-selector-tabs-scrollable ai-smart-form-fill-other-tabs" : "ai-smart-form-fill-suggested-tabs"}
      >
  ...
  render() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
      ...
      <div class="tab-selector-dialog">
        ...
        ${this.suggestedTabs?.length ? this.#renderTabList("ai-smart-form-fill-suggested-tabs", this.suggestedTabs, selectedTabCount) : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.nothing}
        ${this.otherTabs?.length ? this.#renderTabList("ai-smart-form-fill-other-tabs", this.otherTabs, selectedTabCount, true) : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.nothing}
...
//# sourceMappingURL=components-ai-sff-tab-selector-ai-sff-tab-selector-stories.bef13cbf.iframe.bundle.js.map