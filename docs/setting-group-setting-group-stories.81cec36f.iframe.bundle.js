...
class SettingControl extends chrome_browser_content_preferences_widgets_setting_element_mjs__WEBPACK_IMPORTED_MODULE_1__.SettingElement {
  ...
  get disabled() {
    return this.setting?.disabled || this.setting?.locked || this.isDisabledByExtension();
  }
    ...
    if (this.isControlledByExtension()) {
      ...
      >
        ${supportPage ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<a
            ...
            ></a>` : ""}
        ${this.setting.controllingExtensionInfo.mayDisable ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-button
              slot="actions"
...
module.exports = __webpack_require__.p + "moz-input-text.6f41a9a9bd5be8ef161b.css";
...
module.exports = __webpack_require__.p + "moz-input-folder.ee9bff07e3f40989d895.css";
...
function expandPaneName(category) {
  return category ? `pane${category[0].toUpperCase()}${category.slice(1)}` : undefined;
}
...
class SettingElement extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.MozLitElement {
  ...
  getCommonPropertyMapping(config) {
    ...
    return {
      ...
      slot: config.slot,
      headinglevel: bumpHeadingLevelForSrd(config.headingLevel, lazy.srdEnabled),
      ...controlAttrs
    };
  }
}
...
/* harmony import */ var chrome_browser_content_preferences_config_SettingGroupManager_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(884);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
class SettingGroup extends chrome_browser_content_preferences_widgets_setting_element_mjs__WEBPACK_IMPORTED_MODULE_1__.SettingElement {
  ...
  connectedCallback() {
    ...
    this.#unsubscribeGroupRegister = chrome_browser_content_preferences_config_SettingGroupManager_mjs__WEBPACK_IMPORTED_MODULE_3__.SettingGroupManager.onRegister(id => {
  ...
  containerTemplate(content) {
    if ((this.srdEnabled || this.inSubPane || this.config.card == "always") && this.config.card != "never") {
      return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-card role="presentation">${content}</moz-card>`;
    }
    return content;
  }
  render() {
    ...
    return this.containerTemplate((0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-fieldset
        ...
        ${(0,chrome_browser_content_preferences_widgets_setting_element_mjs__WEBPACK_IMPORTED_MODULE_1__.spread)(this.getCommonPropertyMapping(config))}
...
//# sourceMappingURL=setting-group-setting-group-stories.81cec36f.iframe.bundle.js.map