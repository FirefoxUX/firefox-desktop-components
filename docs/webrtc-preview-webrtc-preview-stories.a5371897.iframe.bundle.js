"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2524,8456],{
...
/* harmony import */ var _webrtc_preview_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35227);
...
const lazy = {};
XPCOMUtils.defineLazyPreferenceGetter(lazy, "testGumDelayMs", "privacy.webrtc.preview.testGumDelayMs", 0);
window.MozXULElement?.insertFTLIfNeeded("browser/webrtc-preview.ftl");
...
class WebRTCPreview extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  #dispatchTestEvent(result) {
    if (lazy.testGumDelayMs > 0) {
      this.dispatchEvent(new CustomEvent("test-preview-complete", {
        detail: {
          result
        }
      }));
...
//# sourceMappingURL=webrtc-preview-webrtc-preview-stories.a5371897.iframe.bundle.js.map