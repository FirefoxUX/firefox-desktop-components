...
class MozBrowser extends MozElements.MozElementMixin(XULFrameElement) {
  ...
  updateWebNavigationForLocationChange(aCanGoBack, aCanGoBackIgnoringUserInteraction, aCanGoForward) {
    if (this.isRemoteBrowser && this.messageManager && !Services.appinfo.sessionHistoryInParent) {
      this._remoteWebNavigation._canGoBack = aCanGoBack;
      this._remoteWebNavigation._canGoBackIgnoringUserInteraction = aCanGoBackIgnoringUserInteraction;
  ...
  purgeSessionHistory() {
    ...
    try {
      ...
      this.sendMessageToActor("Browser:PurgeSessionHistory", {}, "PurgeSessionHistory", "roots");
    } catch (ex) {
...
//# sourceMappingURL=3184.377eaec3.iframe.bundle.js.map