"use strict";
(self["webpackChunkbrowser_storybook"] = self["webpackChunkbrowser_storybook"] || []).push([[5054],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n[slot=\"main\"] {\n  display: flex;\n  gap: 40px;\n  align-items: center;\n  padding: 36px;\n}\n\n[slot=\"main\"].selectedTab {\n  flex-direction: column;\n  text-align: center;\n  gap: 22px;\n}\n\n[slot=\"main\"].selectedTab .header {\n  justify-content: center;\n}\n\n.image {\n  -moz-context-properties: fill, stroke, fill-opacity;\n  fill: var(--fxview-background-color-secondary);\n  stroke: var(--fxview-text-primary-color);\n}\n\n.header {\n  margin-block: 0;\n  font-size: 1.46rem;\n  font-weight: 400;\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.icon[hidden], .header[hidden] {\n  display: none;\n}\n\n.icon {\n  background-position: center center;\n  background-repeat: no-repeat;\n  display: inline-block;\n  width: 20px;\n  height: 20px;\n}\n\n.info {\n  -moz-context-properties: fill;\n  fill: var(--in-content-primary-button-background);\n}\n\n.description {\n  color: var(--text-color-deemphasized);\n  margin-block: 4px 0;\n}\n\n.description.secondary {\n  margin-block-start: 16px;\n}\n\n.main a {\n  color: var(--fxview-primary-action-background);\n}\n", "",{"version":3,"sources":["webpack://./../firefoxview/fxview-empty-state.css"],"names":[],"mappings":"AAAA;;6DAE6D;;AAE7D;EACE,aAAa;EACb,SAAS;EACT,mBAAmB;EACnB,aAAa;AACf;;AAEA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,SAAS;AACX;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,mDAAmD;EACnD,8CAA8C;EAC9C,wCAAwC;AAC1C;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;EACnB,QAAQ;AACV;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,kCAAkC;EAClC,4BAA4B;EAC5B,qBAAqB;EACrB,WAAW;EACX,YAAY;AACd;;AAEA;EACE,6BAA6B;EAC7B,iDAAiD;AACnD;;AAEA;EACE,qCAAqC;EACrC,mBAAmB;AACrB;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,8CAA8C;AAChD","sourcesContent":["/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n[slot=\"main\"] {\n  display: flex;\n  gap: 40px;\n  align-items: center;\n  padding: 36px;\n}\n\n[slot=\"main\"].selectedTab {\n  flex-direction: column;\n  text-align: center;\n  gap: 22px;\n}\n\n[slot=\"main\"].selectedTab .header {\n  justify-content: center;\n}\n\n.image {\n  -moz-context-properties: fill, stroke, fill-opacity;\n  fill: var(--fxview-background-color-secondary);\n  stroke: var(--fxview-text-primary-color);\n}\n\n.header {\n  margin-block: 0;\n  font-size: 1.46rem;\n  font-weight: 400;\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.icon[hidden], .header[hidden] {\n  display: none;\n}\n\n.icon {\n  background-position: center center;\n  background-repeat: no-repeat;\n  display: inline-block;\n  width: 20px;\n  height: 20px;\n}\n\n.info {\n  -moz-context-properties: fill;\n  fill: var(--in-content-primary-button-background);\n}\n\n.description {\n  color: var(--text-color-deemphasized);\n  margin-block: 4px 0;\n}\n\n.description.secondary {\n  margin-block-start: 16px;\n}\n\n.main a {\n  color: var(--fxview-primary-action-background);\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_fxview_empty_state_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12422);
...
var update = _storybook_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_fxview_empty_state_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_fxview_empty_state_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
//# sourceMappingURL=5054.866dd20a.iframe.bundle.js.map