    ...
    this.addEventListener("drop", event => {
      ...
      if (contentAnalysis.isActive) {
        ...
        try {
          ...
          contentAnalysis.analyzeContentRequests([request], true).then(caResult => {
            dragSession.sendDispatchToDropTargetAndResumeEndDragSession(caResult.shouldAllowContent);
          }, () => {
...
//# sourceMappingURL=660.7327c4b7.iframe.bundle.js.map