...
class MozReorderableList extends _lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  onDrop(event) {
    ...
    this.emitEvent(REORDER_EVENT, {
      ...
      insertAt: (position < 0 ? targetIndex : targetIndex + 1) - (draggedIndex < targetIndex ? 1 : 0)
    });
    this.onDragEnd();
  }
  onDragEnd() {
...
module.exports = __webpack_require__.p + "moz-reorderable-list.733ae42c942b05dd3684.css";

/***/ })

}]);
//# sourceMappingURL=moz-reorderable-list-moz-reorderable-list-stories.beee01cf.iframe.bundle.js.map