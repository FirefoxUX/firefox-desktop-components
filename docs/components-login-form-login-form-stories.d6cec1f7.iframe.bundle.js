...
class LoginForm extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  #normalizeOrigin() {
    ...
    const normalized = originValue && !originValue.match(/:\/\//) ? `https://${originValue}` : originValue;
...
//# sourceMappingURL=components-login-form-login-form-stories.d6cec1f7.iframe.bundle.js.map