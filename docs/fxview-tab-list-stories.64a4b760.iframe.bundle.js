...
/* harmony import */ var _helpers_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(58474);
/* harmony import */ var chrome_global_content_elements_moz_button_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(99053);
    ...
    return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`
      ...
      >
        ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
          ...
          `,
          () =>
            chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`${this.tabItems.map((tabItem, i) =>
...
class FxviewTabRowBase extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  highlightSearchMatches(query, string) {
    const fragments = [];
    const regex = RegExp((0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_4__.escapeRegExp)(query), "dgi");
    let prevIndexEnd = 0;
    let result;
    while ((result = regex.exec(string)) !== null) {
      ...
      fragments.push(
        chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`<strong>${string.substring(indexStart, indexEnd)}</strong>`
      );
  ...
  secondaryButtonTemplate() {
    return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
      this.secondaryL10nId && this.secondaryActionHandler,
      () => chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`<moz-button
        type="icon ghost"
  ...
  render() {
    return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`
      ...
      >
        ...
        ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.when)(
          !this.compact,
          () => chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html`${this.urlTemplate()} ${this.dateTemplate()}
          ${this.timeTemplate()}`
        )}
      </a>
...
module.exports = __webpack_require__.p + "fxview-tab-row.60f23b4680bce8a4cf61.css";
...
//# sourceMappingURL=fxview-tab-list-stories.64a4b760.iframe.bundle.js.map