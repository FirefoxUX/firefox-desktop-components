"use strict";
(self["webpackChunkbrowser_storybook"] = self["webpackChunkbrowser_storybook"] || []).push([[5727],{
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(chrome://browser/content/usercontext/usercontext.css);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n#name {\n  -moz-box-flex: 1;\n}\n\n.radio-buttons {\n  -moz-box-orient: horizontal;\n  margin-inline-start: 0.35rem;\n}\n\n.radio-buttons > radio {\n  user-select: none;\n  outline: 2px solid transparent;\n  outline-offset: 4px;\n  min-block-size: 24px;\n  min-inline-size: 24px;\n  border-radius: 50%;\n  padding: 2px;\n  margin: 9px;\n}\n\n.icon-buttons > radio > .userContext-icon {\n  fill: var(--in-content-text-color);\n}\n\n.radio-buttons > radio {\n  padding-inline-start: 2px;\n}\n\nradio > .userContext-icon {\n  inline-size: 22px;\n  block-size: 22px;\n}\n\n.radio-buttons > radio[selected=true] {\n  outline-color: var(--in-content-text-color);\n}\n\n.radio-buttons > radio[focused=true] {\n  outline-color: var(--in-content-accent-color);\n}\n\n.radio-buttons > radio:hover:active {\n  outline-color: var(--in-content-accent-color-active);\n}\n", "",{"version":3,"sources":["webpack://./../../themes/shared/preferences/containers-dialog.css"],"names":[],"mappings":"AAAA;;6DAE6D;;AAI7D;EACE,gBAAgB;AAClB;;AAEA;EACE,2BAA2B;EAC3B,4BAA4B;AAC9B;;AAEA;EACE,iBAAiB;EACjB,8BAA8B;EAC9B,mBAAmB;EACnB,oBAAoB;EACpB,qBAAqB;EACrB,kBAAkB;EAClB,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,kCAAkC;AACpC;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;AAClB;;AAEA;EACE,2CAA2C;AAC7C;;AAEA;EACE,6CAA6C;AAC/C;;AAEA;EACE,oDAAoD;AACtD","sourcesContent":["/* Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n@import url(\"chrome://browser/content/usercontext/usercontext.css\");\n\n#name {\n  -moz-box-flex: 1;\n}\n\n.radio-buttons {\n  -moz-box-orient: horizontal;\n  margin-inline-start: 0.35rem;\n}\n\n.radio-buttons > radio {\n  user-select: none;\n  outline: 2px solid transparent;\n  outline-offset: 4px;\n  min-block-size: 24px;\n  min-inline-size: 24px;\n  border-radius: 50%;\n  padding: 2px;\n  margin: 9px;\n}\n\n.icon-buttons > radio > .userContext-icon {\n  fill: var(--in-content-text-color);\n}\n\n.radio-buttons > radio {\n  padding-inline-start: 2px;\n}\n\nradio > .userContext-icon {\n  inline-size: 22px;\n  block-size: 22px;\n}\n\n.radio-buttons > radio[selected=true] {\n  outline-color: var(--in-content-text-color);\n}\n\n.radio-buttons > radio[focused=true] {\n  outline-color: var(--in-content-accent-color);\n}\n\n.radio-buttons > radio:hover:active {\n  outline-color: var(--in-content-accent-color-active);\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _components_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_containers_dialog_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(89124);
...
var update = _components_storybook_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_components_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_containers_dialog_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_components_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_containers_dialog_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
//# sourceMappingURL=5727.60ebb0e1.iframe.bundle.js.map