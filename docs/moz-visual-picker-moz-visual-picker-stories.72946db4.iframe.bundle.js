...
class MozVisualPickerItem extends (0,_lit_select_control_mjs__WEBPACK_IMPORTED_MODULE_2__.SelectControlItemMixin)(_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement) {
  ...
  textTemplate() {
    ...
    const labelElement = this.labelPosition == "outside" ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<label class="label" for="picker-item">${this.label}</label>` : (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<p class="label">${this.label}</p>`;
...
module.exports = __webpack_require__.p + "moz-visual-picker-item.ca8c544b7487e41014a7.css";
...
//# sourceMappingURL=moz-visual-picker-moz-visual-picker-stories.72946db4.iframe.bundle.js.map