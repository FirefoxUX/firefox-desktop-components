...
/* harmony import */ var _tokens_storybook_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45881);
    ...
    return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`
      <td>
        <div class="preview-wrapper">
          ${type == "preview"
            ? chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`${this.getTemplate(raw ?? value, tokenName)}`
            : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`<p class="value">${value}</p>
...
//# sourceMappingURL=tokens-table-stories.53e9254e.iframe.bundle.js.map