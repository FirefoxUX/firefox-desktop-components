...
/* harmony import */ var _tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40224);
...
class TablesPage extends chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  constructor() {
    super();
    this.surface = "brand";
    this.tokensData = _tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__.tokensTable;
  }
      ...
      <div class="page-wrapper">
        <div class="filters-wrapper">
          ...
          <div class="table-filter" @click=${this.handleTableFilterClick}>
            ...
            ${Object.keys(_tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__.tokensTable).map(table => {
...
class TokensTable extends chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  ...
  getRawValue(theme, token) {
    ...
    if (matches) {
      let variableValue = _tokens_table_mjs__WEBPACK_IMPORTED_MODULE_1__.variableLookupTable[matches.groups?.lookupKey];
...
module.exports = __webpack_require__.p + "tokens-table.201670fcb82d51b5b951.css";

/***/ })

}]);
//# sourceMappingURL=tokens-table-stories.874dc5f1.iframe.bundle.js.map