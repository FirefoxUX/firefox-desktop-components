"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[160,226,1279,2776,4920,5865,5944,6284,7752,7912,8102,8400,9240,9417],{
...
module.exports = __webpack_require__.p + "moz-input-text.ceeaaf7d12526fafc511.css";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DEFAULT_MONITOR_ERROR_L10N_ID: () => (/* binding */ DEFAULT_MONITOR_ERROR_L10N_ID),
/* harmony export */   MONITOR_ERROR_L10N_IDS: () => (/* binding */ MONITOR_ERROR_L10N_IDS),
/* harmony export */   monitorErrorL10nId: () => (/* binding */ monitorErrorL10nId)
/* harmony export */ });
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 ...
 */
const MONITOR_ERROR_L10N_IDS = Object.freeze({
 ...
 */
function monitorErrorL10nId(errorCode) {
...
module.exports = __webpack_require__.p + "moz-button.f4354bf8b62caf24a41a.css";
...
class MozCheckbox extends _lit_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.MozBaseInputElement {
  ...
  inputTemplate() {
    return (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<input
      ...
      title=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.ifDefined)(this.title)}
    />`;
  }
}
...
module.exports = __webpack_require__.p + "agent-monitor-item.c5a37cc52d8a934682b7.css";
...
/* harmony import */ var _accesskey_check_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35865);
...
class PanelList extends HTMLElement {
  ...
  #selectByFirstLetter(key) {
    ...
    let chain = [];
    for (let el = this.ownerDocument.activeElement; el; el = el.shadowRoot?.activeElement) {
      chain.push(el);
    }
    let focused = chain.find(el => this.contains(el));
    if (!focused) {
      let deepest = chain.at(-1);
      if (deepest?.isContentEditable || ["input", "textarea", "select"].includes(deepest?.localName)) {
        return false;
      }
      // Both this list and its open submenu hear the keystroke through their
      // document listeners.
      if ([...this.querySelectorAll("panel-item[submenu]")].some(item => item.submenuPanel?.open)) {
        return false;
      }
    }
  ...
  async onShow() {
    ...
    requestAnimationFrame(() => {
      ...
      (0,_accesskey_check_mjs__WEBPACK_IMPORTED_MODULE_2__.checkAccessKeys)(this);
      ...
      case "mouseup":
        {
          ...
          if (event.preventClickEvent) {
            ...
            let removeSwallowClick = () => window.removeEventListener("click", swallowClick, {
              capture: true
            });
...
module.exports = __webpack_require__.p + "applied-memories-button.a6b337ea0ac0bb423bb8.css";
  ...
  render() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
      ...
      this.#emitCopy();
        ...
        ${this.hideRetry ? chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.nothing : (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
              <moz-button
...
module.exports = __webpack_require__.p + "monitors-display.264b9743d1b3a0843ab1.css";
...
module.exports = __webpack_require__.p + "ai-action-confirmation.b317a2b0d18876be981e.css";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MonitorStatusChip: () => (/* binding */ MonitorStatusChip)
/* harmony export */ });
/* harmony import */ var browser_components_aiwindow_ui_components_monitors_display_monitors_display_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63232);
/* harmony import */ var chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(616);
/* harmony import */ var chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(82242);
 ...
 */
class MonitorStatusChip extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  static properties = {
    kind: {
      type: String,
      reflect: true
  ...
  render() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <link
        ...
        href="${browser_components_aiwindow_ui_components_monitors_display_monitors_display_css__WEBPACK_IMPORTED_MODULE_0__}"
      />
      ${l10nId ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<span data-l10n-id=${l10nId}></span>` : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
    `;
  }
}
...
module.exports = __webpack_require__.p + "moz-box-item.ea3c37b010b7a55d2a29.css";
...
class AIChatContent extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  #maybeFocusAgentMonitorCard() {
    const card = this.conversationState.findLast(msg => msg?.toolUIData?.uiType === UI_TYPES.AGENT_MONITOR && (msg.toolUIData.properties?.mode ?? "create") === "create" && !msg.isRestored);
    if (!card) {
      return;
    }
  ...
  async #focusMonitorNameInput(cardId) {
    const item = this.shadowRoot?.querySelector(`agent-monitor-item[data-tool-call-id="${CSS.escape(cardId)}"]`);
    if (!item) {
      return;
    }
  ...
  render() {
    return (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      <button
        ...
        role=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.buttonRole)}
        aria-label=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.ariaLabel)}
        ...
        aria-selected=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.ariaSelected)}
        accesskey=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.accessKey)}
      >
        <span
          class=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.classMap)({
...
/* harmony import */ var chrome_browser_content_aiwindow_components_monitor_status_chip_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(68652);
/* harmony import */ var chrome_browser_content_aiwindow_components_ai_website_chip_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6266);
/* harmony import */ var chrome_browser_content_aiwindow_components_monitor_error_copy_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(20477);
...
class AgentMonitorItem extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
   ...
   */
  #optionIcon(icon) {
    return this.selfContained ? icon : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing;
  }
  ...
  #validateForm() {
    ...
    if (this.mode === "create" && !this.#monitorName.trim()) {
      errors.name = {
        id: "ai-tasks-alert-error-name-required"
      };
    }
    if (!this.alertDescription?.trim()) {
      errors.condition = {
        id: "ai-tasks-alert-error-condition-required"
      };
    }
    if (!this.pageUrls.length) {
      errors.pages = {
        id: "ai-tasks-alert-error-no-pages"
      };
    }
  ...
  #renderStatusChip() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<monitor-status-chip
      kind=${this.agent?.status?.kind ?? chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
    ></monitor-status-chip>`;
  }
  #renderLastCheckedCondition() {
    ...
    const normalizedItem = mostRecentItem ? this.#transformHistoryItem(mostRecentItem) : null;
    if (!normalizedItem) {
      return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing;
    }
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<span
  ...
  #renderFieldError(error) {
    return error ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div
          class="error-message"
          data-l10n-id=${error.id}
          data-l10n-args=${error.args ? JSON.stringify(error.args) : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
  ...
  #renderPagesField() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      maxPages: this.maxWatchUrls
          ...
          ${this.#renderFieldError(this.pendingUrlError ?? this.fieldErrors.pages)}
          ${this.pageUrls.length ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="page-pills-row">
                ${this.pageUrls.map(url => (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<ai-website-chip
                      type="context-chip"
                      size="small"
                      removable
                      label=${this.agent?.watchUrlTitles?.[url] ?? this.#displayUrl(url)}
  ...
  #transformHistoryItem(item) {
    ...
    if (item.status === "error") {
      return {
        ...
        note: "",
        noteL10nId: (0,chrome_browser_content_aiwindow_components_monitor_error_copy_mjs__WEBPACK_IMPORTED_MODULE_11__.monitorErrorL10nId)(item.errorCode),
        status: item.status,
        low: true
      };
    }
  ...
  #renderCreate() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <div class="monitor-card">
        ${this.selfContained ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="title-container">
        ...
        ${this.editing ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`${this.#renderConditionField()} ${this.#renderPagesField()}
            ${this.#renderScheduler()}` : (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="task-section">
              ...
              ${agent.watchUrls?.length ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="url-section">
                    ...
                    ></div>
                    <div class="url-chips">
                      ${agent.watchUrls.map(url => (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<ai-website-chip
                            type="context-chip"
                            size="small"
                            label=${agent.watchUrlTitles?.[url] ?? this.#displayUrl(url)}
                            .iconSrc=${`page-icon:${url}`}
                            title=${url}
                            .href=${url}
                          ></ai-website-chip>`)}
        ...
        <div class="monitor-card-actions">
          ${!this.editing ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<moz-button
                ...
                <moz-button
                  id="pause-button"
                  type="default"
                  ?disabled=${agent.status?.kind === "paused" && !this.canResume}
                  @click=${() => {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`
      ...
      count: citationsOverflow.length
        ...
        ${hasOverflow ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`<smartwindow-panel-list
            ...
            >
              ${citationsOverflow.map(citation => this.#renderPill(citation, {
      itemRole: "menuitem"
    }))}
...
//# sourceMappingURL=components-ai-chat-content-ai-chat-content-stories.2d4951a1.iframe.bundle.js.map