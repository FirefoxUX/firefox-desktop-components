"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2524,3743,6284,9240,9417],{
...
const Split = Template.bind({});
Split.args = {
  ...Default.args,
  primaryText: "Sync all your devices",
  secondaryText: "Instantly get your bookmarks and passwords everywhere you’re signed in to Firefox.",
  buttonText: "Sign in",
  layout: "split",
  imagePosition: "end",
  imageWidth: 100,
...
module.exports = __webpack_require__.p + "menu-message.6b59d55dfc227bab06e5.css";
...
class MenuMessage extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  renderIllustration() {
    const useRtl = this.rtlImageURL && this.documentGlobal.getComputedStyle(this).direction === "rtl";
...
//# sourceMappingURL=components-menu-message-menu-message-stories.a6512ef0.iframe.bundle.js.map