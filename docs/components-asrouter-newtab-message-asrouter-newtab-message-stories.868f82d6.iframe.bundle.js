...
module.exports = __webpack_require__.p + "asrouter-newtab-message.884ffdd50849cfbb1cde.css";
...
const DEFAULT_IMAGE = "chrome://newtab/content/data/content/assets/kit-in-circle.svg";
class ASRouterNewTabMessage extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.MozLitElement {
  ...
  #renderPrimaryButton(primaryButton, secondaryButton) {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<div class="button-group">
...
//# sourceMappingURL=components-asrouter-newtab-message-asrouter-newtab-message-stories.868f82d6.iframe.bundle.js.map