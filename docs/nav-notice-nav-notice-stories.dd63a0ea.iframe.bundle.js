...
class NavNotice extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  render() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.staticHtml)`<link
      ...
      />
      <${element} iconsrc=${this.iconSrc} label=${this.label} href=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.href)} support-page=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.supportPage)}></${element}>`;
  }
}
...
/* harmony import */ var chrome_browser_content_preferences_widgets_nav_notice_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8722);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
//# sourceMappingURL=nav-notice-nav-notice-stories.dd63a0ea.iframe.bundle.js.map