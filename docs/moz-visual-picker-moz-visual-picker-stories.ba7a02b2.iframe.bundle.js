...
class MozVisualPickerItem extends (0,_lit_select_control_mjs__WEBPACK_IMPORTED_MODULE_2__.SelectControlItemMixin)(_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement) {
  ...
  contentTemplate() {
    if (!this.imageSrc && (this.labelPosition == "outside" || !this.label && !this.description)) {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      ${this.labelPosition != "outside" ? this.textTemplate() : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
    `;
  }
  textTemplate() {
    if (!this.label) {
    ...
    const labelElement = this.labelPosition == "outside" ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<label class="label" id="label" for="picker-item"
            >${this.label}</label
          >` : (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<p class="label" id="label">${this.label}</p>`;
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="text-content">
      ${this.label ? labelElement : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
      ${this.description ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<p class="description" id="description">${this.description}</p>` : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
    </div>`;
  }
  render() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      "image-item": this.imageSrc && this.label
        ...
        aria-labelledby=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.label && !this.ariaLabel ? "label" : undefined)}
        aria-describedby=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.description && this.label ? "description" : undefined)}
        title=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(this.title)}
...
/* harmony export */   LabelOutside: () => (/* binding */ LabelOutside),
...
const Template = ({
  ...
  return (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
    ...
    <moz-visual-picker
      type=${type}
      orientation=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.ifDefined)(orientation)}
...
const VerticalTemplate = args => (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
  <style>
    .vertical-container {
      max-width: 400px;
    }
...
const LabelOutside = Template.bind({});
LabelOutside.args = {
  ...Default.args,
  showItemLabels: true,
  showItemDescriptions: true,
...
module.exports = __webpack_require__.p + "moz-fieldset.7bb868ed15abe39054d8.css";
...
module.exports = __webpack_require__.p + "moz-visual-picker-item.292e9ab83013271e069c.css";
...
//# sourceMappingURL=moz-visual-picker-moz-visual-picker-stories.ba7a02b2.iframe.bundle.js.map