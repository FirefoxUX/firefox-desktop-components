"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5865,6284,7752,7769,9240,9417],{
...
module.exports = __webpack_require__.p + "smartwindow-history-menu.ff2ecbd1193e2f4eefca.css";
...
/* harmony import */ var chrome_browser_content_aiwindow_components_smartwindow_history_menu_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82572);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
Sidebar.args = {
  mode: "sidebar",
  recentChats: SAMPLE_CHATS
};
const Fullpage = Template.bind({});
Fullpage.args = {
  mode: "fullpage",
  recentChats: SAMPLE_CHATS
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SmartwindowHistoryMenu: () => (/* binding */ SmartwindowHistoryMenu)
/* harmony export */ });
/* harmony import */ var browser_components_aiwindow_ui_components_smartwindow_history_menu_smartwindow_history_menu_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30532);
 ...
 */
class SmartwindowHistoryMenu extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  static properties = {
    mode: {
      type: String,
      reflect: true
  ...
  #dispatch(type, detail) {
    this.dispatchEvent(new CustomEvent(`smartwindow-history-menu:${type}`, {
      detail,
      bubbles: true,
      composed: true
    }));
  ...
  #recentChatRowTemplate(chat) {
    ...
    const iconUrl = hasExternalUrl ? `page-icon:${chat.pageUrl}` : "chrome://browser/content/firefoxview/view-chats.svg";
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<panel-item
      ...
      "--panel-item-icon-url": `url("${iconUrl}")`
    })}
  ...
  #recentChatsListTemplate() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      ${this.recentChats.length ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<hr />` : ""}
      <panel-item
        icon
        style=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.styleMap)({
  ...
  #sidebarTemplate() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      >
        ${this.view === "chats" ? this.#chatHistoryViewTemplate() : this.#mainViewTemplate()}
      </panel-list>
    `;
  }
  #fullpageTemplate() {
  ...
  render() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <link
        rel="stylesheet"
        href="${browser_components_aiwindow_ui_components_smartwindow_history_menu_smartwindow_history_menu_css__WEBPACK_IMPORTED_MODULE_0__}"
      />
      ${this.mode === "fullpage" ? this.#fullpageTemplate() : this.#sidebarTemplate()}
    `;
  }
}
...
//# sourceMappingURL=components-smartwindow-history-menu-smartwindow-history-menu-stories.18a2ad92.iframe.bundle.js.map