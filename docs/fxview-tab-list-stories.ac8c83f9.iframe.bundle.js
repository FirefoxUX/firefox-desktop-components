...
/* harmony import */ var _helpers_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(31557);
...
XPCOMUtils.defineLazyPreferenceGetter(lazy, "searchEnabledPref", "browser.firefox-view.search.enabled");
...
function placeLinkOnClipboard(title, uri) {
  ...
  let contents = [{
    ...
    type: lazy.PlacesUtils.TYPE_HTML,
    entries: []
  }, {
    type: lazy.PlacesUtils.TYPE_PLAINTEXT,
    entries: []
  }];
...
//# sourceMappingURL=fxview-tab-list-stories.ac8c83f9.iframe.bundle.js.map