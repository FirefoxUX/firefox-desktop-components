"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2928,5865,7752,9862],{
...
function generatePlaceholderKeyframeStyles(placeholderCount) {
  ...
  return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.css)`
...
class MultilineEditor extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  get value() {
    ...
    this.#valueCacheStr = this.#markdownSerializer ? this.#markdownSerializer.serialize(doc) : doc.textBetween(0, doc.content.size, "\n", "\n");
    return this.#valueCacheStr;
  }
  ...
  set value(val) {
    ...
    tr.setSelection(chrome_browser_content_multilineeditor_prosemirror_bundle_mjs__WEBPACK_IMPORTED_MODULE_4__.TextSelection.between(tr.doc.resolve(cursorPos), tr.doc.resolve(cursorPos)));
  ...
  setRangeText(replacement, start, end, selectionMode) {
    ...
    const state = this.#view.state;
    const from = this.#posFromTextOffset(start ?? this.selectionStart, state.doc);
    ...
    tr.setSelection(chrome_browser_content_multilineeditor_prosemirror_bundle_mjs__WEBPACK_IMPORTED_MODULE_4__.TextSelection.between(tr.doc.resolve(selectionStart), tr.doc.resolve(selectionEnd)));
    this.#dispatchSilently(tr);
  }
  ...
  setSelectionRange(start, end) {
    ...
    const [resolvedFrom, resolvedTo] = this.#posFromTextOffsets([fromOffset, end ?? fromOffset], doc);
  ...
  updated(changedProps) {
    if (changedProps.has("placeholder") || changedProps.has("placeholderHints") || changedProps.has("plugins") || changedProps.has("readOnly")) {
      this.#refreshView();
    }
  ...
  #dispatchTransaction = tr => {
    ...
    if (tr.docChanged && this.maxLength > 0 && tr.doc.content.size > this.maxLength) {
      ...
      if (newText.length > this.maxLength && truncated !== this.value) {
        ...
        tr = this.#view.state.tr.replaceWith(0, this.#view.state.doc.content.size, doc.content).scrollIntoView();
      }
    }
  ...
  #createPlaceholderHints() {
    ...
    hints.style.setProperty("--multiline-editor-placeholder-count", placeholderCount);
    ...
    for (const [index, hint] of this.placeholderHints.entries()) {
      ...
      hintItem.style.setProperty("--multiline-editor-placeholder-index", index + 1);
      ...
      props: {
        decorations: ({
          ...
          if (this.placeholderHints.length) {
            return chrome_browser_content_multilineeditor_prosemirror_bundle_mjs__WEBPACK_IMPORTED_MODULE_4__.DecorationSet.create(doc, [chrome_browser_content_multilineeditor_prosemirror_bundle_mjs__WEBPACK_IMPORTED_MODULE_4__.Decoration.widget(1, () => this.#createPlaceholderHints(), {
  ...
  #getPlaceholderAnimations() {
    const placeholderHints = this.renderRoot.querySelector(".placeholder-hints");
    if (!placeholderHints) {
      return [];
    }
    return [...placeholderHints.querySelectorAll("li")].flatMap(placeholderHint => placeholderHint.getAnimations());
  }
  #updatePlaceholderKeyframeStyles() {
    ...
    const keyframeStyles = generatePlaceholderKeyframeStyles(this.placeholderHints.length + 1);
  ...
  #viewAttributes() {
    ...
    if (this.placeholderHints.length) {
      attrs["aria-describedby"] = `placeholder-hints-${this.#instanceId}-${this.#placeholderVersion}`;
    }
    return attrs;
  }
  render() {
...
module.exports = __webpack_require__.p + "multiline-editor.f0bd5636b19713508d8c.css";
...
/* harmony export */   WithAnimatedPlaceholderHints: () => (/* binding */ WithAnimatedPlaceholderHints),
...
const WithAnimatedPlaceholderHints = Template.bind({});
...
//# sourceMappingURL=multiline-editor-stories.a59b63b2.iframe.bundle.js.map