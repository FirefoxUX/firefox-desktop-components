"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6284,8591,9240],{
...
/* harmony export */   DOMSerializer: () => (/* binding */ ie),
/* harmony export */   Decoration: () => (/* binding */ oo),
/* harmony export */   DecorationSet: () => (/* binding */ ao),
/* harmony export */   EditorState: () => (/* binding */ dt),
/* harmony export */   EditorView: () => (/* binding */ Ro),
/* harmony export */   Plugin: () => (/* binding */ mt),
/* harmony export */   PluginKey: () => (/* binding */ kt),
/* harmony export */   Schema: () => (/* binding */ H),
/* harmony export */   TextSelection: () => (/* binding */ et),
/* harmony export */   baseKeymap: () => (/* binding */ zt),
/* harmony export */   basicSchema: () => (/* binding */ xn),
/* harmony export */   defaultMarkdownParser: () => (/* binding */ La),
/* harmony export */   history: () => (/* binding */ Qt),
/* harmony export */   keymap: () => (/* binding */ pn),
/* harmony export */   redo: () => (/* binding */ en),
/* harmony export */   suggestionsPlugin: () => (/* binding */ $a),
/* harmony export */   triggerCharacter: () => (/* binding */ qa),
/* harmony export */   undo: () => (/* binding */ Yt)
/* harmony export */ });
function e(e) {
  this.content = e;
}
  ...
  for (let o = e.childCount, s = t.childCount;;) {
    ...
    if (l != a) {
      ...
      if (l.isText && l.text != a.text) {
        ...
        for (; e < t && l.text[l.text.length - e - 1] == a.text[a.text.length - e - 1];) e++, r--, i--;
        return {
          a: r,
          b: i
        };
      ...
      if (l.content.size || a.content.size) {
        let e = n(l.content, a.content, r - 1, i - 1);
        if (e) return e;
      }
      r -= c, i -= c;
    } else r -= c, i -= c;
...
e.prototype = {
  ...
  update: function (t, n, r) {
    var i = r && r != t ? this.remove(r) : this,
      o = i.find(t),
      s = i.content.slice();
    return -1 == o ? s.push(r || t, n) : (s[o + 1] = n, r && (s[o] = r)), new e(s);
  },
  remove: function (t) {
    var n = this.find(t);
    if (-1 == n) return this;
  ...
  addBefore: function (t, n, r) {
    var i = this.remove(n),
      o = i.content.slice(),
      s = i.find(t);
    return o.splice(-1 == s ? o.length : s, 0, n, r), new e(o);
  },
  forEach: function (e) {
    for (var t = 0; t < this.content.length; t += 2) e(this.content[t], this.content[t + 1]);
  },
  prepend: function (t) {
    return (t = e.from(t)).size ? new e(t.content.concat(this.subtract(t).content)) : this;
  },
  append: function (t) {
    return (t = e.from(t)).size ? new e(this.subtract(t).content.concat(t.content)) : this;
  },
  subtract: function (t) {
    var n = this;
    t = e.from(t);
...
class r {
  ...
  textBetween(e, t, n, r) {
    ...
    return this.nodesBetween(e, t, (s, l) => {
      let a = s.isText ? s.text.slice(Math.max(e, l) - l, t - l) : s.isLeaf ? r ? "function" == typeof r ? r(s) : r : s.type.spec.leafText ? s.type.spec.leafText(s) : "" : "";
  ...
  cut(e, t = this.size) {
    ...
    let n = [],
      i = 0;
    if (t > e) for (let r = 0, o = 0; o < t; r++) {
      let s = this.content[r],
        l = o + s.nodeSize;
      l > e && ((o < e || l > t) && (s = s.isText ? s.cut(Math.max(0, e - o), Math.min(s.text.length, t - o)) : s.cut(Math.max(0, e - o - 1), Math.min(s.content.size, t - o - 1))), n.push(s), i += s.nodeSize), o = l;
    }
    return new r(n, i);
  }
  cutByIndex(e, t) {
    return e == t ? r.empty : 0 == e && t == this.content.length ? this : new r(this.content.slice(e, t));
  }
  replaceChild(e, t) {
  ...
  findIndex(e) {
    ...
    for (let t = 0, n = 0;; t++) {
      ...
      if (r >= e) return r == e ? o(t + 1, r) : o(t, n);
      n = r;
    }
  }
  toString() {
...
function s(e, t) {
  ...
  if (n) {
    ...
    for (let n in e) if (!(n in t) || !s(e[n], t[n])) return !1;
...
class l {
  ...
  addToSet(e) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      if (this.type.excludes(i.type)) t || (t = e.slice(0, r));else {
  ...
  eq(e) {
    return this == e || this.type == e.type && s(this.attrs, e.attrs);
  }
  toJSON() {
    let e = {
      type: this.type.name
...
class c {
  ...
  insertAt(e, t) {
    let n = u(this.content, e + this.openStart, t);
    return n && new c(n, this.openStart, this.openEnd);
  }
  removeBetween(e, t) {
    return new c(h(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  eq(e) {
  ...
  static fromJSON(e, t) {
    ...
    return new c(r.fromJSON(e, t.content), n, i);
  }
...
function u(e, t, n, r) {
  ...
  let l = u(s.content, t - o - 1, n, s);
  return l && e.replaceChild(i, s.copy(l));
}
function p(e, t, n) {
  if (n.openStart > e.depth) throw new a("Inserted content deeper than insertion position");
  if (e.depth - n.openStart != t.depth - n.openEnd) throw new a("Inconsistent open depths");
  return d(e, t, n, 0);
}
function d(e, t, n, i) {
  let o = e.index(i),
    s = e.node(i);
  if (o == t.index(i) && i < e.depth - n.openStart) {
    let r = d(e, t, n, i + 1);
    return s.copy(s.content.replaceChild(o, r));
  }
  if (n.content.size) {
    if (n.openStart || n.openEnd || e.depth != i || t.depth != i) {
      let {
        start: o,
        end: l
      } = function (e, t) {
      ...
      return k(s, b(e, o, l, t, i));
    }
    {
      let r = e.parent,
        i = r.content;
      return k(r, i.cut(0, e.parentOffset).append(n.content).append(i.cut(t.parentOffset)));
    }
  }
  return k(s, w(e, t, i));
}
function f(e, t) {
  if (!t.type.compatibleContent(e.type)) throw new a("Cannot join " + t.type.name + " onto " + e.type.name);
}
function m(e, t, n) {
  let r = e.node(n);
  return f(r, t.node(n)), r;
}
function g(e, t) {
  let n = t.length - 1;
...
function y(e, t, n, r) {
  ...
  e && (o = e.index(n), e.depth > n ? o++ : e.textOffset && (g(e.nodeAfter, r), o++));
  for (let e = o; e < s; e++) g(i.child(e), r);
...
function b(e, t, n, i, o) {
  let s = e.depth > o && m(e, t, o + 1),
    l = i.depth > o && m(n, i, o + 1),
    a = [];
  return y(null, e, o, a), s && l && t.index(o) == n.index(o) ? (f(s, l), g(k(s, b(e, t, n, i, o + 1)), a)) : (s && g(k(s, w(e, t, o + 1)), a), y(t, n, o, a), l && g(k(l, w(n, i, o + 1)), a)), y(i, null, o, a), new r(a);
}
function w(e, t, n) {
  let i = [];
  if (y(null, e, n, i), e.depth > n) {
    g(k(m(e, t, n + 1), w(e, t, n + 1)), i);
  }
  return y(t, null, n, i), new r(i);
}
...
class C {
  ...
  blockRange(e = this, t) {
    ...
    for (let n = this.depth - (this.parent.inlineContent || this.pos == e.pos ? 1 : 0); n >= 0; n--) if (e.pos <= this.end(n) && (!t || t(this.node(n)))) return new _(this, e, n);
    return null;
  }
  sameParent(e) {
  ...
  static resolveCached(e, t) {
    ...
    if (n) for (let e = 0; e < n.elts.length; e++) {
      let r = n.elts[e];
      if (r.pos == t) return r;
    } else v.set(e, n = new x());
    let r = n.elts[n.i] = C.resolve(e, t);
...
class E {
  ...
  hasMarkup(e, t, n) {
    return this.type == e && s(this.attrs, t || e.defaultAttrs || S) && l.sameSet(this.marks, n || l.none);
  }
  copy(e = null) {
  ...
  canReplace(e, t, n = r.empty, i = 0, o = n.childCount) {
    let s = this.contentMatchAt(e).matchFragment(n, i, o),
  ...
  check() {
    ...
    if (!l.sameSet(e, this.marks)) throw new RangeError(`Invalid collection of marks for node ${this.type.name}: ${this.marks.map(e => e.type.name)}`);
  ...
  static fromJSON(e, t) {
    ...
    let i = r.fromJSON(e, t.content),
      o = e.nodeType(t.type).create(t.attrs, i, n);
...
class A extends E {
  ...
  mark(e) {
    return e == this.marks ? this : new A(this.type, this.attrs, this.text, e);
  }
  withText(e) {
    return e == this.text ? this : new A(this.type, this.attrs, e, this.marks);
  }
...
class O {
  ...
  static parse(e, t) {
    ...
    let i = function (e) {
      ...
      function n(r) {
        ...
        let o = t[r.join(",")] = new O(r.indexOf(e.length - 1) > -1);
      ...
      function o(e, t) {
        ...
        if ("seq" != e.type) {
          ...
          if ("range" == e.type) {
            ...
            if (-1 == e.max) i(o(e.expr, s), s);else for (let t = e.min; t < e.max; t++) {
              let t = n();
  ...
  fillBefore(e, t = !1, n = 0) {
    ...
    return function o(s, l) {
      ...
      if (a && (!t || a.validEnd)) return r.from(l.map(e => e.createAndFill()));
      for (let e = 0; e < s.next.length; e++) {
        let {
          type: t,
          next: n
        } = s.next[e];
        if (!t.isText && !t.hasRequiredAttrs() && -1 == i.indexOf(n)) {
          i.push(n);
...
function I(e, t) {
  let n = z(e),
    r = n;
  return e.eat(",") && (r = "}" != e.next ? z(e) : -1), e.eat("}") || e.err("Unclosed braced range"), {
    type: "range",
    min: n,
    max: r,
    expr: t
...
function V(e, t) {
  let n = Object.create(null);
  if (t) for (let r in t) n[r] = new J(e, r, t[r]);
  return n;
}
let j = class e {
  constructor(e, t, n) {
    this.name = e, this.schema = t, this.spec = n, this.markSet = null, this.groups = n.group ? n.group.split(" ") : [], this.attrs = V(e, n.attrs), this.defaultAttrs = L(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(n.inline || "text" == e), this.isText = "text" == e;
  }
  get isInline() {
    return !this.isBlock;
  }
  ...
  create(e = null, t, n) {
    ...
    return new E(this, this.computeAttrs(e), r.from(t), l.setFrom(n));
  }
  createChecked(e = null, t, n) {
    return t = r.from(t), this.checkContent(t), new E(this, this.computeAttrs(e), t, l.setFrom(n));
  }
  createAndFill(e = null, t, n) {
    if (e = this.computeAttrs(e), (t = r.from(t)).size) {
    ...
    return o ? new E(this, e, t.append(o), l.setFrom(n)) : null;
  }
  validContent(e) {
  ...
  constructor(e, t, n) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(n, "default"), this.default = n.default, this.validate = "string" == typeof n.validate ? function (e, t, n) {
      ...
      return n => {
        ...
        if (r.indexOf(i) < 0) throw new RangeError(`Expected value of type ${r} for attribute ${t} on type ${e}, got ${i}`);
      };
...
class W {
  constructor(e, t, n, r) {
    this.name = e, this.rank = t, this.schema = n, this.spec = r, this.attrs = V(e, r.attrs), this.excluded = null;
    let i = L(this.attrs);
    this.instance = i ? new l(this, i) : null;
  }
  create(e = null) {
    return !e && this.instance ? this.instance : new l(this, q(this.attrs, e));
  }
  static compile(e, t) {
    let n = Object.create(null),
      r = 0;
...
class H {
  constructor(t) {
    ...
    n.nodes = e.from(t.nodes), n.marks = e.from(t.marks || {}), this.nodes = j.compile(this.spec.nodes, this), this.marks = W.compile(this.spec.marks, this);
    let r = Object.create(null);
    for (let e in this.nodes) {
      ...
      let t = this.nodes[e],
        n = t.spec.content || "",
        i = t.spec.marks;
      if (t.contentMatch = r[n] || (r[n] = O.parse(n, this.nodes)), t.inlineContent = t.contentMatch.inlineContent, t.spec.linebreakReplacement) {
      ...
      t.markSet = "_" == i ? null : i ? U(this, i.split(" ")) : "" != i && t.inlineContent ? null : [];
    }
    ...
    this.nodeFromJSON = e => E.fromJSON(this, e), this.markFromJSON = e => l.fromJSON(this, e), this.topNodeType = this.nodes[this.spec.topNode || "doc"], this.cached.wrappings = Object.create(null);
  }
  node(e, t = null, n, r) {
  ...
  text(e, t) {
    ...
    return new A(n, n.defaultAttrs, e, l.setFrom(t));
  }
  mark(e, t) {
...
function U(e, t) {
  ...
  for (let r = 0; r < t.length; r++) {
    let i = t[r],
      o = e.marks[i],
      s = o;
    if (o) n.push(o);else for (let t in e.marks) {
      let r = e.marks[t];
...
class K {
  ...
  parse(e, t = {}) {
    let n = new ee(this, t, !1);
    return n.addAll(e, l.none, t.from, t.to), n.finish();
  }
  parseSlice(e, t = {}) {
    let n = new ee(this, t, !0);
    return n.addAll(e, l.none, t.from, t.to), c.maxOpen(n.finish());
  }
  matchTag(e, t, n) {
    for (let r = n ? this.tags.indexOf(n) + 1 : 0; r < this.tags.length; r++) {
      let n = this.tags[r];
      if (te(e, n.tag) && (void 0 === n.namespace || e.namespaceURI == n.namespace) && (!n.context || t.matchesContext(n.context))) {
        if (n.getAttrs) {
          let t = n.getAttrs(e);
          if (!1 === t) continue;
          n.attrs = t || void 0;
  ...
  matchStyle(e, t, n, r) {
    for (let i = r ? this.styles.indexOf(r) + 1 : 0; i < this.styles.length; i++) {
      let r = this.styles[i],
        o = r.style;
      if (!(0 != o.indexOf(e) || r.context && !n.matchesContext(r.context) || o.length > e.length && (61 != o.charCodeAt(e.length) || o.slice(e.length + 1) != t))) {
        if (r.getAttrs) {
          let e = r.getAttrs(t);
          if (!1 === e) continue;
          r.attrs = e || void 0;
  ...
  static schemaRules(e) {
    ...
    for (let t in e.marks) {
      ...
      r && r.forEach(e => {
        n(e = ne(e)), e.mark || e.ignore || e.clearMark || (e.mark = t);
      });
    }
    for (let t in e.nodes) {
      let r = e.nodes[t].spec.parseDOM;
      r && r.forEach(e => {
        n(e = ne(e)), e.node || e.ignore || e.mark || (e.node = t);
      });
    }
    return t;
  }
  static fromSchema(e) {
    return e.cached.domParser || (e.cached.domParser = new K(e, K.schemaRules(e)));
  }
}
const Z = {
    address: !0,
...
class Y {
  constructor(e, t, n, r, i, o) {
    this.type = e, this.attrs = t, this.marks = n, this.solid = r, this.options = o, this.content = [], this.activeMarks = l.none, this.match = i || (4 & o ? null : e.contentMatch);
  }
  findWrapping(e) {
    if (!this.match) {
      if (!this.type) return [];
  ...
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !Z.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class ee {
  constructor(e, t, n) {
    ...
    let r,
      i = t.topNode,
      o = X(null, t.preserveWhitespace, 0) | (n ? 4 : 0);
    r = i ? new Y(i.type, i.attrs, l.none, !0, t.topMatch || i.type.contentMatch, o) : new Y(n ? null : e.schema.topNodeType, null, l.none, !0, null, o), this.nodes = [r], this.find = t.findPositions, this.needsBlock = !1;
  }
  get top() {
  ...
  addElement(e, t, n) {
    ...
    Q.hasOwnProperty(s) && this.parser.normalizeLists && function (e) {
      for (let t = e.firstChild, n = null; t; t = t.nextSibling) {
        let e = 1 == t.nodeType ? t.nodeName.toLowerCase() : null;
        e && Q.hasOwnProperty(e) && n ? (n.appendChild(t), t = n) : "li" == e ? n = t : e && (n = null);
      }
    }(e);
    let l = this.options.ruleFromNode && this.options.ruleFromNode(e) || (o = this.parser.matchTag(e, this, n));
    e: if (l ? l.ignore : G.hasOwnProperty(s)) this.findInside(e), this.ignoreFallback(e, t);else if (!l || l.skip || l.closeParent) {
      l && l.closeParent ? this.open = Math.max(0, this.open - 1) : l && l.skip.nodeType && (e = l.skip);
      let n,
        r = this.needsBlock;
      if (Z.hasOwnProperty(s)) i.content.length && i.content[0].isInline && this.open && (this.open--, i = this.top), n = !0, i.type || (this.needsBlock = !0);else if (!e.firstChild) {
  ...
  addElementByRule(e, t, n, r) {
    let i, o;
    if (t.node) {
      if (o = this.parser.schema.nodes[t.node], o.isLeaf) this.insertNode(o.create(t.attrs), n, "BR" == e.nodeName) || this.leafFallback(e, n);else {
    ...
    let s = this.top;
    if (o && o.isLeaf) this.findInside(e);else if (r) this.addElement(e, n, r);else if (t.getContent) this.findInside(e), t.getContent(e, this.parser.schema).forEach(e => this.insertNode(e, n, !1));else {
      let r = e;
  ...
  addAll(e, t, n, r) {
    let i = n || 0;
    for (let o = n ? e.childNodes[n] : e.firstChild, s = null == r ? null : e.childNodes[r]; o != s; o = o.nextSibling, ++i) this.findAtPoint(e, i), this.addDOM(o, t);
    this.findAtPoint(e, i);
  }
  findPlace(e, t, n) {
    let r, i;
    for (let t = this.open, o = 0; t >= 0; t--) {
      let s = this.nodes[t],
        l = s.findWrapping(e);
  ...
  insertNode(e, t, n) {
    ...
    if (r) {
      ...
      let n = l.none;
      for (let i of r.concat(e.marks)) (t.type ? t.type.allowsMarkType(i.type) : re(i.type, e.type)) && (n = i.addToSet(n));
  ...
  enterInner(e, t, n, r = !1, i) {
    ...
    let s = X(e, i, o.options);
    4 & o.options && 0 == o.content.length && (s |= 4);
    let a = l.none;
    return n = n.filter(t => !(o.type ? o.type.allowsMarkType(t.type) : re(t.type, e)) || (a = t.addToSet(a), !1)), this.nodes.push(new Y(e, t, a, r, null, s)), this.open++, n;
  }
  closeExtra(e = !1) {
  ...
  findAround(e, t, n) {
    if (e != t && this.find) for (let r = 0; r < this.find.length; r++) if (null == this.find[r].pos && 1 == e.nodeType && e.contains(this.find[r].node)) {
...
class ie {
  ...
  serializeFragment(e, t = {}, n) {
    n || (n = se(t).createDocumentFragment());
    let r = n,
      i = [];
    return e.forEach(e => {
  ...
  serializeNodeInner(e, t) {
    let {
      dom: n,
      contentDOM: r
    } = ce(se(t), this.nodes[e.type.name](e), null, e.attrs);
    if (r) {
  ...
  serializeMark(e, t, n = {}) {
    ...
    return r && ce(se(n), r(e, t), null, e.attrs);
  }
...
function ae(e) {
  let t = le.get(e);
  return void 0 === t && le.set(e, t = function (e) {
    let t = null;
    function n(e) {
      if (e && "object" == typeof e) if (Array.isArray(e)) {
        if ("string" == typeof e[0]) t || (t = []), t.push(e);else for (let t = 0; t < e.length; t++) n(e[t]);
...
function ce(e, t, n, r) {
  ...
  if (r && (i = ae(r)) && i.indexOf(t) > -1) throw new RangeError("Using an array from an attribute object as a DOM spec. This may be an attempted cross site scripting attack.");
  let s,
    l = o.indexOf(" ");
  ...
  if (c && "object" == typeof c && null == c.nodeType && !Array.isArray(c)) {
    ...
    for (let e in c) if (null != c[e]) {
      let t = e.indexOf(" ");
      t > 0 ? a.setAttributeNS(e.slice(0, t), e.slice(t + 1), c[e]) : "style" == e && a.style ? a.style.cssText = c[e] : a.setAttribute(e, c[e]);
    }
  }
  for (let i = h; i < t.length; i++) {
    let o = t[i];
    if (0 === o) {
      if (i < t.length - 1 || i > h) throw new RangeError("Content hole must be the only child of its parent node");
      return {
        dom: a,
        contentDOM: a
      };
...
class fe {
  constructor(e, t = !1) {
    if (this.ranges = e, this.inverted = t, !e.length && fe.empty) return fe.empty;
  }
  recover(e) {
    let t = 0,
      n = pe(e);
  ...
  _map(e, t, n) {
    ...
    for (let s = 0; s < this.ranges.length; s += 3) {
      ...
      let a = this.ranges[s + i],
        ...
        h = l + a;
      if (e <= h) {
        let i = l + r + ((a ? e == l ? -1 : e == h ? 1 : t : t) < 0 ? 0 : c);
        if (n) return i;
        let o = e == (t < 0 ? l : h) ? null : ue(s / 3, e - l),
          u = e == l ? 2 : e == h ? 1 : 4;
        return (t < 0 ? e != l : e != h) && (u |= 8), new de(i, u, o);
      }
      r += c - a;
    }
    return n ? e + r : new de(e + r, 0, null);
  }
  touches(e, t) {
    let n = 0,
      r = pe(t),
  ...
  static offset(e) {
    return 0 == e ? fe.empty : new fe(e < 0 ? [0, -e, 0] : [0, 0, e]);
  }
}
fe.empty = new fe([]);
class me {
  ...
  slice(e = 0, t = this.maps.length) {
    return new me(this._maps, this.mirror, e, t);
  }
  appendMap(e, t) {
...
class ye {
  ...
  static jsonID(e, t) {
    if (e in ge) throw new RangeError("Duplicate use of step JSON ID " + e);
    return ge[e] = t, t.prototype.jsonID = e, t;
  }
}
class ke {
  constructor(e, t) {
  ...
  static fromReplace(e, t, n, r) {
    try {
      return ke.ok(e.replace(t, n, r));
    } catch (e) {
      if (e instanceof a) return ke.fail(e.message);
      throw e;
    }
  }
}
function be(e, t, n) {
  ...
  for (let r = 0; r < e.childCount; r++) {
    let o = e.child(r);
    o.content.size && (o = o.copy(be(o.content, t, o))), o.isInline && (o = t(o, n, r)), i.push(o);
  }
...
class we extends ye {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      ...
      i = new c(be(t.content, (e, t) => e.isAtom && t.type.allowsMarkType(this.mark.type) ? e.mark(this.mark.addToSet(e.marks)) : e, r), t.openStart, t.openEnd);
    return ke.fromReplace(e, this.from, this.to, i);
  }
  invert() {
...
class Ce extends ye {
  ...
  apply(e) {
    let t = e.slice(this.from, this.to),
      n = new c(be(t.content, e => e.mark(this.mark.removeFromSet(e.marks)), e), t.openStart, t.openEnd);
    return ke.fromReplace(e, this.from, this.to, n);
  }
  invert() {
...
class xe extends ye {
  ...
  apply(e) {
    ...
    if (!t) return ke.fail("No node at mark step's position");
    let n = t.type.create(t.attrs, null, this.mark.addToSet(t.marks));
    return ke.fromReplace(e, this.pos, this.pos + 1, new c(r.from(n), 0, t.isLeaf ? 0 : 1));
  }
  invert(e) {
    let t = e.nodeAt(this.pos);
    if (t) {
      ...
      if (e.length == t.marks.length) {
        for (let n = 0; n < t.marks.length; n++) if (!t.marks[n].isInSet(e)) return new xe(this.pos, t.marks[n]);
...
class De extends ye {
  ...
  invert(e) {
    let t = e.nodeAt(this.pos);
    return t && this.mark.isInSet(t.marks) ? new xe(this.pos, this.mark) : this;
  }
  map(e) {
    let t = e.mapResult(this.pos, 1);
    return t.deletedAfter ? null : new De(t.pos, this.mark);
  }
  toJSON() {
    return {
  ...
  static fromJSON(e, t) {
    ...
    return new De(t.pos, e.markFromJSON(t.mark));
  }
}
ye.jsonID("removeNodeMark", De);
class ve extends ye {
  constructor(e, t, n, r = !1) {
    super(), this.from = e, this.to = t, this.slice = n, this.structure = r;
  }
  apply(e) {
    return this.structure && Se(e, this.from, this.to) ? ke.fail("Structure replace would overwrite content") : ke.fromReplace(e, this.from, this.to, this.slice);
  }
  getMap() {
  ...
  map(e) {
    let t = e.mapResult(this.from, 1),
      n = e.mapResult(this.to, -1);
    return t.deletedAcross && n.deletedAcross ? null : new ve(t.pos, Math.max(t.pos, n.pos), this.slice, this.structure);
  }
  merge(e) {
    if (!(e instanceof ve) || e.structure || this.structure) return null;
  ...
  static fromJSON(e, t) {
    ...
    return new ve(t.from, t.to, c.fromJSON(e, t.slice), !!t.structure);
  }
}
ye.jsonID("replace", ve);
class _e extends ye {
  constructor(e, t, n, r, i, o, s = !1) {
    super(), this.from = e, this.to = t, this.gapFrom = n, this.gapTo = r, this.slice = i, this.insert = o, this.structure = s;
  }
  apply(e) {
    if (this.structure && (Se(e, this.from, this.gapFrom) || Se(e, this.gapTo, this.to))) return ke.fail("Structure gap-replace would overwrite content");
    let t = e.slice(this.gapFrom, this.gapTo);
    if (t.openStart || t.openEnd) return ke.fail("Gap is not a flat range");
    let n = this.slice.insertAt(this.insert, t.content);
    return n ? ke.fromReplace(e, this.from, this.to, n) : ke.fail("Content does not fit in gap");
  }
  getMap() {
    return new fe([this.from, this.gapFrom - this.from, this.insert, this.gapTo, this.to - this.gapTo, this.slice.size - this.insert]);
  }
  invert(e) {
    let t = this.gapTo - this.gapFrom;
    return new _e(this.from, this.from + this.slice.size + t, this.from + this.insert, this.from + this.insert + t, e.slice(this.from, this.to).removeBetween(this.gapFrom - this.from, this.gapTo - this.from), this.gapFrom - this.from, this.structure);
  }
  map(e) {
    let t = e.mapResult(this.from, 1),
      n = e.mapResult(this.to, -1),
    ...
    return t.deletedAcross && n.deletedAcross || r < t.pos || i > n.pos ? null : new _e(t.pos, n.pos, r, i, this.slice, this.insert, this.structure);
  }
  toJSON() {
    let e = {
  ...
  static fromJSON(e, t) {
    ...
    return new _e(t.from, t.to, t.gapFrom, t.gapTo, c.fromJSON(e, t.slice), t.insert, !!t.structure);
  }
}
function Se(e, t, n) {
  let r = e.resolve(t),
...
function Ee(e, t, n, i = n.contentMatch, o = !0) {
  ...
  for (let t = 0; t < s.childCount; t++) {
    ...
    if (p) {
      i = p;
      for (let t = 0; t < h.marks.length; t++) n.allowsMarkType(h.marks[t].type) || e.step(new Ce(a, u, h.marks[t]));
      if (o && h.isText && "pre" != n.whitespace) {
        let e,
          t,
          i = /\r?\n|\r/g;
        for (; e = i.exec(h.text);) t || (t = new c(r.from(n.schema.text(" ", n.allowedMarks(h.marks))), 0, 0)), l.push(new ve(a + e.index, a + e.index + e[0].length, t));
      }
    } else l.push(new ve(a, u, c.empty));
    a = u;
  }
  if (!i.validEnd) {
...
function Me(e) {
  ...
  for (let n = e.depth, r = 0, i = 0;; --n) {
    let o = e.$from.node(n),
      s = e.$from.index(n) + r,
      l = e.$to.indexAfter(n) - i;
    if (n < e.depth && o.canReplace(s, l, t)) return n;
    if (0 == n || o.type.spec.isolating || !Ae(o, s, l)) break;
...
function Te(e, t) {
  let n = e.resolve(t),
    r = n.index();
  return i = n.nodeBefore, o = n.nodeAfter, !(!i || !o || i.isLeaf || !function (e, t) {
...
class Ie {
  ...
  fit() {
    ...
    let l = new c(i, o, s);
    return e > -1 ? new _e(n.pos, e, this.$to.pos, this.$to.end(), l, t) : l.size || n.pos != this.$to.pos ? new ve(n.pos, r.pos, l) : null;
  }
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++) for (let n = 1 == t ? e : this.unplaced.openStart; n >= 0; n--) {
      let e,
        i = null;
      n ? (i = Le(this.unplaced.content, n - 1).firstChild, e = i.content) : e = this.unplaced.content;
      let o = e.firstChild;
      for (let e = this.depth; e >= 0; e--) {
        let s,
          ...
          c = null;
        if (1 == t && (o ? a.matchType(o.type) || (c = a.fillBefore(r.from(o), !1)) : i && l.compatibleContent(i.type))) return {
          sliceDepth: n,
          frontierDepth: e,
          parent: i,
          inject: c
        };
        if (2 == t && o && (s = a.findWrapping(o.type))) return {
          sliceDepth: n,
          frontierDepth: e,
          parent: i,
          wrap: s
  ...
  openMore() {
    let {
      ...
      r = Le(e, t);
    return !(!r.childCount || r.firstChild.isLeaf) && (this.unplaced = new c(e, t + 1, Math.max(n, r.size + t >= e.size - n ? t + 1 : 0)), !0);
  }
  dropNode() {
    let {
        content: e,
    ...
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new c(Be(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new c(Be(e, t, 1), t, n);
  }
  placeNodes({
    sliceDepth: e,
    frontierDepth: t,
    ...
    for (; h < l.childCount;) {
      ...
      if (!t) break;
      h++, (h > 1 || 0 == a || e.content.size) && (p = t, u.push(qe(e.mark(d.allowedMarks(e.marks)), 1 == h ? a : 0, h == l.childCount ? f : -1)));
    }
    let m = h == l.childCount;
    m || (f = -1), this.placed = Pe(this.placed, t, r.from(u)), this.frontier[t].match = p, m && f < 0 && n && n.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
    ...
    this.unplaced = m ? 0 == e ? c.empty : new c(Be(s.content, e - 1, 1), e - 1, f < 0 ? s.openEnd : e - 1) : new c(Be(s.content, e, h), s.openStart, s.openEnd);
  }
  mustMoveInline() {
    if (!this.$to.parent.isTextblock) return -1;
    let e,
      t = this.frontier[this.depth];
    if (!t.type.isTextblock || !$e(this.$to, this.$to.depth, t.type, t.match, !1) || this.$to.depth == this.depth && (e = this.findCloseLevel(this.$to)) && e.depth == this.depth) return -1;
    let {
        depth: n
      } = this.$to,
      r = this.$to.after(n);
  ...
  openFrontierNode(e, t = null, n) {
    ...
    i.match = i.match.matchType(e), this.placed = Pe(this.placed, this.depth, r.from(e.create(t, n))), this.frontier.push({
      type: e,
  ...
  closeFrontierNode() {
    ...
    e.childCount && (this.placed = Pe(this.placed, this.frontier.length, e));
  }
}
function Be(e, t, n) {
  return 0 == t ? e.cutByIndex(n, e.childCount) : e.replaceChild(0, e.firstChild.copy(Be(e.firstChild.content, t - 1, n)));
}
function Pe(e, t, n) {
  return 0 == t ? e.append(n) : e.replaceChild(e.childCount - 1, e.lastChild.copy(Pe(e.lastChild.content, t - 1, n)));
}
function Le(e, t) {
...
function qe(e, t, n) {
  if (t <= 0) return e;
  let i = e.content;
  return t > 1 && (i = i.replaceChild(0, qe(i.firstChild, t - 1, 1 == i.childCount ? n - 1 : 0))), t > 0 && (i = e.type.contentMatch.fillBefore(i).append(i), n <= 0 && (i = i.append(e.type.contentMatch.matchFragment(i).fillBefore(r.empty, !0)))), e.copy(i);
}
...
function je(e, t, n, i, o) {
  if (t < n) {
    let r = e.firstChild;
    e = e.replaceChild(0, r.copy(je(r.content, t + 1, n, i, r)));
  }
  if (t > i) {
...
function Je(e, t) {
  ...
  for (let r = Math.min(e.depth, t.depth); r >= 0; r--) {
    let i = e.start(r);
    if (i < e.pos - (e.depth - r) || t.end(r) > t.pos + (t.depth - r) || e.node(r).type.spec.isolating || t.node(r).type.spec.isolating) break;
    (i == t.start(r) || r == e.depth && r == t.depth && e.parent.inlineContent && t.parent.inlineContent && r && t.start(r - 1) == i - 1) && n.push(r);
  }
  return n;
}
class We extends ye {
  ...
  apply(e) {
    let t = e.nodeAt(this.pos);
    if (!t) return ke.fail("No node at attribute step's position");
    let n = Object.create(null);
    for (let e in t.attrs) n[e] = t.attrs[e];
    n[this.attr] = this.value;
    let i = t.type.create(n, null, t.marks);
    return ke.fromReplace(e, this.pos, this.pos + 1, new c(r.from(i), 0, t.isLeaf ? 0 : 1));
  }
  getMap() {
    return fe.empty;
  }
...
ye.jsonID("docAttr", He);
let Ue = class extends Error {};
Ue = function e(t) {
  let n = Error.call(this, t);
  return n.__proto__ = e.prototype, n;
}, (Ue.prototype = Object.create(Error.prototype)).constructor = Ue, Ue.prototype.name = "TransformError";
class Ke {
  constructor(e) {
    this.doc = e, this.steps = [], this.docs = [], this.mapping = new me();
  }
  get before() {
  ...
  step(e) {
    ...
    if (t.failed) throw new Ue(t.failed);
    return this;
  }
  maybeStep(e) {
  ...
  replace(e, t = e, n = c.empty) {
    let r = Re(this.doc, e, t, n);
    return r && this.step(r), this;
  }
  replaceWith(e, t, n) {
    return this.replace(e, t, new c(r.from(n), 0, 0));
  }
  delete(e, t) {
  ...
  replaceRange(e, t, n) {
    return function (e, t, n, r) {
      ...
      let i = e.doc.resolve(t),
        o = e.doc.resolve(n);
      if (ze(i, o, r)) return e.step(new ve(t, n, r));
      let s = Je(i, o);
      ...
      for (let e = r.content, t = 0;; t++) {
        let n = e.firstChild;
        if (h.push(n), t == r.openStart) break;
        e = n.content;
      }
      for (let e = u - 1; e >= 0; e--) {
        let t = h[e],
          n = Ve(t.type);
        if (n && !t.sameMarkup(i.node(Math.abs(l) - 1))) u = e;else if (n || !t.type.isTextblock) break;
      }
      for (let t = r.openStart; t >= 0; t--) {
        let l = (t + u + 1) % (r.openStart + 1),
          p = h[l];
        if (p) for (let t = 0; t < s.length; t++) {
          let h = s[(t + a) % s.length],
            u = !0;
          h < 0 && (u = !1, h = -h);
          let d = i.node(h - 1),
            f = i.index(h - 1);
          if (d.canReplaceWith(f, f, p.type, p.marks)) return e.replace(i.before(h), u ? o.after(h) : n, new c(je(r.content, 0, r.openStart, l), l, r.openEnd));
        }
      }
      let p = e.steps.length;
      for (let l = s.length - 1; l >= 0 && (e.replace(t, n, r), !(e.steps.length > p)); l--) {
        let e = s[l];
  ...
  replaceRangeWith(e, t, n) {
    return function (e, t, n, i) {
      ...
      e.replaceRange(t, n, new c(r.from(i), 0, 0));
    }(this, e, t, n), this;
  }
  deleteRange(e, t) {
    return function (e, t, n) {
      ...
      for (let t = 0; t < o.length; t++) {
        let n = o[t],
          s = t == o.length - 1;
        if (s && 0 == n || r.node(n).type.contentMatch.validEnd) return e.delete(r.start(n), i.end(n));
        if (n > 0 && (s || r.node(n - 1).canReplace(r.index(n - 1), i.indexAfter(n - 1)))) return e.delete(r.before(n), i.after(n));
      }
      for (let o = 1; o <= r.depth && o <= i.depth; o++) if (t - r.start(o) == r.depth - o && n > r.end(o) && i.end(o) - n != i.depth - o && r.start(o - 1) == i.start(o - 1) && r.node(o - 1).canReplace(r.index(o - 1), i.index(o - 1))) return e.delete(r.before(o), n);
      e.delete(t, n);
    }(this, e, t), this;
  }
  lift(e, t) {
    return function (e, t, n) {
      let {
        ...
        p = r.empty,
        d = 0;
      for (let e = s, t = !1; e > n; e--) t || i.index(e) > 0 ? (t = !0, p = r.from(i.node(e).copy(p)), d++) : h--;
      let f = r.empty,
        m = 0;
      for (let e = s, t = !1; e > n; e--) t || o.after(e + 1) < o.end(e) ? (t = !0, f = r.from(o.node(e).copy(f)), m++) : u++;
      e.step(new _e(h, u, l, a, new c(p.append(f), d, m), p.size - d, !0));
    }(this, e, t), this;
  }
  join(e, t = 1) {
    return function (e, t, n) {
      ...
      if (!1 === r) {
        ...
        Ne(e, r.node(), r.before(), l);
      }
      s.inlineContent && Ee(e, t + n - 1, s, o.node().contentMatchAt(o.index()), null == r);
      let a = e.mapping.slice(l),
        h = a.map(t - n);
      if (e.step(new ve(h, a.map(t + n, -1), c.empty, !0)), !0 === r) {
        let t = e.doc.resolve(h);
        Oe(e, t.node(), t.before(), e.steps.length);
      }
    }(this, e, t), this;
  }
  wrap(e, t) {
    return function (e, t, n) {
      ...
      let o = t.start,
        s = t.end;
      e.step(new _e(o, s, o, s, new c(i, 0, 0), n.length, !0));
    }(this, e, t), this;
  }
  setBlockType(e, t = e, n, i = null) {
    return function (e, t, n, i, o) {
      ...
      e.doc.nodesBetween(t, n, (t, n) => {
        ...
        if (t.isTextblock && !t.hasMarkup(i, l) && function (e, t, n) {
          let r = e.resolve(t),
            i = r.index();
          ...
          !1 === o && Ne(e, t, n, s), Ee(e, e.mapping.slice(s).map(n, 1), i, void 0, null === o);
          let a = e.mapping.slice(s),
            h = a.map(n, 1),
            u = a.map(n + t.nodeSize, 1);
          return e.step(new _e(h, u, h + 1, u - 1, new c(r.from(i.create(l, null, t.marks)), 0, 0), 1, !0)), !0 === o && Oe(e, t, n, s), !1;
        }
      });
    }(this, e, t, n, i), this;
  }
  setNodeMarkup(e, t, n = null, i) {
    return function (e, t, n, i, o) {
      ...
      e.step(new _e(t, t + s.nodeSize, t + 1, t + s.nodeSize - 1, new c(r.from(l), 0, 0), 1, !0));
    }(this, e, t, n, i), this;
  }
  ...
  removeNodeMark(e, t) {
    ...
    if (t instanceof l) t.isInSet(n.marks) && this.step(new De(e, t));else {
      let r,
        i = n.marks,
        o = [];
      for (; r = t.isInSet(i);) o.push(new De(e, r)), i = r.removeFromSet(i);
      for (let e = o.length - 1; e >= 0; e--) this.step(o[e]);
    }
    return this;
  }
  split(e, t = 1, n) {
    return function (e, t, n = 1, i) {
      let o = e.doc.resolve(t),
        s = r.empty,
        l = r.empty;
      for (let e = o.depth, t = o.depth - n, a = n - 1; e > t; e--, a--) {
        s = r.from(o.node(e).copy(s));
        let t = i && i[a];
        l = r.from(t ? t.type.create(t.attrs, l) : o.node(e).copy(l));
      }
      e.step(new ve(t, t, new c(s.append(l), n, n), !0));
    }(this, e, t, n), this;
  }
  addMark(e, t, n) {
    return function (e, t, n, r) {
      ...
      e.doc.nodesBetween(t, n, (e, a, c) => {
        ...
        if (!r.isInSet(h) && c.type.allowsMarkType(r.type)) {
          let c = Math.max(a, t),
            u = Math.min(a + e.nodeSize, n),
            p = r.addToSet(h);
          for (let e = 0; e < h.length; e++) h[e].isInSet(p) || (i && i.to == c && i.mark.eq(h[e]) ? i.to = u : s.push(i = new Ce(c, u, h[e])));
          o && o.to == c ? o.to = u : l.push(o = new we(c, u, r));
        }
      }), s.forEach(t => e.step(t)), l.forEach(t => e.step(t));
    }(this, e, t, n), this;
  }
  removeMark(e, t, n) {
    return function (e, t, n, r) {
      ...
      }), i.forEach(t => e.step(new Ce(t.from, t.to, t.style)));
    }(this, e, t, n), this;
  }
...
class Ge {
  ...
  replace(e, t = c.empty) {
    ...
    for (let s = 0; s < o.length; s++) {
      let {
        ...
        h = e.mapping.slice(i);
      e.replaceRange(h.map(l.pos), h.map(a.pos), s ? c.empty : t), 0 == s && lt(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1);
    }
  }
  replaceWith(e, t) {
    ...
    for (let i = 0; i < r.length; i++) {
      let {
        ...
        a = l.map(o.pos),
        c = l.map(s.pos);
      i ? e.deleteRange(a, c) : (e.replaceRangeWith(a, c, t), lt(e, n, t.isInline ? -1 : 1));
    }
  }
  static findFrom(e, t, n = !1) {
    let r = e.parent.inlineContent ? new et(e) : st(e.node(0), e.parent, e.pos, e.index(), t, n);
    if (r) return r;
    for (let r = e.depth - 1; r >= 0; r--) {
      let i = t < 0 ? st(e.node(0), e.node(r), e.before(r + 1), e.index(r), t, n) : st(e.node(0), e.node(r), e.after(r + 1), e.index(r) + 1, t, n);
      if (i) return i;
    }
    return null;
  }
  ...
  static atStart(e) {
    return st(e, e, 0, 0, 1) || new it(e);
  }
  static atEnd(e) {
    return st(e, e, e.content.size, e.childCount, -1) || new it(e);
  }
  static fromJSON(e, t) {
  ...
  static jsonID(e, t) {
    if (e in Ze) throw new RangeError("Duplicate use of selection JSON ID " + e);
    return Ze[e] = t, t.prototype.jsonID = e, t;
  }
  getBookmark() {
    return et.between(this.$anchor, this.$head).getBookmark();
  }
}
...
let Xe = !1;
function Ye(e) {
  Xe || e.parent.inlineContent || (Xe = !0, console.warn("TextSelection endpoint not pointing into a node with inline content (" + e.parent.type.name + ")"));
}
class et extends Ge {
  constructor(e, t = e) {
    Ye(e), Ye(t), super(e, t);
  ...
  map(e, t) {
    ...
    if (!n.parent.inlineContent) return Ge.near(n);
    let r = e.resolve(t.map(this.anchor));
    return new et(r.parent.inlineContent ? r : n, n);
  }
  replace(e, t = c.empty) {
  ...
  eq(e) {
    return e instanceof et && e.anchor == this.anchor && e.head == this.head;
  }
  getBookmark() {
    return new tt(this.anchor, this.head);
  }
  toJSON() {
    return {
      type: "text",
  ...
  static between(e, t, n) {
    ...
    if (n && !r || (n = r >= 0 ? 1 : -1), !t.parent.inlineContent) {
      let e = Ge.findFrom(t, n, !0) || Ge.findFrom(t, -n, !0);
      if (!e) return Ge.near(t, n);
      t = e.$head;
    }
    return e.parent.inlineContent || (0 == r || (e = (Ge.findFrom(e, -n, !0) || Ge.findFrom(e, n, !0)).$anchor).pos < t.pos != r < 0) && (e = t), new et(e, t);
  }
}
Ge.jsonID("text", et);
class tt {
  ...
  map(e) {
    return new tt(e.map(this.anchor), e.map(this.head));
  }
  resolve(e) {
    return et.between(e.resolve(this.anchor), e.resolve(this.head));
  }
}
class nt extends Ge {
  constructor(e) {
  ...
  map(e, t) {
    let {
      ...
      i = e.resolve(r);
    return n ? Ge.near(i) : new nt(i);
  }
  content() {
    return new c(r.from(this.node), 0, 0);
  }
  eq(e) {
    return e instanceof nt && e.anchor == this.anchor;
  }
  toJSON() {
    return {
      type: "node",
  ...
  static fromJSON(e, t) {
    ...
    return new nt(e.resolve(t.anchor));
  }
  static create(e, t) {
    return new nt(e.resolve(t));
  }
  static isSelectable(e) {
    return !e.isText && !1 !== e.type.spec.selectable;
  }
}
nt.prototype.visible = !1, Ge.jsonID("node", nt);
class rt {
  constructor(e) {
    this.anchor = e;
  }
  map(e) {
    ...
    return t ? new tt(n, n) : new rt(n);
  }
  resolve(e) {
    let t = e.resolve(this.anchor),
      n = t.nodeAfter;
    return n && nt.isSelectable(n) ? new nt(t) : Ge.near(t);
  }
}
class it extends Ge {
  constructor(e) {
...
function st(e, t, n, r, i, o = !1) {
  if (t.inlineContent) return et.create(e, n);
  for (let s = r - (i > 0 ? 0 : 1); i > 0 ? s < t.childCount : s >= 0; s += i) {
    let r = t.child(s);
    if (r.isAtom) {
      if (!o && nt.isSelectable(r)) return nt.create(e, n - (i < 0 ? r.nodeSize : 0));
    } else {
      let t = st(e, r, n + i, i < 0 ? r.childCount : 0, i, o);
      if (t) return t;
    }
    n += r.nodeSize * i;
  }
...
function lt(e, t, n) {
  ...
  let i,
    o = e.steps[r];
  (o instanceof ve || o instanceof _e) && (e.mapping.maps[r].forEach((e, t, n, r) => {
    null == i && (i = r);
  }), e.setSelection(Ge.near(e.doc.resolve(i), n)));
}
class at extends Ke {
  constructor(e) {
  ...
  insertText(e, t, n) {
    ...
    if (null == t) return e ? this.replaceSelectionWith(r.text(e), !0) : this.deleteSelection();
    {
      ...
      return this.replaceRangeWith(t, n, r.text(e, i)), this.selection.empty || this.selection.to != t + e.length || this.setSelection(Ge.near(this.selection.$to)), this;
    }
  }
  setMeta(e, t) {
...
const ut = [new ht("doc", {
  ...
  init: (e, t) => e.selection || Ge.atStart(t.doc),
  apply: e => e.selection
}), new ht("storedMarks", {
...
class pt {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = Object.create(null), this.fields = ut.slice(), t && t.forEach(e => {
      if (this.pluginsByKey[e.key]) throw new RangeError("Adding different instances of a keyed plugin (" + e.key + ")");
      this.plugins.push(e), this.pluginsByKey[e.key] = e, e.spec.state && this.fields.push(new ht(e.key, e.spec.state, e));
    });
  }
}
class dt {
    ...
    for (;;) {
      ...
      for (let o = 0; o < this.config.plugins.length; o++) {
        ...
        if (s.spec.appendTransaction) {
          let l = r ? r[o].n : 0,
            a = r ? r[o].state : this,
            c = l < t.length && s.spec.appendTransaction.call(s, l ? t.slice(l) : t, a, n);
  ...
  static create(e) {
    let t = new pt(e.doc ? e.doc.type.schema : e.schema, e.plugins),
      n = new dt(t);
    for (let r = 0; r < t.fields.length; r++) n[t.fields[r].name] = t.fields[r].init(e, n);
    return n;
  }
  reconfigure(e) {
    let t = new pt(this.schema, e.plugins),
      n = t.fields,
      r = new dt(t);
  ...
  static fromJSON(e, t, n) {
    ...
    let r = new pt(e.schema, e.plugins),
      i = new dt(r);
    return r.fields.forEach(r => {
      if ("doc" == r.name) i.doc = E.fromJSON(e.schema, t.doc);else if ("selection" == r.name) i.selection = Ge.fromJSON(i.doc, t.selection);else if ("storedMarks" == r.name) t.storedMarks && (i.storedMarks = t.storedMarks.map(e.schema.markFromJSON));else {
        if (n) for (let o in n) {
          let s = n[o],
            l = s.spec.state;
          if (s.key == r.name && l && l.fromJSON && Object.prototype.hasOwnProperty.call(t, o)) return void (i[r.name] = l.fromJSON.call(s, e, t[o], i));
        }
        i[r.name] = r.init(e, i);
      }
    }), i;
...
function ft(e, t, n) {
  for (let r in e) {
    let i = e[r];
    i instanceof Function ? i = i.bind(t) : "handleDOMEvents" == r && (i = ft(i, t, {})), n[r] = i;
  }
  return n;
}
class mt {
  constructor(e) {
    this.spec = e, this.props = {}, e.props && ft(e.props, this, this.props), this.key = e.key ? e.key.key : yt("plugin");
  }
  getState(e) {
    return e[this.key];
  }
...
function yt(e) {
  return e in gt ? e + "$" + ++gt[e] : (gt[e] = 0, e + "$");
}
class kt {
  constructor(e = "key") {
    this.key = yt(e);
...
const bt = (e, t) => !e.selection.empty && (t && t(e.tr.deleteSelection().scrollIntoView()), !0);
function wt(e, t, n = !1) {
...
const vt = (e, t) => {
  ...
  if (e.selection instanceof nt && e.selection.node.isBlock) return !(!n.parentOffset || !Fe(e.doc, n.pos) || (t && t(e.tr.split(n.pos).scrollIntoView()), 0));
  if (!n.depth) return !1;
  let i,
    o,
    s = [],
  ...
  for (let e = n.depth;; e--) {
    if (n.node(e).isBlock) {
      l = n.end(e) == n.pos + (n.depth - e), a = n.start(e) == n.pos - (n.depth - e), o = Dt(n.node(e - 1).contentMatchAt(n.indexAfter(e - 1)));
      let t = _t && _t(r.parent, l, n);
      s.unshift(t || (l && o ? {
        type: o
      } : null)), i = e;
      break;
  ...
  let c = e.tr;
  (e.selection instanceof et || e.selection instanceof it) && c.deleteSelection();
  let h = c.mapping.map(n.pos),
    u = Fe(c.doc, h, s.length, s);
  if (u || (s[0] = o ? {
    type: o
  } : null, u = Fe(c.doc, h, s.length, s)), !u) return !1;
  if (c.split(h, s.length, s), !l && a && n.node(i).type != o) {
    let e = c.mapping.map(n.before(i)),
      t = c.doc.resolve(e);
    o && n.node(i - 1).canReplaceWith(t.index(), t.index() + 1, o) && c.setNodeMarkup(c.mapping.map(n.before(i)), o);
  }
...
function St(e, t, n, i) {
  ...
  if (!h && function (e, t, n) {
    let r = t.nodeBefore,
      i = t.nodeAfter,
      o = t.index();
    return !(!(r && i && r.type.compatibleContent(i.type)) || (!r.content.size && t.parent.canReplace(o - 1, o) ? (n && n(e.tr.delete(t.pos - r.nodeSize, t.pos).scrollIntoView()), 0) : !t.parent.canReplace(o, o + 1) || !i.isTextblock && !Te(e.doc, t.pos) || (n && n(e.tr.join(t.pos).scrollIntoView()), 0)));
  }(e, t, n)) return !0;
  let u = !h && t.parent.canReplace(t.index(), t.index() + 1);
  if (u && (o = (s = l.contentMatchAt(l.childCount)).findWrapping(a.type)) && s.matchType(o[0] || a.type).validEnd) {
    if (n) {
      let i = t.pos + a.nodeSize,
        s = r.empty;
      for (let e = o.length - 1; e >= 0; e--) s = r.from(o[e].create(null, s));
      s = r.from(l.copy(s));
      let h = e.tr.step(new _e(t.pos - 1, i, t.pos, i, new c(s, 1, 0), o.length, !0)),
        u = h.doc.resolve(i + 2 * o.length);
      u.nodeAfter && u.nodeAfter.type == l.type && Te(h.doc, u.pos) && h.join(u.pos), n(h.scrollIntoView());
    }
    return !0;
  }
  let p = a.type.spec.isolating || i > 0 && h ? null : Ge.findFrom(t, 1),
    d = p && p.$from.blockRange(p.$to),
    f = d && Me(d);
  if (null != f && f >= t.depth) return n && n(e.tr.lift(d, f).scrollIntoView()), !0;
  if (u && wt(a, "start", !0) && wt(l, "end")) {
    let i = l,
      o = [];
    ...
    if (i.canReplace(i.childCount, i.childCount, s.content)) {
      if (n) {
        let i = r.empty;
        for (let e = o.length - 1; e >= 0; e--) i = r.from(o[e].copy(i));
        n(e.tr.step(new _e(t.pos - o.length, t.pos + a.nodeSize, t.pos + h, t.pos + a.nodeSize - h, new c(i, o.length, 0), 0, !0)).scrollIntoView());
      }
      return !0;
    }
  }
...
function Et(e) {
  return function (t, n) {
    ...
    return !!i.node(o).isTextblock && (n && n(t.tr.setSelection(et.create(t.doc, e < 0 ? i.start(o) : i.end(o)))), !0);
  };
}
const At = Et(-1),
  Mt = Et(1);
...
let Nt = Ot(bt, (e, t, n) => {
    ...
    let o = i.nodeBefore;
    if (St(e, i, t, -1)) return !0;
    if (0 == r.parent.content.size && (wt(o, "end") || nt.isSelectable(o))) for (let n = r.depth;; n--) {
      let s = Re(e.doc, r.before(n), r.after(n), c.empty);
      if (s && s.slice.size < s.to - s.from) {
        if (t) {
          let n = e.tr.step(s);
          n.setSelection(wt(o, "end") ? Ge.findFrom(n.doc.resolve(n.mapping.map(i.pos, -1)), -1) : nt.create(n.doc, i.pos - o.nodeSize)), t(n.scrollIntoView());
        }
        return !0;
      }
      if (1 == n || r.node(n - 1).childCount > 1) break;
    }
    return !(!o.isAtom || i.depth != r.depth - 1) && (t && t(e.tr.delete(i.pos - o.nodeSize, i.pos).scrollIntoView()), !0);
  }, (e, t, n) => {
    let {
        $head: r,
        empty: i
    ...
    return !(!s || !nt.isSelectable(s)) && (t && t(e.tr.setSelection(nt.create(e.doc, o.pos - s.nodeSize)).scrollIntoView()), !0);
  }),
  Ft = Ot(bt, (e, t, n) => {
    let r = function (e, t) {
      let {
    ...
    let o = i.nodeAfter;
    if (St(e, i, t, 1)) return !0;
    if (0 == r.parent.content.size && (wt(o, "start") || nt.isSelectable(o))) {
      let n = Re(e.doc, r.before(), r.after(), c.empty);
      if (n && n.slice.size < n.to - n.from) {
        if (t) {
          let r = e.tr.step(n);
          r.setSelection(wt(o, "start") ? Ge.findFrom(r.doc.resolve(r.mapping.map(i.pos)), 1) : nt.create(r.doc, r.mapping.map(i.pos))), t(r.scrollIntoView());
        }
        return !0;
      }
    }
    return !(!o.isAtom || i.depth != r.depth - 1) && (t && t(e.tr.delete(i.pos, i.pos + o.nodeSize).scrollIntoView()), !0);
  }, (e, t, n) => {
    let {
        $head: r,
        empty: i
    ...
    let s = o && o.nodeAfter;
    return !(!s || !nt.isSelectable(s)) && (t && t(e.tr.setSelection(nt.create(e.doc, o.pos)).scrollIntoView()), !0);
  });
const Tt = {
    Enter: Ot((e, t) => {
      let {
      ...
      if (n instanceof it || r.parent.inlineContent || i.parent.inlineContent) return !1;
      let o = Dt(i.parent.contentMatchAt(i.indexAfter()));
      if (!o || !o.isTextblock) return !1;
      if (t) {
        let n = (!r.parentOffset && i.index() < i.parent.childCount ? r : i).pos,
          s = e.tr.insert(n, o.createAndFill());
        s.setSelection(et.create(s.doc, n + 1)), t(s.scrollIntoView());
      }
      return !0;
    }, (e, t) => {
      let {
      ...
      if (n.depth > 1 && n.after() != n.end(-1)) {
        let r = n.before();
        if (Fe(e.doc, r)) return t && t(e.tr.split(r).scrollIntoView()), !0;
      }
      let r = n.blockRange(),
        i = r && Me(r);
    ...
    "Mod-Enter": (e, t) => {
      ...
      let i = n.node(-1),
        o = n.indexAfter(-1),
        s = Dt(i.contentMatchAt(o));
      if (!s || !i.canReplaceWith(o, o, s)) return !1;
      if (t) {
        let r = n.after(),
          i = e.tr.replaceWith(r, r, s.createAndFill());
        i.setSelection(Ge.near(i.doc.resolve(r), 1)), t(i.scrollIntoView());
      }
      return !0;
    },
    Backspace: Nt,
    ...
    Delete: Ft,
    "Mod-Delete": Ft,
    "Mod-a": (e, t) => (t && t(e.tr.setSelection(new it(e.doc))), !0)
  },
  Rt = {
    "Ctrl-h": Tt.Backspace,
...
for (let e in Tt) Rt[e] = Tt[e];
const zt = ("undefined" != typeof navigator ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !("undefined" == typeof os || !os.platform) && "darwin" == os.platform()) ? Rt : Tt;
var It = 200,
  Bt = function () {};
Bt.prototype.append = function (e) {
  return e.length ? (e = Bt.from(e), !this.length && e || e.length < It && this.leafAppend(e) || this.length < It && e.leafPrepend(this) || this.appendInner(e)) : this;
  ...
  return void 0 === e && (e = 0), void 0 === t && (t = this.length), e >= t ? Bt.empty : this.sliceInner(Math.max(0, e), Math.min(this.length, t));
}, Bt.prototype.get = function (e) {
  if (!(e < 0 || e >= this.length)) return this.getInner(e);
}, Bt.prototype.forEach = function (e, t, n) {
  void 0 === t && (t = 0), void 0 === n && (n = this.length), t <= n ? this.forEachInner(e, t, n, 0) : this.forEachInvertedInner(e, t, n, 0);
}, Bt.prototype.map = function (e, t, n) {
  ...
  return e instanceof Bt ? e : e && e.length ? new Pt(e) : Bt.empty;
};
var Pt = function (e) {
  function t(t) {
...
var Lt = function (e) {
  ...
  return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.flatten = function () {
    ...
    return !(t < i && !1 === this.left.forEachInner(e, t, Math.min(n, i), r)) && !(n > i && !1 === this.right.forEachInner(e, Math.max(t - i, 0), Math.min(this.length, n) - i, r + i)) && void 0;
  }, t.prototype.forEachInvertedInner = function (e, t, n, r) {
    var i = this.left.length;
    return !(t > i && !1 === this.right.forEachInvertedInner(e, t - i, Math.max(n, i) - i, r + i)) && !(n < i && !1 === this.left.forEachInvertedInner(e, Math.min(t, i), n, r)) && void 0;
...
class qt {
  ...
  popEvent(e, t) {
    ...
    return this.items.forEach((e, t) => {
      if (!e.step) return n || (n = this.remapping(i, t + 1), r = n.maps.length), r--, void c.push(e);
      if (n) {
        c.push(new $t(e.map));
        let t,
          i = e.step.map(n.slice(r));
        i && l.maybeStep(i).doc && (t = l.mapping.maps[l.mapping.maps.length - 1], a.push(new $t(t, void 0, void 0, a.length + c.length))), r--, t && n.appendMap(t, r);
      } else l.maybeStep(e.step);
      return e.selection ? (o = n ? e.selection.map(n.slice(r)) : e.selection, s = new qt(this.items.slice(0, i).append(c.reverse().concat(a)), this.eventCount - 1), !1) : void 0;
    }, this.items.length, 0), {
      remaining: s,
      transform: l,
      selection: o
  ...
  addTransform(e, t, n, r) {
    ...
    for (let n = 0; n < e.steps.length; n++) {
      let a,
        ...
        h = new $t(e.mapping.maps[n], c, t);
      (a = l && l.merge(h)) && (h = a, n ? i.pop() : s = s.slice(0, s.length - 1)), i.push(h), t && (o++, t = void 0), r || (l = h);
    }
    let a = o - n.depth;
    return a > jt && (s = function (e, t) {
      let n;
      return e.forEach((e, r) => {
        if (e.selection && 0 == t--) return n = r, !1;
      }), e.slice(n);
    }(s, a), o -= a), new qt(s.append(i), o);
  }
  remapping(e, t) {
    let n = new me();
  ...
  addMaps(e) {
    return 0 == this.eventCount ? this : new qt(this.items.append(e.map(e => new $t(e))), this.eventCount);
  }
  rebased(e, t) {
    ...
    this.items.forEach(t => {
      ...
      if (t.step) {
        let o = e.steps[r].invert(e.docs[r]),
          c = t.selection && t.selection.map(i.slice(l + 1, r));
        c && s++, n.push(new $t(a, o, c));
      } else n.push(new $t(a));
    }, r);
    let a = [];
    for (let e = t; e < o; e++) a.push(new $t(i.maps[e]));
    ...
    return this.items.forEach((o, s) => {
      if (s >= e) r.push(o), o.selection && i++;else if (o.step) {
        ...
        if (n--, s && t.appendMap(s, n), e) {
          ...
          l && i++;
          let a,
            c = new $t(s.invert(), e, l),
            h = r.length - 1;
          (a = r.length && r[h].merge(c)) ? r[h] = a : r.push(c);
        }
      } else o.map && n--;
    }, this.items.length, 0), new qt(Bt.from(r.reverse()), i);
  }
}
qt.empty = new qt(Bt.empty, 0);
class $t {
  constructor(e, t, n, r) {
...
const Zt = new kt("history"),
  Gt = new kt("closeHistory");
function Qt(e = {}) {
  return e = {
    depth: e.depth || 100,
    ...
    key: Zt,
    state: {
      init: () => new Vt(qt.empty, qt.empty, null, 0, -1),
      apply: (t, n, r) => function (e, t, n, r) {
        let i,
          o = n.getMeta(Zt);
        if (o) return o.historyState;
        n.getMeta(Gt) && (e = new Vt(e.done, e.undone, null, 0, -1));
        let s = n.getMeta("appendedTransaction");
        if (0 == n.steps.length) return e;
        if (s && s.getMeta(Zt)) return s.getMeta(Zt).redo ? new Vt(e.done.addTransform(n, void 0, r, Kt(t)), e.undone, Jt(n.mapping.maps), e.prevTime, e.prevComposition) : new Vt(e.done, e.undone.addTransform(n, void 0, r, Kt(t)), null, e.prevTime, e.prevComposition);
        if (!1 === n.getMeta("addToHistory") || s && !1 === s.getMeta("addToHistory")) return (i = n.getMeta("rebased")) ? new Vt(e.done.rebased(n, i), e.undone.rebased(n, i), Wt(e.prevRanges, n.mapping), e.prevTime, e.prevComposition) : new Vt(e.done.addMaps(n.mapping.maps), e.undone.addMaps(n.mapping.maps), Wt(e.prevRanges, n.mapping), e.prevTime, e.prevComposition);
        {
          let i = n.getMeta("composition"),
            o = 0 == e.prevTime || !s && e.prevComposition != i && (e.prevTime < (n.time || 0) - r.newGroupDelay || !function (e, t) {
              if (!t) return !1;
            ...
            l = s ? Wt(e.prevRanges, n.mapping) : Jt(n.mapping.maps);
          return new Vt(e.done.addTransform(n, o ? t.selection.getBookmark() : void 0, r, Kt(t)), qt.empty, l, n.time, null == i ? e.prevComposition : i);
        }
      }(n, r, t, e)
    },
    config: e,
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let n = t.inputType,
            r = "historyUndo" == n ? Yt : "historyRedo" == n ? en : null;
    ...
    if (r) {
      let o = function (e, t, n) {
        ...
        let s = o.selection.resolve(o.transform.doc),
          ...
          a = new Vt(n ? l : o.remaining, n ? o.remaining : l, null, 0, -1);
        return o.transform.setSelection(s).setMeta(Zt, {
          redo: n,
          historyState: a
        });
      }(i, n, e);
...
for (var tn = {
    ...
    221: "}",
    222: '"'
  }, rn = "undefined" != typeof navigator && /Mac/.test(navigator.platform), on = "undefined" != typeof navigator && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), sn = 0; sn < 10; sn++) tn[48 + sn] = tn[96 + sn] = String(sn);
for (sn = 1; sn <= 24; sn++) tn[sn + 111] = "F" + sn;
for (sn = 65; sn <= 90; sn++) tn[sn] = String.fromCharCode(sn + 32), nn[sn] = String.fromCharCode(sn);
for (var ln in tn) nn.hasOwnProperty(ln) || (nn[ln] = tn[ln]);
...
function hn(e) {
  ...
  for (let e = 0; e < o.length - 1; e++) {
    let s = o[e];
    if (/^(cmd|meta|m)$/i.test(s)) i = !0;else if (/^a(lt)?$/i.test(s)) t = !0;else if (/^(c|ctrl|control)$/i.test(s)) n = !0;else if (/^s(hift)?$/i.test(s)) r = !0;else {
...
function dn(e) {
  let t = function (e) {
    let t = Object.create(null);
    for (let n in e) t[hn(n)] = e[n];
    return t;
  }(e);
  return function (e, n) {
    let r,
      i = function (e) {
        var t = !(rn && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || on && e.shiftKey && e.key && 1 == e.key.length || "Unidentified" == e.key) && e.key || (e.shiftKey ? nn : tn)[e.keyCode] || e.key || "Unidentified";
    ...
    if (1 == i.length && " " != i) {
      ...
      if ((n.altKey || n.metaKey || n.ctrlKey) && !(cn && n.ctrlKey && n.altKey) && (r = tn[n.keyCode]) && r != i) {
        let i = t[un(r, n)];
...
const Sn = function (e, t, n) {
  ...
  En = function (e, t, n, r) {
    return n && (Mn(e, t, n, r, -1) || Mn(e, t, n, r, 1));
  },
...
function Mn(e, t, n, r, i) {
  for (var o;;) {
    ...
    if (t == (i < 0 ? 0 : On(e))) {
      let n = e.parentNode;
      if (!n || 1 != n.nodeType || Nn(e) || An.test(e.nodeName) || "false" == e.contentEditable) return !1;
      t = Dn(e) + (i < 0 ? 0 : 1), e = n;
    } else {
...
const Rn = "undefined" != typeof navigator ? navigator : null,
  ...
  qn = !!(Pn || Ln || Bn),
  $n = Pn ? document.documentMode : Ln ? +Ln[1] : Bn ? +Bn[1] : 0,
  Vn = !qn && /gecko\/(\d+)/i.test(In);
Vn && (/Firefox\/(\d+)/.exec(In) || [0, 0])[1];
const jn = !qn && /Chrome\/(\d+)/.exec(In),
  Jn = !!jn,
  Wn = jn ? +jn[1] : 0,
  Hn = !qn && !!Rn && /Apple Computer/.test(Rn.vendor),
...
function nr(e, t, n) {
  ...
  for (let s = n || e.dom; s;) {
    ...
    let e = s,
      ...
      a = 0,
      c = 0;
    if (t.top < l.top + er(r, "top") ? c = -(l.top - t.top + er(i, "top")) : t.bottom > l.bottom - er(r, "bottom") && (c = t.bottom - t.top > l.bottom - l.top ? t.top + er(i, "top") - l.top : t.bottom - l.bottom + er(i, "bottom")), t.left < l.left + er(r, "left") ? a = -(l.left - t.left + er(i, "left")) : t.right > l.right - er(r, "right") && (a = t.right - l.right + er(i, "right")), a || c) if (n) o.defaultView.scrollBy(a, c);else {
      let n = e.scrollLeft,
        r = e.scrollTop;
...
function sr(e, t) {
  ...
  for (let h = e.firstChild, u = 0; h; h = h.nextSibling, u++) {
    let e;
    if (1 == h.nodeType) e = h.getClientRects();else {
      if (3 != h.nodeType) continue;
      e = Sn(h).getClientRects();
    }
    for (let p = 0; p < e.length; p++) {
      ...
      if (d.top <= a && d.bottom >= c) {
        ...
        if (e < s) {
          n = h, s = e, r = e && 3 == n.nodeType ? {
            left: d.right < t.left ? d.right : d.left,
            top: t.top
          } : t, 1 == h.nodeType && e && (l = u + (t.left >= (d.left + d.right) / 2 ? 1 : 0));
          continue;
        }
      } else d.top > t.top && !i && d.left <= t.left && d.right >= t.left && (i = h, o = {
        left: Math.max(d.left, Math.min(d.right, t.left)),
        top: d.top
      });
      !n && (t.left >= d.right && t.top >= d.top || t.left >= d.left && t.top >= d.bottom) && (l = u + 1);
    }
  }
  return !n && i && (n = i, r = o, s = 0), n && 3 == n.nodeType ? function (e, t) {
    let n,
    ...
    for (let o = 0; o < r; o++) {
      ...
      let r = ur(i, 1);
      if (r.top != r.bottom && lr(t, r)) {
        n = {
          node: e,
          offset: o + (t.left >= (r.left + r.right) / 2 ? 1 : 0)
        };
        break;
      }
    }
...
function ar(e, t, n) {
  ...
  if (r && n.top < n.bottom) for (let i = Math.max(0, Math.min(r - 1, Math.floor(r * (t.top - n.top) / (n.bottom - n.top)) - 2)), o = i;;) {
    let n = e.childNodes[o];
    if (1 == n.nodeType) {
      let e = n.getClientRects();
      for (let r = 0; r < e.length; r++) {
        let i = e[r];
        if (lr(t, i)) return ar(n, t, i);
      }
    }
    if ((o = (o + 1) % r) == i) break;
  }
...
function cr(e, t) {
  ...
  if (!l || !e.dom.contains(1 != l.nodeType ? l.parentNode : l)) {
    ...
    if (!lr(t, n)) return null;
    if (l = ar(e.dom, t, n), !l) return null;
  }
  if (Hn) for (let e = l; n && e; e = vn(e)) e.draggable && (n = void 0);
  if (l = function (e, t) {
    let n = e.parentNode;
    ...
    let r;
    Qn && i && 1 == n.nodeType && 1 == (r = n.childNodes[i - 1]).nodeType && "false" == r.contentEditable && r.getBoundingClientRect().top >= t.top && i--, n == e.dom && i == n.childNodes.length - 1 && 1 == n.lastChild.nodeType && t.top > n.lastChild.getBoundingClientRect().bottom ? s = e.state.doc.content.size : 0 != i && 1 == n.nodeType && "BR" == n.childNodes[i - 1].nodeName || (s = function (e, t, n, r) {
      let i = -1;
      for (let n = t, o = !1; n != e.dom;) {
        let t,
          s = e.docView.nearestDesc(n, !0);
        if (!s) return null;
        if (1 == s.dom.nodeType && (s.node.isBlock && s.parent || !s.contentDOM) && ((t = s.dom.getBoundingClientRect()).width || t.height) && (s.node.isBlock && s.parent && !/^T(R|BODY|HEAD|FOOT)$/.test(s.dom.nodeName) && (!o && t.left > r.left || t.top > r.top ? i = s.posBefore : (!o && t.right < r.left || t.bottom < r.top) && (i = s.posAfter), o = !0), !s.contentDOM && i < 0 && !s.node.isText)) return (s.node.isBlock ? r.top < (t.top + t.bottom) / 2 : r.left < (t.left + t.right) / 2) ? s.posBefore : s.posAfter;
        n = s.dom.parentNode;
      }
...
function ur(e, t) {
  ...
  return Array.prototype.find.call(n, hr) || e.getBoundingClientRect();
}
const pr = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function dr(e, t, n) {
  let {
  ...
  if (3 == r.nodeType) {
    if (!s || !pr.test(r.nodeValue) && (n < 0 ? i : i != r.nodeValue.length)) {
      let e = i,
        t = i,
        o = n < 0 ? 1 : -1;
      return n < 0 && !i ? (t++, o = -1) : n >= 0 && i == r.nodeValue.length ? (e--, o = 1) : n < 0 ? e-- : t++, fr(ur(Sn(r, e, t), o), o < 0);
    }
    {
      let e = ur(Sn(r, i, i), n);
      if (Vn && i && /\s/.test(r.nodeValue[i - 1]) && i < r.nodeValue.length) {
        let t = ur(Sn(r, i - 1, i - 1), -1);
        if (t.top == e.top) {
  ...
  if (!e.state.doc.resolve(t - (o || 0)).parent.inlineContent) {
    if (null == o && i && (n < 0 || i == On(r))) {
      ...
      if (1 == e.nodeType) return mr(e.getBoundingClientRect(), !1);
    }
    if (null == o && i < On(r)) {
      let e = r.childNodes[i];
      if (1 == e.nodeType) return mr(e.getBoundingClientRect(), !0);
    }
    return mr(r.getBoundingClientRect(), n >= 0);
  }
  if (null == o && i && (n < 0 || i == On(r))) {
    let e = r.childNodes[i - 1],
      t = 3 == e.nodeType ? Sn(e, On(e) - (s ? 0 : 1)) : 1 != e.nodeType || "BR" == e.nodeName && e.nextSibling ? null : e;
    if (t) return fr(ur(t, 1), !1);
  }
  if (null == o && i < On(r)) {
    let e = r.childNodes[i];
    for (; e.pmViewDesc && e.pmViewDesc.ignoreForCoords;) e = e.nextSibling;
    let t = e ? 3 == e.nodeType ? Sn(e, 0, s ? 0 : 1) : 1 == e.nodeType ? e : null : null;
    if (t) return fr(ur(t, -1), !0);
  }
...
let kr = null,
  ...
  wr = !1;
function Cr(e, t, n) {
  return kr == t && br == n ? wr : (kr = t, br = n, wr = "up" == n || "down" == n ? function (e, t, n) {
    let r = t.selection,
      i = "up" == n ? r.$from : r.$to;
    return gr(e, t, () => {
      let {
      ...
      for (let e = t.firstChild; e; e = e.nextSibling) {
        ...
        if (1 == e.nodeType) t = e.getClientRects();else {
          ...
          t = Sn(e, 0, e.nodeValue.length).getClientRects();
        }
    ...
    let i = r.parentOffset,
      ...
      l = e.domSelection();
    return l ? yr.test(r.parent.textContent) && l.modify ? gr(e, t, () => {
      let {
          focusNode: t,
          focusOffset: i,
          anchorNode: o,
      ...
      let c = r.depth ? e.docView.domAfterPos(r.before()) : e.dom,
        ...
        p = h && !c.contains(1 == h.nodeType ? h : h.parentNode) || t == h && i == u;
      try {
...
class xr {
  ...
  localPosFromDOM(e, t, n) {
    ...
    let r;
    if (e == this.dom && this.contentDOM) r = t > Dn(this.contentDOM);else if (this.contentDOM && this.contentDOM != this.dom && this.dom.contains(this.contentDOM)) r = 2 & e.compareDocumentPosition(this.contentDOM);else if (this.dom.firstChild) {
  ...
  nearestDesc(e, t = !1) {
    for (let n = !0, r = e; r; r = r.parentNode) {
      let i,
        o = this.getDesc(r);
      if (o && (!t || o.node)) {
        if (!n || !(i = o.nodeDOM) || (1 == i.nodeType ? i.contains(1 == e.nodeType ? e : e.parentNode) : i == e)) return o;
        n = !1;
      }
    }
  }
  ...
  domFromPos(e, t) {
    ...
    for (let e; n && !(e = this.children[n - 1]).size && e instanceof Dr && e.side >= 0; n--);
    if (t <= 0) {
      let e,
        r = !0;
    ...
    }
    {
      ...
      return e && r && !e.border && !e.domAtom ? e.domFromPos(0, t) : {
        node: this.contentDOM,
        offset: e ? Dn(e.dom) : this.contentDOM.childNodes.length
      };
    }
  }
  parseRange(e, t, n = 0) {
  ...
  setSelection(e, t, n, r = !1) {
    ...
    for (let s = 0, l = 0; s < this.children.length; s++) {
      let a = this.children[s],
        c = l + a.size;
      if (i > l && o < c) return a.setSelection(e - l - a.border, t - l - a.border, n, r);
      l = c;
    }
    ...
    if ((Vn || Hn) && e == t) {
      ...
      if (3 == e.nodeType) {
        if (h = !(!t || "\n" != e.nodeValue[t - 1]), h && t == e.nodeValue.length) for (let t, n = e; n; n = n.parentNode) {
          if (t = n.nextSibling) {
            "BR" == t.nodeName && (s = l = {
              node: t.parentNode,
              offset: Dn(t) + 1
    ...
    let u = !1;
    if ((a.extend || e == t) && (!h || !Vn)) {
      a.collapse(s.node, s.offset);
      try {
        e != t && a.extend(l.node, l.offset), u = !0;
      } catch (e) {}
    }
    if (!u) {
      if (e > t) {
  ...
  markDirty(e, t) {
    for (let n = 0, r = 0; r < this.children.length; r++) {
      ...
      if (n == o ? e <= o && t >= n : e < o && t > n) {
        let r = n + i.border,
          s = o - i.border;
        if (e >= r && t <= s) return this.dirty = e == n || t == o ? 2 : 1, void (e != r || t != s || !i.contentLost && i.dom.parentNode == this.contentDOM ? i.markDirty(e - r, t - r) : i.dirty = 3);
...
class Dr extends xr {
  constructor(e, t, n, r) {
    let i,
      o = t.type.toDOM;
    if ("function" == typeof o && (o = o(n, () => i ? i.parent ? i.parent.posBeforeChild(i) : void 0 : r)), !t.type.spec.raw) {
      if (1 != o.nodeType) {
...
class _r extends xr {
  ...
  static create(e, t, n, r) {
    let i = r.nodeViews[t.type.name],
      o = i && i(t, r, n);
    return o && o.dom || (o = ie.renderSpec(document, t.type.spec.toDOM(t, n), null, t.attrs)), new _r(e, t, o.dom, o.contentDOM || o.dom, o);
  }
  parseRule() {
  ...
  slice(e, t, n) {
    let r = _r.create(this.parent, this.mark, !0, n),
      i = this.children,
      o = this.size;
    t < o && (i = Vr(i, t, o, n)), e > 0 && (i = Vr(i, 0, e, n));
...
class Sr extends xr {
  ...
  static create(e, t, n, r, i, o) {
    ...
    if (t.isText) {
      ...
      let e = ie.renderSpec(document, t.type.spec.toDOM(t), null, t.attrs);
      ({
        dom: c,
        contentDOM: h
      } = e);
    ...
    let u = c;
    return c = Br(c, n, t), a ? s = new Or(e, t, n, r, c, h || null, u, a, i, o + 1) : t.isText ? new Ar(e, t, n, r, c, u, i) : new Sr(e, t, n, r, c, h || null, u, i, o + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, n) {
    return 0 == this.dirty && e.eq(this.node) && Pr(t, this.outerDeco) && n.eq(this.innerDeco);
  }
  get size() {
    ...
    !function (e, t, n, r) {
      ...
      for (let c = 0;;) {
        ...
        for (; s < i.length && i[s].to == o;) {
          let e = i[s++];
          e.widget && (h ? (u || (u = [h])).push(e) : h = e);
        }
        if (h) if (u) {
          u.sort($r);
          for (let e = 0; e < u.length; e++) n(u[e], c, !!a);
        } else n(h, c, !!a);
        ...
        if (p.isText) {
          ...
          e < f && (a = p.cut(e - o), p = p.cut(0, e - o), f = e, d = -1);
        } else for (; s < i.length && i[s].to < f;) s++;
        r(p, p.isInline && !p.isLeaf ? l.filter(e => !e.inline) : l.slice(), t.forChild(o, p), d), o = f;
      }
    }(this.node, this.innerDeco, (t, i, o) => {
      t.spec.marks ? a.syncToMarks(t.spec.marks, n, e) : t.type.side >= 0 && !o && a.syncToMarks(i == this.node.childCount ? l.none : this.node.child(i).marks, n, e), a.placeWidget(t, e, r);
    }, (t, o, l, c) => {
      let h;
      a.syncToMarks(t.marks, n, e), a.findNodeMatch(t, o, l, c) || s && e.state.selection.from > r && e.state.selection.to < r + t.nodeSize && (h = a.findIndexWithChild(i.node)) > -1 && a.updateNodeAt(t, o, l, h, e) || a.updateNextNode(t, o, l, e, c, r) || a.addNode(t, o, l, e, r), r += t.nodeSize;
    }), a.syncToMarks([], n, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || 2 == this.dirty) && (o && this.protectLocalComposition(e, o), Nr(this.contentDOM, this.children, e), Un && function (e) {
  ...
  localCompositionInfo(e, t) {
    ...
    if (!(e.state.selection instanceof et) || n < t || r > t + this.node.content.size) return null;
  ...
  protectLocalComposition(e, {
    ...
    let o = new vr(this, i, t, r);
    e.input.compositionNodes.push(o), this.children = Vr(this.children, n, n + r.length, e, o);
  }
  update(e, t, n, r) {
  ...
  updateOuterDeco(e) {
    if (Pr(e, this.outerDeco)) return;
    let t = 1 != this.nodeDOM.nodeType,
      n = this.dom;
    this.dom = zr(this.dom, this.nodeDOM, Rr(this.outerDeco, this.node, t), Rr(e, this.node, t)), this.dom != n && (n.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
  selectNode() {
...
function Er(e, t, n, r, i) {
  Br(r, t, e);
  let o = new Sr(void 0, e, t, n, r, r, r, i, 0);
...
class Or extends Sr {
  constructor(e, t, n, r, i, o, s, l, a, c) {
    super(e, t, n, r, i, o, s, a, c), this.spec = l;
  }
  update(e, t, n, r) {
...
function Nr(e, t, n) {
  ...
  for (let o = 0; o < t.length; o++) {
    ...
    if (s instanceof _r) {
      ...
      Nr(s.contentDOM, s.children, n), r = t ? t.nextSibling : e.firstChild;
    }
  }
  for (; r;) r = Lr(r), i = !0;
...
function Rr(e, t, n) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s) {
      ...
      for (let e in s) {
        let o = s[e];
        null != o && (n && 1 == i.length && i.push(r = new Fr(t.isInline ? "span" : "div")), "class" == e ? r.class = (r.class ? r.class + " " : "") + o : "style" == e ? r.style = (r.style ? r.style + ";" : "") + o : "nodeName" != e && (r[e] = o));
      }
    }
  }
  return i;
...
function zr(e, t, n, r) {
  ...
  for (let t = 0; t < r.length; t++) {
    ...
    if (t) {
      let t;
      s && s.nodeName == o.nodeName && i != e && (t = i.parentNode) && t.nodeName.toLowerCase() == o.nodeName || (t = document.createElement(o.nodeName), t.pmIsDeco = !0, t.appendChild(i), s = Tr[0]), i = t;
    }
    Ir(i, s || Tr[0], o);
  }
  return i;
...
function Br(e, t, n) {
  return zr(e, e, Tr, Rr(t, n, 1 != e.nodeType));
}
function Pr(e, t) {
  if (e.length != t.length) return !1;
...
class qr {
  ...
  syncToMarks(e, t, n) {
    ...
    for (; r < o && (r == i - 1 ? this.top : this.stack[r + 1 << 1]).matchesMark(e[r]) && !1 !== e[r].type.spec.spanning;) r++;
    ...
    for (; i < e.length;) {
      ...
      if (r > -1) r > this.index && (this.changed = !0, this.destroyBetween(this.index, r)), this.top = this.top.children[this.index];else {
        let r = _r.create(this.top, e[i], t, n);
  ...
  findNodeMatch(e, t, n, r) {
    let i,
      o = -1;
    if (r >= this.preMatch.index && (i = this.preMatch.matches[r - this.preMatch.index]).parent == this.top && i.matchesNode(e, t, n)) o = this.top.children.indexOf(i, this.index);else for (let r = this.index, i = Math.min(this.top.children.length, r + 5); r < i; r++) {
  ...
  updateNodeAt(e, t, n, r, i) {
    ...
    return 3 == o.dirty && o.dom == o.contentDOM && (o.dirty = 2), !!o.update(e, t, n, i) && (this.destroyBetween(this.index, r), this.index++, !0);
  }
  ...
  updateNextNode(e, t, n, r, i, o) {
    for (let s = this.index; s < this.top.children.length; s++) {
      ...
      if (l instanceof Sr) {
        ...
        let c,
          h = l.dom,
          u = this.isLocked(h) && !(e.isText && l.node && l.node.isText && l.nodeDOM.nodeValue == e.text && 3 != l.dirty && Pr(t, l.outerDeco));
        if (!u && l.update(e, t, n, r)) return this.destroyBetween(this.index, s), l.dom != h && (this.changed = !0), this.index++, !0;
        if (!u && (c = this.recreateWrapper(l, e, t, n, r, o))) return this.destroyBetween(this.index, s), this.top.children[this.index] = c, c.contentDOM && (c.dirty = 2, c.updateChildren(r, o + 1), c.dirty = 0), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
  ...
  recreateWrapper(e, t, n, r, i, o) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !Pr(n, e.outerDeco) || !r.eq(e.innerDeco)) return null;
    let s = Sr.create(this.top, t, n, r, i, o);
    if (s.contentDOM) {
  ...
  addNode(e, t, n, r, i) {
    let o = Sr.create(this.top, e, t, n, r, i);
  ...
  addTextblockHacks() {
    let e = this.top.children[this.index - 1],
      t = this.top;
    for (; e instanceof _r;) t = e, e = t.children[t.children.length - 1];
    (!e || !(e instanceof Ar) || /\n$/.test(e.node.text) || this.view.requiresGeckoHackNode && /\s$/.test(e.node.text)) && ((Hn || Jn) && e && "false" == e.dom.contentEditable && this.addHackNode("IMG", t), this.addHackNode("BR", this.top));
  }
  addHackNode(e, t) {
...
function Vr(e, t, n, r, i) {
  ...
  for (let s = 0, l = 0; s < e.length; s++) {
    let a = e[s],
      c = l,
      h = l += a.size;
    c >= n || h <= t ? o.push(a) : (c < t && o.push(a.slice(0, t - c, r)), i && (o.push(i), i = void 0), h > n && o.push(a.slice(n - c, a.size, r)));
  }
  return o;
}
function jr(e, t = null) {
  ...
  if (Fn(n)) {
    ...
    let e = i.node;
    if (i && e.isAtom && nt.isSelectable(e) && i.parent && (!e.isInline || !function (e, t, n) {
      for (let r = 0 == t, i = t == On(e); r || i;) {
        if (e == n) return !0;
        let t = Dn(e);
    ...
    if (n instanceof e.dom.ownerDocument.defaultView.Selection && n.rangeCount > 1) {
      ...
      for (let r = 0; r < n.rangeCount; r++) {
        ...
        t = Math.min(t, e.docView.posFromDOM(o.startContainer, o.startOffset, 1)), i = Math.max(i, e.docView.posFromDOM(o.endContainer, o.endOffset, -1));
      }
      if (t < 0) return null;
      [l, s] = i == e.state.selection.anchor ? [i, t] : [t, i], c = r.resolve(s);
    } else l = e.docView.posFromDOM(n.anchorNode, n.anchorOffset, 1);
    if (l < 0) return null;
  }
  let h = r.resolve(l);
  if (!a) {
    a = Xr(e, h, c, "pointer" == t || e.state.selection.head < c.pos && !o ? 1 : -1);
  }
  return a;
}
function Jr(e) {
  return e.editable ? e.hasFocus() : ei(e) && document.activeElement && document.activeElement.contains(e.dom);
}
function Wr(e, t = !1) {
  let n = e.state.selection;
  if (Gr(e, n), Jr(e)) {
    if (!t && e.input.mouseDown && e.input.mouseDown.allowDefault && Jn) {
    ...
    if (e.domObserver.disconnectSelection(), e.cursorWrapper) !function (e) {
      ...
      let n = e.cursorWrapper.dom,
        r = "IMG" == n.nodeName;
      r ? t.collapse(n.parentNode, Dn(n) + 1) : t.collapse(n, 0);
      !r && !e.state.selection.visible && qn && $n <= 11 && (n.disabled = !0, n.disabled = !1);
    }(e);else {
      let r,
        i,
        {
      ...
      !Hr || n instanceof et || (n.$from.parent.inlineContent || (r = Ur(e, n.from)), n.empty || n.$from.parent.inlineContent || (i = Ur(e, n.to))), e.docView.setSelection(o, s, e, t), Hr && (r && Zr(r), i && Zr(i)), n.visible ? e.dom.classList.remove("ProseMirror-hideselection") : (e.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && function (e) {
        ...
        t.addEventListener("selectionchange", e.input.hideSelectionGuard = () => {
          n.anchorNode == r && n.anchorOffset == i || (t.removeEventListener("selectionchange", e.input.hideSelectionGuard), setTimeout(() => {
            Jr(e) && !e.state.selection.visible || e.dom.classList.remove("ProseMirror-hideselection");
          }, 20));
        });
      }(e));
    }
...
function Gr(e, t) {
  if (t instanceof nt) {
    ...
    n != e.lastSelectedViewDesc && (Qr(e), n && n.selectNode(), e.lastSelectedViewDesc = n);
  } else Qr(e);
}
function Qr(e) {
...
function Xr(e, t, n, r) {
  return e.someProp("createSelectionBetween", r => r(e, t, n)) || et.between(t, n, r);
}
function Yr(e) {
  return !(e.editable && !e.hasFocus()) && ei(e);
}
function ei(e) {
  let t = e.domSelectionRange();
...
function ri(e, t, n) {
  ...
  if (!(r instanceof et)) {
    if (r instanceof nt && r.node.isInline) return ni(e, new et(t > 0 ? r.$to : r.$from));
    {
      let n = ti(e.state, t);
      return !!n && ni(e, n);
    }
  ...
  if (n.indexOf("s") > -1) {
    ...
    return ni(e, new et(r.$anchor, o));
  }
  if (!r.empty) return !1;
  if (e.endOfTextblock(t > 0 ? "forward" : "backward")) {
    let n = ti(e.state, t);
    return !!(n && n instanceof nt) && ni(e, n);
  }
  if (!(Kn && n.indexOf("m") > -1)) {
    let n,
      i = r.$head,
    ...
    return !!(o.isAtom || (n = e.docView.descAt(s)) && !n.contentDOM) && (nt.isSelectable(o) ? ni(e, new nt(t < 0 ? e.state.doc.resolve(i.pos - o.nodeSize) : i)) : !!Qn && ni(e, new et(e.state.doc.resolve(t < 0 ? s : s + o.nodeSize))));
  }
}
function ii(e) {
  return 3 == e.nodeType ? e.nodeValue.length : e.childNodes.length;
  ...
  return t < 0 ? function (e) {
    ...
    for (;;) if (r > 0) {
      ...
      if (li(n)) break;
      {
        ...
        for (; t && oi(t, -1);) i = n.parentNode, o = Dn(t), t = t.previousSibling;
        if (t) n = t, r = ii(n);else {
          if (n = n.parentNode, n == e.dom) break;
          r = 0;
        }
      }
    }
    s ? ai(e, n, r) : i && ai(e, i, o);
  }(e) : function (e) {
    let t = e.domSelectionRange(),
      n = t.focusNode,
      r = t.focusOffset;
    ...
    for (;;) if (r < s) {
      ...
      {
        let t = n.nextSibling;
        for (; t && oi(t, 1);) i = t.parentNode, o = Dn(t) + 1, t = t.nextSibling;
        if (t) n = t, r = 0, s = ii(n);else {
          if (n = n.parentNode, n == e.dom) break;
          r = s = 0;
        }
      }
...
function ai(e, t, n) {
  if (3 != t.nodeType) {
    let e, r;
    (r = function (e, t) {
      for (; e && t == e.childNodes.length && !Nn(e);) t = Dn(e) + 1, e = e.parentNode;
      ...
      for (; e && !t && !Nn(e);) t = Dn(e), e = e.parentNode;
      for (; e && t;) {
        let n = e.childNodes[t - 1];
        if (3 == n.nodeType) return n;
        if (1 == n.nodeType && "false" == n.contentEditable) break;
...
function hi(e, t, n) {
  let r = e.state.selection;
  if (r instanceof et && !r.empty || n.indexOf("s") > -1) return !1;
  ...
  if (!i.parent.inlineContent || e.endOfTextblock(t < 0 ? "up" : "down")) {
    let n = ti(e.state, t);
    if (n && n instanceof nt) return ni(e, n);
  }
  if (!i.parent.inlineContent) {
    let n = t < 0 ? i : o,
      s = r instanceof it ? Ge.near(n, t) : Ge.findFrom(n, t);
    return !!s && ni(e, s);
  }
  return !1;
}
function ui(e, t) {
  if (!(e.state.selection instanceof et)) return !0;
  let {
    $head: n,
    $anchor: r,
    empty: i
...
function di(e, t) {
  ...
  if (8 == n || Kn && 72 == n && "c" == r) return ui(e, -1) || si(e, -1);
  if (46 == n && !t.shiftKey || Kn && 68 == n && "c" == r) return ui(e, 1) || si(e, 1);
  if (13 == n || 27 == n) return !0;
  if (37 == n || Kn && 66 == n && "c" == r) {
    let t = 37 == n ? "ltr" == ci(e, e.state.selection.from) ? -1 : 1 : -1;
    return ri(e, t, r) || si(e, t);
  }
  if (39 == n || Kn && 70 == n && "c" == r) {
    let t = 39 == n ? "ltr" == ci(e, e.state.selection.from) ? 1 : -1 : 1;
    return ri(e, t, r) || si(e, t);
  }
  return 38 == n || Kn && 80 == n && "c" == r ? hi(e, -1, r) || si(e, -1) : 40 == n || Kn && 78 == n && "c" == r ? function (e) {
    if (!Hn || e.state.selection.$head.parentOffset > 0) return !1;
    let {
      focusNode: t,
      focusOffset: n
    } = e.domSelectionRange();
    if (t && 1 == t.nodeType && 0 == n && t.firstChild && "false" == t.firstChild.contentEditable) {
      let n = t.firstChild;
      pi(e, n, "true"), setTimeout(() => pi(e, n, "false"), 20);
    }
    return !1;
  }(e) || hi(e, 1, r) || si(e, 1) : r == (Kn ? "m" : "c") && (66 == n || 73 == n || 89 == n || 90 == n);
}
function fi(e, t) {
  ...
  let s = e.someProp("clipboardSerializer") || ie.fromSchema(e.state.schema),
    l = vi(),
  ...
  let c,
    h = a.firstChild,
    u = 0;
  for (; h && 1 == h.nodeType && (c = xi[h.nodeName.toLowerCase()]);) {
    for (let e = c.length - 1; e >= 0; e--) {
      let t = l.createElement(c[e]);
...
function mi(e, t, n, i, o) {
  ...
  if (h) {
    if (e.someProp("transformPastedText", n => {
      t = n(t, a || i, e);
    }), a) return l = new c(r.from(e.state.schema.text(t.replace(/\r\n?/g, "\n"))), 0, 0), e.someProp("transformPasted", t => {
      l = t(l, e, !0);
    }), l;
    let n = e.someProp("clipboardTextParser", n => n(t, o, i, e));
    if (n) l = n;else {
      let n = o.marks(),
        {
          schema: r
    ...
    let n,
      ...
      i = /<([a-z][^>\s]+)/i.exec(e);
    (n = i && xi[i[1].toLowerCase()]) && (e = n.map(e => "<" + e + ">").join("") + e + n.map(e => "</" + e + ">").reverse().join(""));
    if (r.innerHTML = function (e) {
      let t = window.trustedTypes;
      if (!t) return e;
      _i || (_i = t.defaultPolicy || t.createPolicy("ProseMirrorClipboard", {
        createHTML: e => e
      }));
      return _i.createHTML(e);
    }(e), n) for (let e = 0; e < n.length; e++) r = r.querySelector(n[e]) || r;
    return r;
  }(n), Qn && function (e) {
    let t = e.querySelectorAll(Jn ? "span:not([class]):not([style])" : "span.Apple-converted-space");
  ...
  if (!l) {
    let t = e.someProp("clipboardParser") || e.someProp("domParser") || K.fromSchema(e.state.schema);
    l = t.parseSlice(s, {
      preserveWhitespace: !(!h && !p),
      context: o,
      ruleFromNode: e => "BR" != e.nodeName || e.nextSibling || !e.parentNode || gi.test(e.parentNode.nodeName) ? null : {
        ignore: !0
      }
    });
  }
  if (p) l = function (e, t) {
    if (!e.size) return e;
    let n,
      i = e.content.firstChild.type.schema;
    try {
      n = JSON.parse(t);
    } catch (t) {
      return e;
    ...
    for (let e = n.length - 2; e >= 0; e -= 2) {
      ...
      o = r.from(t.create(n[e + 1], o)), s++, l++;
    }
    return new c(o, s, l);
  }(Ci(l, +p[1], +p[2]), p[4]);else if (l = c.maxOpen(function (e, t) {
    ...
    for (let n = t.depth; n >= 0; n--) {
      ...
      if (e.forEach(e => {
        ...
        if (!n) return s = null;
        if (t = s.length && i.length && ki(n, i, e, s[s.length - 1], 0)) s[s.length - 1] = t;else {
          s.length && (s[s.length - 1] = bi(s[s.length - 1], i.length));
          let t = yi(e, n);
          s.push(t), o = o.matchType(t.type), i = n;
        }
      }), s) return r.from(s);
    }
    return e;
...
function ki(e, t, n, i, o) {
  if (o < e.length && o < t.length && e[o] == t[o]) {
    let s = ki(e, t, n, i.lastChild, o + 1);
    if (s) return i.copy(i.content.replaceChild(i.childCount - 1, s));
    if (i.contentMatchAt(i.childCount).matchType(o == e.length - 1 ? n.type : e[o + 1])) return i.copy(i.content.append(r.from(yi(n, e, o + 1))));
  }
}
function bi(e, t) {
  if (0 == t) return e;
  let n = e.content.replaceChild(e.childCount - 1, bi(e.lastChild, t - 1)),
    i = e.contentMatchAt(e.childCount).fillBefore(r.empty, !0);
  return e.copy(n.append(i));
}
function wi(e, t, n, i, o, s) {
  let l = t < 0 ? e.firstChild : e.lastChild,
    a = l.content;
  return e.childCount > 1 && (s = 0), o < i - 1 && (a = wi(a, t, n, i, o + 1, s)), o >= n && (a = t < 0 ? l.contentMatchAt(0).fillBefore(a, s <= o).append(a) : a.append(l.contentMatchAt(l.childCount).fillBefore(r.empty, !0))), e.replaceChild(t < 0 ? 0 : e.childCount - 1, l.copy(a));
}
function Ci(e, t, n) {
  return t < e.openStart && (e = new c(wi(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)), n < e.openEnd && (e = new c(wi(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)), e;
}
const xi = {
  thead: ["table"],
  tbody: ["table"],
...
function Ni(e) {
  e.someProp("handleDOMEvents", t => {
    for (let n in t) e.input.eventHandlers[n] || e.dom.addEventListener(n, e.input.eventHandlers[n] = t => Fi(e, t));
  });
}
function Fi(e, t) {
...
function zi(e, t, n, r, i) {
  ...
  for (let r = o.depth + 1; r > 0; r--) if (e.someProp(t, t => r > o.depth ? t(e, n, o.nodeAfter, o.before(r), i, !0) : t(e, n, o.node(r), o.before(r), i, !1))) return !0;
  return !1;
}
function Ii(e, t, n) {
...
function Bi(e, t, n, r, i) {
  return zi(e, "handleClickOn", t, n, r) || e.someProp("handleClick", n => n(e, t, r)) || (i ? function (e, t) {
    if (-1 == t) return !1;
    let n,
      r,
      i = e.state.selection;
    i instanceof nt && (n = i.node);
    let o = e.state.doc.resolve(t);
    for (let e = o.depth + 1; e > 0; e--) {
      let t = e > o.depth ? o.nodeAfter : o.node(e);
      if (nt.isSelectable(t)) {
        r = n && i.$from.depth > 0 && e >= i.$from.depth && o.before(i.$from.depth + 1) == i.$from.pos ? o.before(i.$from.depth) : o.before(e);
        break;
      }
    }
    return null != r && (Ii(e, nt.create(e.state.doc, r)), !0);
  }(e, n) : function (e, t) {
    if (-1 == t) return !1;
    let n = e.state.doc.resolve(t),
      r = n.nodeAfter;
    return !!(r && r.isAtom && nt.isSelectable(r)) && (Ii(e, new nt(n)), !0);
  }(e, n));
}
function Pi(e, t, n, r) {
  return zi(e, "handleDoubleClickOn", t, n, r) || e.someProp("handleDoubleClick", n => n(e, t, r));
}
function Li(e, t, n, r) {
  return zi(e, "handleTripleClickOn", t, n, r) || e.someProp("handleTripleClick", n => n(e, t, r)) || function (e, t, n) {
    if (0 != n.button) return !1;
    let r = e.state.doc;
    if (-1 == t) return !!r.inlineContent && (Ii(e, et.create(r, 0, r.content.size)), !0);
    let i = r.resolve(t);
    for (let t = i.depth + 1; t > 0; t--) {
      let n = t > i.depth ? i.nodeAfter : i.node(t),
        o = i.before(t);
      if (n.inlineContent) Ii(e, et.create(r, o + 1, o + 1 + n.content.size));else {
        if (!nt.isSelectable(n)) continue;
        Ii(e, nt.create(r, o));
      }
      return !0;
    }
...
Ei.keydown = (e, t) => {
  let n = t;
  if (e.input.shiftKey = 16 == n.keyCode || n.shiftKey, !ji(e, n) && (e.input.lastKeyCode = n.keyCode, e.input.lastKeyCodeTime = Date.now(), !Gn || !Jn || 13 != n.keyCode)) if (229 != n.keyCode && e.domObserver.forceFlush(), !Un || 13 != n.keyCode || n.ctrlKey || n.altKey || n.metaKey) e.someProp("handleKeyDown", t => t(e, n)) || di(e, n) ? n.preventDefault() : Oi(e, "key");else {
    let t = Date.now();
    e.input.lastIOSEnter = t, e.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
      e.input.lastIOSEnter == t && (e.someProp("handleKeyDown", t => t(e, Tn(13, "Enter"))), e.input.lastIOSEnter = 0);
    }, 200);
  }
}, Ei.keyup = (e, t) => {
  ...
  let n = t;
  if (ji(e, n) || !n.charCode || n.ctrlKey && !n.altKey || Kn && n.metaKey) return;
  if (e.someProp("handleKeyPress", t => t(e, n))) return void n.preventDefault();
  let r = e.state.selection;
  if (!(r instanceof et && r.$from.sameParent(r.$to))) {
...
Si.mousedown = (e, t) => {
  ...
  i - e.input.lastClick.time < 500 && function (e, t) {
    let n = t.x - e.clientX,
      r = t.y - e.clientY;
    return n * n + r * r < 100;
  }(n, e.input.lastClick) && !n[$i] && e.input.lastClick.button == n.button && ("singleClick" == e.input.lastClick.type ? o = "doubleClick" : "doubleClick" == e.input.lastClick.type && (o = "tripleClick")), e.input.lastClick = {
    time: i,
    x: n.clientX,
    y: n.clientY,
    type: o,
  ...
  let s = e.posAtCoords(Ri(n));
  s && ("singleClick" == o ? (e.input.mouseDown && e.input.mouseDown.done(), e.input.mouseDown = new Vi(e, s, n, !!r)) : ("doubleClick" == o ? Pi : Li)(e, s.pos, s.inside, n) ? n.preventDefault() : Oi(e, "pointer"));
};
class Vi {
  constructor(e, t, n, r) {
    let i, o;
    if (this.view = e, this.pos = t, this.event = n, this.flushed = r, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!n[$i], this.allowDefault = n.shiftKey, t.inside > -1) i = e.state.doc.nodeAt(t.inside), o = t.inside;else {
    ...
    (0 == n.button && i.type.spec.draggable && !1 !== i.type.spec.selectable || a instanceof nt && a.from <= o && a.to > o) && (this.mightDrag = {
      node: i,
      pos: o,
    ...
    }, 20), this.view.domObserver.start()), e.root.addEventListener("mouseup", this.up = this.up.bind(this)), e.root.addEventListener("mousemove", this.move = this.move.bind(this)), Oi(e, "pointer");
  }
  done() {
...
function ji(e, t) {
  return !!e.composing || !!(Hn && Math.abs(t.timeStamp - e.input.compositionEndedAt) < 500) && (e.input.compositionEndedAt = -2e8, !0);
}
Si.touchstart = e => {
  e.input.lastTouch = Date.now(), qi(e), Oi(e, "pointer");
}, Si.touchmove = e => {
  e.input.lastTouch = Date.now(), Oi(e, "pointer");
}, Si.contextmenu = e => qi(e);
const Ji = Gn ? 5e3 : -1;
function Wi(e, t) {
  clearTimeout(e.input.composingTimeout), t > -1 && (e.input.composingTimeout = setTimeout(() => Ki(e), t));
}
function Hi(e) {
  ...
  let n = function (e, t) {
      for (;;) {
        ...
        if (1 == e.nodeType && t > 0) {
          ...
          t = On(e = e.childNodes[t - 1]);
        } else {
          if (!e.parentNode || Nn(e)) return null;
          t = Dn(e), e = e.parentNode;
        }
      }
...
function Ki(e, t = !1) {
  if (!(Gn && e.domObserver.flushingSoon >= 0)) {
...
Ei.compositionstart = Ei.compositionupdate = e => {
  if (!e.composing) {
    ...
    let {
      ...
      n = t.selection.$to;
    if (t.selection instanceof et && (t.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some(e => !1 === e.type.spec.inclusive) || Jn && Zn && function (e) {
      let {
        focusNode: t,
        focusOffset: n
      } = e.domSelectionRange();
    ...
    }(e))) e.markCursor = e.state.storedMarks || n.marks(), Ki(e, !0), e.markCursor = null;else if (Ki(e, !t.selection.empty), Vn && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length) {
      let t = e.domSelectionRange();
  ...
  e.composing && (e.input.composing = !1, e.input.compositionEndedAt = t.timeStamp, e.input.compositionPendingChanges = e.domObserver.pendingRecords().length ? e.input.compositionID : 0, e.input.compositionNode = null, e.input.compositionPendingChanges && Promise.resolve().then(() => e.domObserver.flush()), e.input.compositionID++, Wi(e, 20));
};
const Zi = qn && $n < 15 || Un && Xn < 604;
function Gi(e, t, n, r, i) {
  let o = mi(e, t, n, r, e.state.selection.$from);
...
Si.copy = Ei.cut = (e, t) => {
  ...
  o ? (n.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : function (e, t) {
  ...
  let n = t;
  if (e.composing && !Gn) return;
  let r = Zi ? null : n.clipboardData,
    i = e.input.shiftKey && 45 != e.input.lastKeyCode;
  r && Gi(e, Qi(r), r.getData("text/html"), i, n) ? n.preventDefault() : function (e, t) {
    if (!e.dom.parentNode) return;
    ...
    setTimeout(() => {
      e.focus(), r.parentNode && r.parentNode.removeChild(r), n ? Gi(e, r.value, null, i, t) : Gi(e, r.textContent, r.innerHTML, i, t);
    }, 50);
  }(e, n);
};
class Xi {
...
Si.dragstart = (e, t) => {
  ...
  let i,
    o = e.state.selection,
    s = o.empty ? null : e.posAtCoords(Ri(n));
  if (s && s.pos >= o.from && s.pos <= (o instanceof nt ? o.to - 1 : o.to)) ;else if (r && r.mightDrag) i = nt.create(e.state.doc, r.mightDrag.pos);else if (n.target && 1 == n.target.nodeType) {
    let t = e.docView.nearestDesc(n.target, !0);
    t && t.node.type.spec.draggable && t != e.docView && (i = nt.create(e.state.doc, t.posBefore));
  }
  ...
  (!n.dataTransfer.files.length || !Jn || Wn > 120) && n.dataTransfer.clearData(), n.dataTransfer.setData(Zi ? "Text" : "text/html", a.innerHTML), n.dataTransfer.effectAllowed = "copyMove", Zi || n.dataTransfer.setData("text/plain", c), e.dragging = new Xi(h, eo(e, n), i);
}, Si.dragend = e => {
  let t = e.dragging;
  window.setTimeout(() => {
    e.dragging == t && (e.dragging = null);
  }, 50);
}, Ei.dragover = Ei.dragenter = (e, t) => t.preventDefault(), Ei.drop = (e, t) => {
  try {
    !function (e, t, n) {
      if (!t.dataTransfer) return;
      let r = e.posAtCoords(Ri(t));
      if (!r) return;
      let i = e.state.doc.resolve(r.pos),
        o = n && n.slice;
      o ? e.someProp("transformPasted", t => {
        o = t(o, e, !1);
      }) : o = mi(e, Qi(t.dataTransfer), Zi ? null : t.dataTransfer.getData("text/html"), !1, i);
      let s = !(!n || !eo(e, t));
      if (e.someProp("handleDrop", n => n(e, t, o || c.empty, s))) return void t.preventDefault();
      if (!o) return;
      t.preventDefault();
      let l = o ? function (e, t, n) {
        let r = e.resolve(t);
        ...
        for (let e = 1; e <= (0 == n.openStart && n.size ? 2 : 1); e++) for (let t = r.depth; t >= 0; t--) {
          let n = t == r.depth ? 0 : r.pos <= (r.start(t + 1) + r.end(t + 1)) / 2 ? -1 : 1,
            ...
            s = r.node(t),
            l = !1;
          if (1 == e) l = s.canReplace(o, o, i);else {
            let e = s.contentMatchAt(o).findWrapping(i.firstChild.type);
            l = e && s.canReplaceWith(o, o, e[0]);
          }
          if (l) return 0 == n ? r.pos : n < 0 ? r.before(t + 1) : r.after(t + 1);
        }
        return null;
      }(e.state.doc, i.pos, o) : i.pos;
      null == l && (l = i.pos);
      let a = e.state.tr;
      if (s) {
        let {
      ...
      if (u && nt.isSelectable(o.content.firstChild) && d.nodeAfter && d.nodeAfter.sameMarkup(o.content.firstChild)) a.setSelection(new nt(d));else {
        let t = a.mapping.map(l);
        a.mapping.maps[a.mapping.maps.length - 1].forEach((e, n, r, i) => t = i), a.setSelection(Xr(e, d, a.doc.resolve(t)));
      }
  ...
  e.input.lastFocus = Date.now(), e.focused || (e.domObserver.stop(), e.dom.classList.add("ProseMirror-focused"), e.domObserver.start(), e.focused = !0, setTimeout(() => {
    e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && Wr(e);
  }, 20));
}, Si.blur = (e, t) => {
  let n = t;
  ...
  if (Jn && Gn && "deleteContentBackward" == t.inputType) {
    ...
    setTimeout(() => {
      ...
      if (e.dom.blur(), e.focus(), e.someProp("handleKeyDown", t => t(e, Tn(8, "Backspace")))) return;
      let {
        $cursor: n
      } = e.state.selection;
...
class no {
  constructor(e, t) {
    this.toDOM = e, this.spec = t || lo, this.side = this.spec.side || 0;
  }
  map(e, t, n, r) {
    let {
      pos: i,
  ...
  eq(e) {
    return this == e || e instanceof no && (this.spec.key && this.spec.key == e.spec.key || this.toDOM == e.toDOM && to(this.spec, e.spec));
  }
  destroy(e) {
...
class ro {
  ...
  eq(e) {
    return this == e || e instanceof ro && to(this.attrs, e.attrs) && to(this.spec, e.spec);
  }
  static is(e) {
...
class io {
  ...
  eq(e) {
    return this == e || e instanceof io && to(this.attrs, e.attrs) && to(this.spec, e.spec);
  }
  destroy() {}
}
class oo {
  ...
  static widget(e, t, n) {
    return new oo(e, e, new no(t, n));
  }
  static inline(e, t, n, r) {
    return new oo(e, t, new ro(n, r));
  }
  static node(e, t, n, r) {
    return new oo(e, t, new io(n, r));
  }
  get spec() {
...
class ao {
  constructor(e, t) {
    this.local = e.length ? e : so, this.children = t.length ? t : so;
  }
  static create(e, t) {
    return t.length ? mo(t, e, 0, lo) : co;
  }
  find(e, t, n) {
    let r = [];
  ...
  map(e, t, n) {
    return this == co || 0 == e.maps.length ? this : this.mapInner(e, t, 0, 0, n || lo);
  }
  mapInner(e, t, n, r, i) {
    let o;
      ...
      for (let e = 0, t = o; e < n.maps.length; e++) {
        ...
        n.maps[e].forEach((e, n, i, o) => {
          ...
          for (let i = 0; i < l.length; i += 3) {
            ...
            let a = l[i] + t - r;
            n >= a ? l[i + 1] = e <= a ? -2 : -1 : e >= t && s && (l[i] += s, l[i + 1] += s);
          }
          r += s;
        }), t = n.maps[e].map(t, -1);
      }
      let a = !1;
      for (let t = 0; t < l.length; t += 3) if (l[t + 1] < 0) {
        if (-2 == l[t + 1]) {
          a = !0, l[t + 1] = -1;
          continue;
        }
        ...
        if (f && d == h && d + f.nodeSize == u) {
          let r = l[t + 2].mapInner(n, f, c + 1, e[t] + o + 1, s);
          r != co ? (l[t] = h, l[t + 1] = u, l[t + 2] = r) : (l[t + 1] = -2, a = !0);
        } else a = !0;
      }
      if (a) {
        let a = function (e, t, n, r, i, o, s) {
            ...
            for (let n = 0; n < e.length; n += 3) -1 == e[n + 1] && l(e[n + 2], t[n] + o + 1);
            return n;
          }(l, e, t, n, i, o, s),
          c = mo(a, r, 0, s);
        t = c.local;
        ...
        for (let e = 0, t = 0; e < c.children.length; e += 3) {
          ...
          l.splice(t, 0, c.children[e], c.children[e + 1], c.children[e + 2]);
        }
      }
      return new ao(t.sort(go), l);
    }(this.children, o || [], e, t, n, r, i) : o ? new ao(o.sort(go), so) : co;
  }
  add(e, t) {
    return t.length ? this == co ? ao.create(e, t) : this.addInner(e, t, 0) : this;
  }
  addInner(e, t, n) {
    let r,
      i = 0;
    e.forEach((e, o) => {
      ...
      if (s = po(t, e, l)) {
        ...
        r[i] == o ? r[i + 2] = r[i + 2].addInner(e, s, l + 1) : r.splice(i, 0, o, o + e.nodeSize, mo(s, e, l + 1, lo)), i += 3;
      }
    });
    let o = uo(i ? fo(t) : t, -n);
    for (let t = 0; t < o.length; t++) o[t].type.valid(e, o[t]) || o.splice(t--, 1);
    return new ao(o.length ? this.local.concat(o).sort(go) : this.local, r || this.children);
  }
  remove(e) {
    return 0 == e.length || this == co ? this : this.removeInner(e, 0);
  }
  removeInner(e, t) {
    let n = this.children,
      r = this.local;
    for (let r = 0; r < n.length; r += 3) {
      let i,
        o = n[r] + t,
        s = n[r + 1] + t;
      for (let t, n = 0; n < e.length; n++) (t = e[n]) && t.from > o && t.to < s && (e[n] = null, (i || (i = [])).push(t));
      if (!i) continue;
      n == this.children && (n = this.children.slice());
      let l = n[r + 2].removeInner(i, o + 1);
      l != co ? n[r + 2] = l : (n.splice(r, 3), r -= 3);
    }
    if (r.length) for (let n, i = 0; i < e.length; i++) if (n = e[i]) for (let e = 0; e < r.length; e++) r[e].eq(n, t) && (r == this.local && (r = this.local.slice()), r.splice(e--, 1));
    return n == this.children && r == this.local ? this : r.length || n.length ? new ao(r, n) : co;
  }
  forChild(e, t) {
    if (this == co) return this;
    if (t.isLeaf) return ao.empty;
    let n, r;
    ...
    for (let e = 0; e < this.local.length; e++) {
      let t = this.local[e];
      if (t.from < o && t.to > i && t.type instanceof ro) {
    ...
    if (r) {
      let e = new ao(r.sort(go), so);
      return n ? new ho([e, n]) : e;
    }
    return n || co;
  }
  eq(e) {
    if (this == e) return !0;
    if (!(e instanceof ao) || this.local.length != e.local.length || this.children.length != e.children.length) return !1;
...
class ho {
  ...
  map(e, t) {
    const n = this.members.map(n => n.map(e, t, lo));
    return ho.from(n);
  }
  forChild(e, t) {
    if (t.isLeaf) return ao.empty;
  ...
  eq(e) {
    if (!(e instanceof ho) || e.members.length != this.members.length) return !1;
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new ho(e.every(e => e instanceof ao) ? e : e.reduce((e, t) => e.concat(t instanceof ao ? t : t.members), []));
    }
  }
  forEachSet(e) {
...
function uo(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    let i = e[r];
    n.push(new oo(i.from + t, i.to + t, i.type));
  }
  return n;
}
function po(e, t, n) {
  ...
  let r = n + t.nodeSize,
    i = null;
  for (let t, o = 0; o < e.length; o++) (t = e[o]) && t.from > n && t.to < r && ((i || (i = [])).push(t), e[o] = null);
  return i;
}
function fo(e) {
  let t = [];
...
function mo(e, t, n, r) {
  ...
  t.forEach((t, s) => {
    ...
    if (l) {
      o = !0;
      let e = mo(l, t, n + s + 1, r);
      e != co && i.push(s, s + t.nodeSize, e);
    }
  });
  let s = uo(o ? fo(e) : e, -n).sort(go);
...
function yo(e) {
  ...
  for (let n = 0; n < t.length - 1; n++) {
    ...
    if (r.from != r.to) for (let i = n + 1; i < t.length; i++) {
      let o = t[i];
      if (o.from != r.from) {
        o.from < r.to && (t == e && (t = e.slice()), t[n] = r.copy(r.from, o.from), ko(t, i, r.copy(o.from, r.to)));
        break;
      }
      o.to != r.to && (t == e && (t = e.slice()), t[i] = o.copy(o.from, r.to), ko(t, i + 1, o.copy(r.to, o.to)));
    }
  }
  return t;
}
function ko(e, t, n) {
  for (; t < e.length && go(n, e[t]) > 0;) t++;
  e.splice(t, 0, n);
}
function bo(e) {
  let t = [];
  return e.someProp("decorations", n => {
    let r = n(e.state);
    r && r != co && t.push(r);
  }), e.cursorWrapper && t.push(ao.create(e.state.doc, [e.cursorWrapper.deco])), ho.from(t);
}
const wo = {
    childList: !0,
    characterData: !0,
...
class Do {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new xo(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver(e => {
      for (let t = 0; t < e.length; t++) this.queue.push(e[t]);
      qn && $n <= 11 && e.some(e => "childList" == e.type && e.removedNodes.length || "characterData" == e.type && e.oldValue.length > e.target.nodeValue.length) ? this.flushSoon() : this.flush();
    }), Co && (this.onCharData = e => {
      this.queue.push({
        target: e.target,
        type: "characterData",
  ...
  onSelectionChange() {
    if (Yr(this.view)) {
      ...
      if (qn && $n <= 11 && !this.view.state.selection.empty) {
  ...
  ignoreSelectionChange(e) {
    ...
    let t,
      n = new Set();
    for (let t = e.focusNode; t; t = vn(t)) n.add(t);
    for (let r = e.anchorNode; r; r = vn(r)) if (n.has(r)) {
      t = r;
      break;
    }
  ...
  flush() {
    ...
    if (Vn && l.length) {
      ...
      if (2 == t.length) {
        ...
        for (let r of t) {
          let t = r.parentNode;
          !t || "LI" != t.nodeName || n && Eo(e, n) == t || r.remove();
        }
      }
    } else if ((Jn || Hn) && l.some(e => "BR" == e.nodeName) && (8 == e.input.lastKeyCode || 46 == e.input.lastKeyCode)) for (let e of l) if ("BR" == e.nodeName && e.parentNode) {
      let t = e.nextSibling;
      t && 1 == t.nodeType && "false" == t.contentEditable && e.parentNode.removeChild(e);
    }
    let a = null;
    i < 0 && r && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && Fn(n) && (a = jr(e)) && a.eq(Ge.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Wr(e), this.currentSelection.set(n), e.scrollToSelection()) : (i > -1 || r) && (i > -1 && (e.docView.markDirty(i, o), function (e) {
      if (vo.has(e)) return;
      if (vo.set(e, null), -1 !== ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(e.dom).whiteSpace)) {
        if (e.requiresGeckoHackNode = Vn, _o) return;
    ...
    }(e)), this.handleDOMChange(i, o, s, l), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || Wr(e), this.currentSelection.set(n));
  }
  registerMutation(e, t) {
    ...
    if ("childList" == e.type) {
      ...
      let r = e.previousSibling,
        i = e.nextSibling;
      if (qn && $n <= 11 && e.addedNodes.length) for (let t = 0; t < e.addedNodes.length; t++) {
        let {
          previousSibling: n,
          nextSibling: o
        } = e.addedNodes[t];
        (!n || Array.prototype.indexOf.call(e.addedNodes, n) < 0) && (r = n), (!o || Array.prototype.indexOf.call(e.addedNodes, o) < 0) && (i = o);
      }
      let o = r && r.parentNode == e.target ? Dn(r) + 1 : 0,
        s = n.localPosFromDOM(e.target, o, -1),
        l = i && i.parentNode == e.target ? Dn(i) : e.target.childNodes.length;
      return {
        from: s,
...
function Ao(e) {
  ...
  if ("BR" == e.nodeName && e.parentNode) {
    ...
    if (e.parentNode.lastChild == e || Hn && /^(tr|table)$/i.test(e.parentNode.nodeName)) return {
      ignore: !0
    };
...
function Oo(e, t, n, i, o) {
  ...
  if (e.input.compositionPendingChanges = 0, t < 0) {
    ...
    if (n && !e.state.selection.eq(n)) {
      if (Jn && Gn && 13 === e.input.lastKeyCode && Date.now() - 100 < e.input.lastKeyCodeTime && e.someProp("handleKeyDown", t => t(e, Tn(13, "Enter")))) return;
  ...
  let c,
    ...
    p = function (e, t, n) {
      let r,
        ...
        h = c.anchorNode;
      if (h && e.dom.contains(1 == h.nodeType ? h : h.parentNode) && (r = [{
        node: h,
        offset: c.anchorOffset
      }], Fn(c) || r.push({
        node: c.focusNode,
        offset: c.focusOffset
      })), Jn && 8 === e.input.lastKeyCode) for (let e = s; e > o; e--) {
      ...
      let u = e.state.doc,
        p = e.someProp("domParser") || K.fromSchema(e.state.schema),
        d = u.resolve(l),
        f = null,
        m = p.parse(i, {
          topNode: d.parent,
  ...
  8 === e.input.lastKeyCode && Date.now() - 100 < e.input.lastKeyCodeTime ? (c = e.state.selection.to, h = "end") : (c = e.state.selection.from, h = "start"), e.input.lastKeyCode = null;
  let m = function (e, t, n, r, i) {
    ...
    if (s < o && e.size < t.size) {
      let e = r <= o && r >= s ? o - r : 0;
      o -= e, o && o < t.size && To(t.textBetween(o - 1, o + 1)) && (o += e ? 1 : -1), l = o + (l - s), s = o;
    } else if (l < o) {
      let t = r <= o && r >= l ? o - r : 0;
      o -= t, o && o < e.size && To(e.textBetween(o - 1, o + 1)) && (o += t ? 1 : -1), s = o + (s - l), l = o;
    }
    return {
      start: o,
      endA: s,
  ...
  if (m && e.input.domChangeCount++, (Un && e.input.lastIOSEnter > Date.now() - 225 || Gn) && o.some(e => 1 == e.nodeType && !Mo.test(e.nodeName)) && (!m || m.endA >= m.endB) && e.someProp("handleKeyDown", t => t(e, Tn(13, "Enter")))) return void (e.input.lastIOSEnter = 0);
  if (!m) {
    if (!(i && u instanceof et && !u.empty && u.$head.sameParent(u.$anchor)) || e.composing || p.sel && p.sel.anchor != p.sel.head) {
      if (p.sel) {
        let t = No(e, e.state.doc, p.sel);
  ...
  e.state.selection.from < e.state.selection.to && m.start == m.endB && e.state.selection instanceof et && (m.start > e.state.selection.from && m.start <= e.state.selection.from + 2 && e.state.selection.from >= p.from ? m.start = e.state.selection.from : m.endA < e.state.selection.to && m.endA >= e.state.selection.to - 2 && e.state.selection.to <= p.to && (m.endB += e.state.selection.to - m.endA, m.endA = e.state.selection.to)), qn && $n <= 11 && m.endB == m.start + 1 && m.endA == m.start && m.start > p.from && "  " == p.doc.textBetween(m.start - p.from - 1, m.start - p.from + 1) && (m.start--, m.endA--, m.endB--);
  ...
  if ((Un && e.input.lastIOSEnter > Date.now() - 225 && (!b || o.some(e => "DIV" == e.nodeName || "P" == e.nodeName)) || !b && g.pos < p.doc.content.size && (!g.sameParent(y) || !g.parent.inlineContent) && g.pos < y.pos && !/\S/.test(p.doc.textBetween(g.pos, y.pos, "", ""))) && e.someProp("handleKeyDown", t => t(e, Tn(13, "Enter")))) return void (e.input.lastIOSEnter = 0);
  if (e.state.selection.anchor > m.start && function (e, t, n, r, i) {
    if (n - t <= i.pos - r.pos || Fo(r, !0, !1) < i.pos) return !1;
    let o = e.resolve(t);
    if (!r.parent.isTextblock) {
      let e = o.nodeAfter;
    ...
    let s = e.resolve(Fo(o, !0, !0));
    return !(!s.parent.isTextblock || s.pos > n || Fo(s, !0, !1) < n) && r.parent.content.cut(r.parentOffset).eq(s.parent.content);
  }(d, m.start, m.endA, g, y) && e.someProp("handleKeyDown", t => t(e, Tn(8, "Backspace")))) return void (Gn && Jn && e.domObserver.suppressSelectionUpdates());
  Jn && m.endB == m.start && (e.input.lastChromeDelete = Date.now()), Gn && !b && g.start() != y.start() && 0 == y.parentOffset && g.depth == y.depth && p.sel && p.sel.anchor == p.sel.head && p.sel.head == m.endA && (m.endB -= 2, y = p.doc.resolveNoCache(m.endB - p.from), setTimeout(() => {
    e.someProp("handleKeyDown", function (t) {
      return t(e, Tn(13, "Enter"));
    });
  }, 20));
  let w,
    C = m.start,
    x = m.endA,
    D = t => {
      let n = t || e.state.tr.replace(C, x, p.doc.slice(m.start - p.from, m.endB - p.from));
      if (p.sel) {
        let t = No(e, n.doc, p.sel);
        t && !(Jn && e.composing && t.empty && (m.start != m.endB || e.input.lastChromeDelete < Date.now() - 100) && (t.head == C || t.head == n.mapping.map(x) - 1) || qn && t.empty && t.head == C) && n.setSelection(t);
      }
      return s && n.setMeta("composition", s), n.scrollIntoView();
    };
  if (b) {
    if (g.pos == y.pos) {
      qn && $n <= 11 && 0 == g.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => Wr(e), 20));
      let t = D(e.state.tr.delete(C, x)),
        n = d.resolve(m.start).marksAcross(d.resolve(m.endA));
      n && t.ensureMarks(n), e.dispatch(t);
    } else if (m.endA == m.endB && (w = function (e, t) {
      let n,
        i,
        o,
      ...
      if (1 == a.length && 0 == c.length) i = a[0], n = "add", o = e => e.mark(i.addToSet(e.marks));else {
        if (0 != a.length || 1 != c.length) return null;
        i = c[0], n = "remove", o = e => e.mark(i.removeFromSet(e.marks));
      }
      let h = [];
      for (let e = 0; e < t.childCount; e++) h.push(o(t.child(e)));
      if (r.from(h).eq(e)) return {
        mark: i,
        type: n
      };
    }(g.parent.content.cut(g.parentOffset, y.parentOffset), k.parent.content.cut(k.parentOffset, m.endA - k.start())))) {
      let t = D(e.state.tr);
      "add" == w.type ? t.addMark(C, x, w.mark) : t.removeMark(C, x, w.mark), e.dispatch(t);
      ...
      let t = g.parent.textBetween(g.parentOffset, y.parentOffset),
        n = () => D(e.state.tr.insertText(t, C, x));
      e.someProp("handleTextInput", r => r(e, C, x, t, n)) || e.dispatch(n());
    } else e.dispatch(D());
  } else e.dispatch(D());
}
function No(e, t, n) {
...
class Ro {
  ...
  updateStateInner(e, t) {
    ...
    let r = this.state,
      i = !1,
      o = !1;
    e.storedMarks && this.composing && (Hi(this), o = !0), this.state = e;
    ...
    (s || t.handleDOMEvents != this._props.handleDOMEvents) && Ni(this), this.editable = Bo(this), Io(this);
    let l = bo(this),
      a = zo(this),
      c = r.plugins == e.plugins || r.doc.eq(e.doc) ? e.scrollToSelection > r.scrollToSelection ? "to selection" : "preserve" : "reset",
      h = i || !this.docView.matchesNode(e.doc, a, l);
    !h && e.selection.eq(r.selection) || (o = !0);
    let u = "preserve" == c && o && null == this.dom.style.overflowAnchor && function (e) {
      let t,
        n,
    ...
    if (o) {
      ...
      let t = h && (qn || Jn) && !this.composing && !r.selection.empty && !e.selection.empty && function (e, t) {
      ...
      if (h) {
        ...
        this.composing && (this.input.compositionNode = Ui(this)), !i && this.docView.update(e.doc, a, l, this) || (this.docView.updateOuterDeco(a), this.docView.destroy(), this.docView = Er(e.doc, a, l, this.dom, this)), n && !this.trackWrites && (t = !0);
      }
      ...
      }(this)) ? Wr(this, t) : (Gr(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(r), (null === (n = this.dragging) || void 0 === n ? void 0 : n.node) && !r.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, r), "reset" == c ? this.dom.scrollTop = 0 : "to selection" == c ? this.scrollToSelection() : u && function ({
      refDOM: e,
      refTop: t,
      stack: n
    }) {
  ...
  scrollToSelection() {
    ...
    if (e && this.dom.contains(1 == e.nodeType ? e : e.parentNode)) {
      if (this.someProp("handleScrollToSelection", e => e(this))) ;else if (this.state.selection instanceof nt) {
        let t = this.docView.domAfterPos(this.state.selection.from);
        1 == t.nodeType && nr(this, t.getBoundingClientRect(), e);
      } else nr(this, this.coordsAtPos(this.state.selection.head, 1), e);
    } else ;
  }
  destroyPluginViews() {
    let e;
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Xi(e.slice, e.move, r < 0 ? void 0 : nt.create(this.state.doc, r));
  }
  someProp(e, t) {
    let n,
  ...
  endOfTextblock(e, t) {
    return Cr(this, t || this.state, e);
  }
  pasteHTML(e, t) {
    return Gi(this, "", e, !1, t || new ClipboardEvent("paste"));
  }
  pasteText(e, t) {
    return Gi(this, e, null, !0, t || new ClipboardEvent("paste"));
  }
  ...
  dispatchEvent(e) {
    return function (e, t) {
      Fi(e, t) || !Si[t.type] || !e.editable && t.type in Ei || Si[t.type](e, t);
    }(this, e);
  }
  domSelectionRange() {
    let e = this.domSelection();
    return e ? Hn && 11 === this.root.nodeType && function (e) {
      ...
      return e.dom.addEventListener("beforeinput", r, !0), document.execCommand("indent"), e.dom.removeEventListener("beforeinput", r, !0), n ? So(e, n) : null;
    }(this, e) || e : {
      focusNode: null,
      focusOffset: 0,
      anchorNode: null,
...
function zo(e) {
  ...
  }), t.translate || (t.translate = "no"), [oo.node(0, e.state.doc.content.size, t)];
}
function Io(e) {
  if (e.markCursor) {
    ...
    t.className = "ProseMirror-separator", t.setAttribute("mark-placeholder", "true"), t.setAttribute("alt", ""), e.cursorWrapper = {
      dom: t,
      deco: oo.widget(e.state.selection.from, t, {
        raw: !0,
        marks: e.markCursor
      })
    };
...
Ro.prototype.dispatch = function (e) {
...
function $o(e, t) {
  ...
  return e.replace(/(%[a-f0-9]{2})+/gi, function (e) {
    ...
    for (let r = 0, i = e.length; r < i; r += 3) {
      const o = parseInt(e.slice(r + 1, r + 3), 16);
      if (o < 128) t += n[o];else {
        if (192 == (224 & o) && r + 3 < i) {
          const n = parseInt(e.slice(r + 4, r + 6), 16);
          if (128 == (192 & n)) {
            const e = o << 6 & 1984 | 63 & n;
        ...
        if (224 == (240 & o) && r + 6 < i) {
          ...
          if (128 == (192 & n) && 128 == (192 & i)) {
            const e = o << 12 & 61440 | n << 6 & 4032 | 63 & i;
        ...
        if (240 == (248 & o) && r + 9 < i) {
          ...
          if (128 == (192 & n) && 128 == (192 & i) && 128 == (192 & s)) {
            let e = o << 18 & 1835008 | n << 12 & 258048 | i << 6 & 4032 | 63 & s;
            e < 65536 || e > 1114111 ? t += "����" : (e -= 65536, t += String.fromCharCode(55296 + (e >> 10), 56320 + (1023 & e))), r += 9;
            continue;
          }
        }
        t += "�";
...
const Vo = {};
function jo(e, t, n) {
  "string" != typeof t && (n = t, t = jo.defaultChars), void 0 === n && (n = !0);
  const r = function (e) {
    let t = Vo[e];
    if (t) return t;
    t = Vo[e] = [];
  ...
  for (let t = 0, o = e.length; t < o; t++) {
    ...
    if (n && 37 === s && t + 2 < o && /^[0-9a-f]{2}$/i.test(e.slice(t + 1, t + 3))) i += e.slice(t, t + 3), t += 2;else if (s < 128) i += r[s];else if (s >= 55296 && s <= 57343) {
...
Wo.prototype.parse = function (e, t) {
  let n,
    r,
    i,
    o = e;
  ...
  let s = Ho.exec(o);
  if (s && (s = s[0], n = s.toLowerCase(), this.protocol = s, o = o.substr(s.length)), (t || s || o.match(/^\/\/[^@\/]+@[^@\/]+/)) && (i = "//" === o.substr(0, 2), !i || s && ts[s] || (o = o.substr(2), this.slashes = !0)), !ts[s] && (i || s && !ns[s])) {
    let e,
      t,
      n = -1;
    for (let e = 0; e < Xo.length; e++) r = o.indexOf(Xo[e]), -1 !== r && (-1 === n || r < n) && (n = r);
    t = -1 === n ? o.lastIndexOf("@") : o.lastIndexOf("@", n), -1 !== t && (e = o.slice(0, t), o = o.slice(t + 1), this.auth = e), n = -1;
    for (let e = 0; e < Qo.length; e++) r = o.indexOf(Qo[e]), -1 !== r && (-1 === n || r < n) && (n = r);
...
}, Wo.prototype.parseHost = function (e) {
  let t = Uo.exec(e);
...
const ms = new Map([[0, 65533], [128, 8364], [130, 8218], [131, 402], [132, 8222], [133, 8230], [134, 8224], [135, 8225], [136, 710], [137, 8240], [138, 352], [139, 8249], [140, 338], [142, 381], [145, 8216], [146, 8217], [147, 8220], [148, 8221], [149, 8226], [150, 8211], [151, 8212], [152, 732], [153, 8482], [154, 353], [155, 8250], [156, 339], [158, 382], [159, 376]]),
  gs = null !== (is = String.fromCodePoint) && void 0 !== is ? is : function (e) {
    let t = "";
...
var ks, bs, ws;
function Cs(e) {
  return e >= ys.ZERO && e <= ys.NINE;
}
function xs(e) {
  return e >= ys.UPPER_A && e <= ys.UPPER_F || e >= ys.LOWER_A && e <= ys.LOWER_F;
}
function Ds(e) {
  return e === ys.EQUALS || function (e) {
    return e >= ys.UPPER_A && e <= ys.UPPER_Z || e >= ys.LOWER_A && e <= ys.LOWER_Z || Cs(e);
  }(e);
}
!function (e) {
...
class vs {
  constructor(e, t, n) {
    this.decodeTree = e, this.emitCodePoint = t, this.errors = n, this.state = bs.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = ws.Strict;
  }
  startEntity(e) {
    this.decodeMode = e, this.state = bs.EntityStart, this.result = 0, this.treeIndex = 0, this.excess = 1, this.consumed = 1;
  }
  write(e, t) {
    switch (this.state) {
      case bs.EntityStart:
        return e.charCodeAt(t) === ys.NUM ? (this.state = bs.NumericStart, this.consumed += 1, this.stateNumericStart(e, t + 1)) : (this.state = bs.NamedEntity, this.stateNamedEntity(e, t));
  ...
  stateNumericStart(e, t) {
    return t >= e.length ? -1 : (32 | e.charCodeAt(t)) === ys.LOWER_X ? (this.state = bs.NumericHex, this.consumed += 1, this.stateNumericHex(e, t + 1)) : (this.state = bs.NumericDecimal, this.stateNumericDecimal(e, t));
  }
  ...
  stateNumericHex(e, t) {
    ...
    for (; t < e.length;) {
      ...
      if (!Cs(r) && !xs(r)) return this.addToNumericResult(e, n, t, 16), this.emitNumericEntity(r, 3);
      t += 1;
    }
  ...
  stateNumericDecimal(e, t) {
    ...
    for (; t < e.length;) {
      const r = e.charCodeAt(t);
      if (!Cs(r)) return this.addToNumericResult(e, n, t, 10), this.emitNumericEntity(r, 2);
      t += 1;
    }
  ...
  emitNumericEntity(e, t) {
    ...
    if (e === ys.SEMI) this.consumed += 1;else if (this.decodeMode === ws.Strict) return 0;
    return this.emitCodePoint(function (e) {
      var t;
      return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : null !== (t = ms.get(e)) && void 0 !== t ? t : e;
    }(this.result), this.consumed), this.errors && (e !== ys.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  ...
  emitNamedEntityData(e, t, n) {
    ...
    return this.emitCodePoint(1 === t ? r[e] & ~ks.VALUE_LENGTH : r[e + 1], n), 3 === t && this.emitCodePoint(r[e + 2], n), n;
  }
  end() {
    var e;
    switch (this.state) {
...
function _s(e) {
  let t = "";
  const n = new vs(e, e => t += gs(e));
  return function (e, r) {
    let i = 0,
      o = 0;
    for (; (o = e.indexOf("&", o)) >= 0;) {
      t += e.slice(i, o), n.startEntity(r);
      const s = n.write(e, o + 1);
      if (s < 0) {
        i = o + n.end();
        break;
      }
...
function Ps(e) {
  return e.indexOf("\\") < 0 && e.indexOf("&") < 0 ? e : e.replace(Is, function (e, t, n) {
    return t || function (e, t) {
      if (35 === t.charCodeAt(0) && Bs.test(t)) {
        const n = "x" === t[1].toLowerCase() ? parseInt(t.slice(2), 16) : parseInt(t.slice(1), 10);
        return Ts(n) ? Rs(n) : e;
      }
      const n = As(e);
      return n !== e ? n : e;
...
function js(e) {
  return Ls.test(e) ? e.replace(qs, Vs) : e;
}
const Js = /[.?*+^$[\]\\(){}|-]/g;
function Ws(e) {
  switch (e) {
...
var Qs = Object.freeze({
  ...
  unescapeMd: function (e) {
    return e.indexOf("\\") < 0 ? e : e.replace(zs, "$1");
  }
});
var Xs = Object.freeze({
  ...
  parseLinkDestination: function (e, t, n) {
    ...
    if (60 === e.charCodeAt(i)) {
      for (i++; i < n;) {
        if (r = e.charCodeAt(i), 10 === r) return o;
        if (60 === r) return o;
        if (62 === r) return o.pos = i + 1, o.str = Ps(e.slice(t + 1, i)), o.ok = !0, o;
        92 === r && i + 1 < n ? i += 2 : i++;
      }
      return o;
    }
    let s = 0;
    for (; i < n && (r = e.charCodeAt(i), 32 !== r) && !(r < 32 || 127 === r);) if (92 === r && i + 1 < n) {
    ...
    return t === i || 0 !== s || (o.str = Ps(e.slice(t, i)), o.pos = i, o.ok = !0), o;
  },
  parseLinkLabel: function (e, t, n) {
    ...
    for (e.pos = t + 1, r = 1; e.pos < l;) {
      ...
      if (s = e.pos, e.md.inline.skipToken(e), 91 === o) if (s === e.pos - 1) r++;else if (n) return e.pos = a, -1;
    }
    let c = -1;
  ...
  parseLinkTitle: function (e, t, n, r) {
    ...
    if (r) s.str = r.str, s.marker = r.marker;else {
      ...
      t++, o++, 40 === r && (r = 41), s.marker = r;
    }
    for (; o < n;) {
      if (i = e.charCodeAt(o), i === s.marker) return s.pos = o + 1, s.str += Ps(e.slice(t, o)), s.ok = !0, s;
      if (40 === i && 41 === s.marker) return s;
      92 === i && o + 1 < n && o++, o++;
    }
    return s.can_continue = !0, s.str += Ps(e.slice(t, o)), s;
  }
});
const Ys = {};
function el() {
...
Ys.code_inline = function (e, t, n, r, i) {
  const o = e[t];
  return "<code" + i.renderAttrs(o) + ">" + js(o.content) + "</code>";
}, Ys.code_block = function (e, t, n, r, i) {
  const o = e[t];
  return "<pre" + i.renderAttrs(o) + "><code>" + js(e[t].content) + "</code></pre>\n";
}, Ys.fence = function (e, t, n, r, i) {
  const o = e[t],
  ...
  if (s) {
    const e = s.split(/(\s+)/g);
    a = e[0], c = e.slice(2).join("");
  }
  if (l = n.highlight && n.highlight(o.content, a, c) || js(o.content), 0 === l.indexOf("<pre")) return l + "\n";
  if (s) {
    const e = o.attrIndex("class"),
      t = o.attrs ? o.attrs.slice() : [];
    e < 0 ? t.push(["class", n.langPrefix + a]) : (t[e] = t[e].slice(), t[e][1] += " " + n.langPrefix + a);
    const r = {
      attrs: t
    };
...
}, Ys.image = function (e, t, n, r, i) {
  const o = e[t];
  return o.attrs[o.attrIndex("alt")][1] = i.renderInlineAsText(o.children, n, r), i.renderToken(e, t, n);
}, Ys.hardbreak = function (e, t, n) {
  return n.xhtmlOut ? "<br />\n" : "<br>\n";
}, Ys.softbreak = function (e, t, n) {
  return n.breaks ? n.xhtmlOut ? "<br />\n" : "<br>\n" : "\n";
}, Ys.text = function (e, t) {
  return js(e[t].content);
}, Ys.html_block = function (e, t) {
  return e[t].content;
}, Ys.html_inline = function (e, t) {
  return e[t].content;
}, el.prototype.renderAttrs = function (e) {
  let t, n, r;
  if (!e.attrs) return "";
  for (r = "", t = 0, n = e.attrs.length; t < n; t++) r += " " + js(e.attrs[t][0]) + '="' + js(e.attrs[t][1]) + '"';
  return r;
}, el.prototype.renderToken = function (e, t, n) {
  const r = e[t];
  let i = "";
  if (r.hidden) return "";
  r.block && -1 !== r.nesting && t && e[t - 1].hidden && (i += "\n"), i += (-1 === r.nesting ? "</" : "<") + r.tag, i += this.renderAttrs(r), 0 === r.nesting && n.xhtmlOut && (i += " /");
  let o = !1;
  if (r.block && (o = !0, 1 === r.nesting && t + 1 < e.length)) {
    const n = e[t + 1];
    ("inline" === n.type || n.hidden || -1 === n.nesting && n.tag === r.tag) && (o = !1);
  }
  return i += o ? ">\n" : ">", i;
}, el.prototype.renderInline = function (e, t, n) {
  let r = "";
  const i = this.rules;
  for (let o = 0, s = e.length; o < s; o++) {
    const s = e[o].type;
    void 0 !== i[s] ? r += i[s](e, o, t, n, this) : r += this.renderToken(e, o, t);
  }
  return r;
}, el.prototype.renderInlineAsText = function (e, t, n) {
  let r = "";
  for (let i = 0, o = e.length; i < o; i++) switch (e[i].type) {
    case "text":
    case "html_inline":
    case "html_block":
      r += e[i].content;
  ...
  return r;
}, el.prototype.render = function (e, t, n) {
  let r = "";
  const i = this.rules;
  for (let o = 0, s = e.length; o < s; o++) {
    const s = e[o].type;
    "inline" === s ? r += this.renderInline(e[o].children, t, n) : void 0 !== i[s] ? r += i[s](e, o, t, n, this) : r += this.renderToken(e, o, t, n);
  }
  return r;
}, tl.prototype.__find__ = function (e) {
  for (let t = 0; t < this.__rules__.length; t++) if (this.__rules__[t].name === e) return t;
  return -1;
}, tl.prototype.__compile__ = function () {
  const e = this,
    t = [""];
...
}, tl.prototype.at = function (e, t, n) {
...
}, tl.prototype.before = function (e, t, n, r) {
...
}, tl.prototype.after = function (e, t, n, r) {
  const i = this.__find__(e),
    o = r || {};
  if (-1 === i) throw new Error("Parser rule not found: " + e);
...
}, tl.prototype.push = function (e, t, n) {
  const r = n || {};
  this.__rules__.push({
    name: e,
    enabled: !0,
...
}, tl.prototype.enableOnly = function (e, t) {
...
}, tl.prototype.getRules = function (e) {
  return null === this.__cache__ && this.__compile__(), this.__cache__[e] || [];
}, nl.prototype.attrIndex = function (e) {
  if (!this.attrs) return -1;
  const t = this.attrs;
  for (let n = 0, r = t.length; n < r; n++) if (t[n][0] === e) return n;
  return -1;
}, nl.prototype.attrPush = function (e) {
  this.attrs ? this.attrs.push(e) : this.attrs = [e];
}, nl.prototype.attrSet = function (e, t) {
  const n = this.attrIndex(e),
    r = [e, t];
  n < 0 ? this.attrPush(r) : this.attrs[n] = r;
}, nl.prototype.attrGet = function (e) {
  const t = this.attrIndex(e);
  let n = null;
  return t >= 0 && (n = this.attrs[t][1]), n;
}, nl.prototype.attrJoin = function (e, t) {
  const n = this.attrIndex(e);
...
function dl(e) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    const r = e[n];
    "text" !== r.type || t || (r.content = r.content.replace(hl, pl)), "link_open" === r.type && "auto" === r.info && t--, "link_close" === r.type && "auto" === r.info && t++;
  }
}
function fl(e) {
  let t = 0;
  for (let n = e.length - 1; n >= 0; n--) {
    const r = e[n];
    "text" !== r.type || t || al.test(r.content) && (r.content = r.content.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1—").replace(/(^|\s)--(?=\s|$)/gm, "$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1–")), "link_open" === r.type && "auto" === r.info && t--, "link_close" === r.type && "auto" === r.info && t++;
  }
}
const ml = /['"]/,
  gl = /['"]/g;
...
function kl(e, t) {
  ...
  for (let i = 0; i < e.length; i++) {
    ...
    e: for (; a < c;) {
      ...
      const d = "'" === h[0];
      let f = 32;
      if (h.index - 1 >= 0) f = l.charCodeAt(h.index - 1);else for (n = i - 1; n >= 0 && "softbreak" !== e[n].type && "hardbreak" !== e[n].type; n--) if (e[n].content) {
        f = e[n].content.charCodeAt(e[n].content.length - 1);
        break;
      }
      let m = 32;
      if (a < c) m = l.charCodeAt(a);else for (n = i + 1; n < e.length && "softbreak" !== e[n].type && "hardbreak" !== e[n].type; n++) if (e[n].content) {
      ...
      if (b ? u = !1 : y && (k || g || (u = !1)), k ? p = !1 : g && (b || y || (p = !1)), 34 === m && '"' === h[0] && f >= 48 && f <= 57 && (p = u = !1), u && p && (u = g, p = y), u || p) {
        if (p) for (n = r.length - 1; n >= 0; n--) {
          ...
          if (u.single === d && r[n].level === s) {
            let s, p;
            u = r[n], d ? (s = t.md.options.quotes[2], p = t.md.options.quotes[3]) : (s = t.md.options.quotes[0], p = t.md.options.quotes[1]), o.content = yl(o.content, h.index, p), e[u.token].content = yl(e[u.token].content, u.pos, s), a += p.length - 1, u.token === i && (a += s.length - 1), l = o.content, c = l.length, r.length = n;
            continue e;
          }
        }
        u ? r.push({
...
const bl = [["normalize", function (e) {
  let t;
  t = e.src.replace(il, "\n"), t = t.replace(ol, "�"), e.src = t;
}], ["block", function (e) {
  let t;
  ...
  if (e.md.options.linkify) for (let n = 0, r = t.length; n < r; n++) {
    ...
    for (let o = r.length - 1; o >= 0; o--) {
      ...
      if ("link_close" !== s.type) {
        if ("html_inline" === s.type && (sl(s.content) && i > 0 && i--, ll(s.content) && i++), !(i > 0) && "text" === s.type && e.md.linkify.test(s.content)) {
          const i = s.content;
          let l = e.md.linkify.match(i);
          const a = [];
          let c = s.level,
            h = 0;
          ...
          for (let t = 0; t < l.length; t++) {
            ...
            let o = l[t].text;
            o = l[t].schema ? "mailto:" !== l[t].schema || /^mailto:/i.test(o) ? e.md.normalizeLinkText(o) : e.md.normalizeLinkText("mailto:" + o).replace(/^mailto:/, "") : e.md.normalizeLinkText("http://" + o).replace(/^http:\/\//, "");
            const s = l[t].index;
            if (s > h) {
              const t = new e.Token("text", "", 0);
              t.content = i.slice(h, s), t.level = c, a.push(t);
            }
            ...
            d.level = --c, d.markup = "linkify", d.info = "auto", a.push(d), h = l[t].lastIndex;
          }
          if (h < i.length) {
            const t = new e.Token("text", "", 0);
            t.content = i.slice(h), t.level = c, a.push(t);
          }
          t[n].children = r = Fs(r, o, a);
        }
  ...
  let t;
  if (e.md.options.typographer) for (t = e.tokens.length - 1; t >= 0; t--) "inline" === e.tokens[t].type && (cl.test(e.tokens[t].content) && dl(e.tokens[t].children), al.test(e.tokens[t].content) && fl(e.tokens[t].children));
}], ["smartquotes", function (e) {
  if (e.md.options.typographer) for (let t = e.tokens.length - 1; t >= 0; t--) "inline" === e.tokens[t].type && ml.test(e.tokens[t].content) && kl(e.tokens[t].children, e);
  ...
  for (let e = 0; e < i; e++) {
    ...
    const i = r[e].children,
      o = i.length;
    for (t = 0; t < o; t++) "text_special" === i[t].type && (i[t].type = "text");
    for (t = n = 0; t < o; t++) "text" === i[t].type && t + 1 < o && "text" === i[t + 1].type ? i[t + 1].content = i[t].content + i[t + 1].content : (t !== n && (i[n] = i[t]), n++);
    t !== n && (i.length = n);
  }
}]];
function wl() {
  this.ruler = new tl();
  for (let e = 0; e < bl.length; e++) this.ruler.push(bl[e][0], bl[e][1]);
}
function Cl(e, t, n, r) {
  ...
  const i = this.src;
  for (let e = 0, t = 0, n = 0, r = 0, o = i.length, s = !1; t < o; t++) {
    const l = i.charCodeAt(t);
    if (!s) {
      if (Ws(l)) {
        n++, 9 === l ? r += 4 - r % 4 : r++;
        continue;
    ...
    10 !== l && t !== o - 1 || (10 !== l && t++, this.bMarks.push(e), this.eMarks.push(t), this.tShift.push(n), this.sCount.push(r), this.bsCount.push(0), s = !1, n = 0, r = 0, e = t + 1);
  }
  this.bMarks.push(i.length), this.eMarks.push(i.length), this.tShift.push(0), this.sCount.push(0), this.bsCount.push(0), this.lineMax = this.bMarks.length - 1;
}
wl.prototype.process = function (e) {
  const t = this.ruler.getRules("");
  for (let n = 0, r = t.length; n < r; n++) t[n](e);
}, wl.prototype.State = rl, Cl.prototype.push = function (e, t, n) {
  const r = new nl(e, t, n);
  return r.block = !0, n < 0 && this.level--, r.level = this.level, n > 0 && this.level++, this.tokens.push(r), r;
}, Cl.prototype.isEmpty = function (e) {
  return this.bMarks[e] + this.tShift[e] >= this.eMarks[e];
}, Cl.prototype.skipEmptyLines = function (e) {
  for (let t = this.lineMax; e < t && !(this.bMarks[e] + this.tShift[e] < this.eMarks[e]); e++);
  return e;
}, Cl.prototype.skipSpaces = function (e) {
  for (let t = this.src.length; e < t; e++) {
    if (!Ws(this.src.charCodeAt(e))) break;
  }
  return e;
}, Cl.prototype.skipSpacesBack = function (e, t) {
  if (e <= t) return e;
  for (; e > t;) if (!Ws(this.src.charCodeAt(--e))) return e + 1;
  return e;
}, Cl.prototype.skipChars = function (e, t) {
  for (let n = this.src.length; e < n && this.src.charCodeAt(e) === t; e++);
  return e;
}, Cl.prototype.skipCharsBack = function (e, t, n) {
  if (e <= n) return e;
  for (; e > n;) if (t !== this.src.charCodeAt(--e)) return e + 1;
  return e;
}, Cl.prototype.getLines = function (e, t, n, r) {
  if (e >= t) return "";
  ...
  for (let o = 0, s = e; s < t; s++, o++) {
    ...
    let a,
      c = l;
    for (a = s + 1 < t || r ? this.eMarks[s] + 1 : this.eMarks[s]; c < a && e < n;) {
      const t = this.src.charCodeAt(c);
      if (Ws(t)) 9 === t ? e += 4 - (e + this.bsCount[s]) % 4 : e++;else {
        if (!(c - l < this.tShift[s])) break;
        e++;
      }
      c++;
    }
    i[o] = e > n ? new Array(e - n + 1).join(" ") + this.src.slice(c, a) : this.src.slice(c, a);
  }
  return i.join("");
}, Cl.prototype.Token = nl;
function xl(e, t) {
...
function Dl(e) {
  ...
  let r = 0,
    ...
    s = 0,
    l = "";
  for (; r < n;) 124 === i && (o ? (l += e.substring(s, r - 1), s = r) : (t.push(l + e.substring(s, r)), l = "", s = r + 1)), o = 92 === i, r++, i = e.charCodeAt(r);
...
function vl(e, t) {
  ...
  if (r < n) {
    if (!Ws(e.src.charCodeAt(r))) return -1;
  }
  return r;
}
function _l(e, t) {
  ...
  return i < r && (o = e.src.charCodeAt(i), !Ws(o)) ? -1 : i;
}
...
const Nl = [["table", function (e, t, n, r) {
  ...
  for (; o < e.eMarks[i];) {
    ...
    if (124 !== t && 45 !== t && 58 !== t && !Ws(t)) return !1;
    o++;
  }
  let a = xl(e, t + 1),
    c = a.split("|");
  ...
  for (let e = 0; e < c.length; e++) {
    ...
    if (!/^:?-+:?$/.test(t)) return !1;
    58 === t.charCodeAt(t.length - 1) ? h.push(58 === t.charCodeAt(0) ? "center" : "right") : 58 === t.charCodeAt(0) ? h.push("left") : h.push("");
  }
  if (a = xl(e, t).trim(), -1 === a.indexOf("|")) return !1;
  ...
  for (let t = 0; t < c.length; t++) {
    ...
    h[t] && (n.attrs = [["style", "text-align:" + h[t]]]);
  ...
  for (i = t + 2; i < n && !(e.sCount[i] < e.blkIndent); i++) {
    let r = !1;
    for (let t = 0, o = d.length; t < o; t++) if (d[t](e, i, n, !0)) {
      r = !0;
      break;
    }
    if (r) break;
    if (a = xl(e, i).trim(), !a) break;
  ...
  return m && (e.push("tbody_close", "tbody", -1), m[1] = i), e.push("table_close", "table", -1), f[1] = i, e.parentType = p, e.line = i, !0;
}, ["paragraph", "reference"]], ["code", function (e, t, n) {
  if (e.sCount[t] - e.blkIndent < 4) return !1;
  let r = t + 1,
    i = r;
  for (; r < n;) if (e.isEmpty(r)) r++;else {
  ...
  let a = i - l;
  if (a < 3) return !1;
  const c = e.src.slice(l, i),
    h = e.src.slice(i, o);
  if (96 === s && h.indexOf(String.fromCharCode(s)) >= 0) return !1;
  if (r) return !0;
  let u = t,
    p = !1;
  for (; (u++, !(u >= n)) && (i = l = e.bMarks[u] + e.tShift[u], o = e.eMarks[u], !(i < o && e.sCount[u] < e.blkIndent));) if (e.src.charCodeAt(i) === s && !(e.sCount[u] - e.blkIndent >= 4 || (i = e.skipChars(i, s), i - l < a || (i = e.skipSpaces(i), i < o)))) {
    p = !0;
    break;
  }
  a = e.sCount[t], e.line = u + (p ? 1 : 0);
  const d = e.push("fence", "code", 0);
  return d.info = h, d.content = e.getLines(t + 1, u, a, !0), d.markup = c, d.map = [t, e.line], !0;
}, ["paragraph", "reference", "blockquote", "list"]], ["blockquote", function (e, t, n, r) {
  let i = e.bMarks[t] + e.tShift[t],
    o = e.eMarks[t];
  const s = e.lineMax;
  if (e.sCount[t] - e.blkIndent >= 4) return !1;
  ...
  const l = [],
    ...
    c = [],
    h = [],
    u = e.md.block.ruler.getRules("blockquote"),
    p = e.parentType;
  ...
  for (d = t; d < n; d++) {
    ...
    if (i = e.bMarks[d] + e.tShift[d], o = e.eMarks[d], i >= o) break;
    if (62 === e.src.charCodeAt(i++) && !t) {
      let t,
        n,
        r = e.sCount[d] + 1;
      32 === e.src.charCodeAt(i) ? (i++, r++, n = !1, t = !0) : 9 === e.src.charCodeAt(i) ? (t = !0, (e.bsCount[d] + r) % 4 == 3 ? (i++, r++, n = !1) : n = !0) : t = !1;
      let s = r;
      for (l.push(e.bMarks[d]), e.bMarks[d] = i; i < o;) {
        const t = e.src.charCodeAt(i);
        if (!Ws(t)) break;
        9 === t ? s += 4 - (s + e.bsCount[d] + (n ? 1 : 0)) % 4 : s++, i++;
      }
      f = i >= o, a.push(e.bsCount[d]), e.bsCount[d] = e.sCount[d] + 1 + (t ? 1 : 0), c.push(e.sCount[d]), e.sCount[d] = s - r, h.push(e.tShift[d]), e.tShift[d] = i - e.bMarks[d];
      continue;
    }
    if (f) break;
    let r = !1;
    for (let t = 0, i = u.length; t < i; t++) if (u[t](e, d, n, !0)) {
      r = !0;
      break;
    }
    if (r) {
      e.lineMax = d, 0 !== e.blkIndent && (l.push(e.bMarks[d]), a.push(e.bsCount[d]), h.push(e.tShift[d]), c.push(e.sCount[d]), e.sCount[d] -= e.blkIndent);
      break;
    }
    l.push(e.bMarks[d]), a.push(e.bsCount[d]), h.push(e.tShift[d]), c.push(e.sCount[d]), e.sCount[d] = -1;
  }
  const m = e.blkIndent;
  e.blkIndent = 0;
  ...
  g.markup = ">";
  const y = [t, 0];
  g.map = y, e.md.block.tokenize(e, t, d), e.push("blockquote_close", "blockquote", -1).markup = ">", e.lineMax = s, e.parentType = p, y[1] = e.line;
  for (let n = 0; n < h.length; n++) e.bMarks[n + t] = l[n], e.tShift[n + t] = h[n], e.sCount[n + t] = c[n], e.bsCount[n + t] = a[n];
  return e.blkIndent = m, !0;
}, ["paragraph", "reference", "blockquote", "list"]], ["hr", function (e, t, n, r) {
  const i = e.eMarks[t];
  if (e.sCount[t] - e.blkIndent >= 4) return !1;
  ...
  return a.map = [t, e.line], a.markup = Array(l + 1).join(String.fromCharCode(s)), !0;
}, ["paragraph", "reference", "blockquote", "list"]], ["list", function (e, t, n, r) {
  let i,
    o,
    s,
    l,
  ...
  if (e.listIndent >= 0 && e.sCount[a] - e.listIndent >= 4 && e.sCount[a] < e.blkIndent) return !1;
  let h,
    u,
    p,
    d = !1;
  if (r && "paragraph" === e.parentType && e.sCount[a] >= e.blkIndent && (d = !0), (p = _l(e, a)) >= 0) {
    if (h = !0, s = e.bMarks[a] + e.tShift[a], u = Number(e.src.slice(s, p - 1)), d && 1 !== u) return !1;
  } else {
    if (!((p = vl(e, a)) >= 0)) return !1;
    h = !1;
  }
  if (d && e.skipSpaces(p) >= e.eMarks[a]) return !1;
  if (r) return !0;
  const f = e.src.charCodeAt(p - 1),
    m = e.tokens.length;
  h ? (l = e.push("ordered_list_open", "ol", 1), 1 !== u && (l.attrs = [["start", u]])) : l = e.push("bullet_list_open", "ul", 1);
  const g = [a, 0];
  ...
  for (e.parentType = "list"; a < n;) {
    ...
    for (; o < i;) {
      const t = e.src.charCodeAt(o);
      if (9 === t) r += 4 - (r + e.bsCount[a]) % 4;else {
        if (32 !== t) break;
        r++;
      }
      o++;
    ...
    d = u >= i ? 1 : r - t, d > 4 && (d = 1);
    const m = t + d;
    l = e.push("list_item_open", "li", 1), l.markup = String.fromCharCode(f);
    const g = [a, 0];
    l.map = g, h && (l.info = e.src.slice(s, p - 1));
    const b = e.tight,
      w = e.tShift[a],
      C = e.sCount[a],
      x = e.listIndent;
    if (e.listIndent = e.blkIndent, e.blkIndent = m, e.tight = !0, e.tShift[a] = u - e.bMarks[a], e.sCount[a] = r, u >= i && e.isEmpty(a + 1) ? e.line = Math.min(e.line + 2, n) : e.md.block.tokenize(e, a, n, !0), e.tight && !y || (c = !1), y = e.line - a > 1 && e.isEmpty(e.line - 1), e.blkIndent = e.listIndent, e.listIndent = x, e.tShift[a] = w, e.sCount[a] = C, e.tight = b, l = e.push("list_item_close", "li", -1), l.markup = String.fromCharCode(f), a = e.line, g[1] = a, a >= n) break;
    if (e.sCount[a] < e.blkIndent) break;
    if (e.sCount[a] - e.blkIndent >= 4) break;
    let D = !1;
    for (let t = 0, r = k.length; t < r; t++) if (k[t](e, a, n, !0)) {
      D = !0;
      break;
    }
    if (D) break;
    if (h) {
      if (p = _l(e, a), p < 0) break;
      s = e.bMarks[a] + e.tShift[a];
    } else if (p = vl(e, a), p < 0) break;
    if (f !== e.src.charCodeAt(p - 1)) break;
  }
  return l = h ? e.push("ordered_list_close", "ol", -1) : e.push("bullet_list_close", "ul", -1), l.markup = String.fromCharCode(f), g[1] = a, e.line = a, e.parentType = b, c && function (e, t) {
    const n = e.level + 2;
    for (let r = t + 2, i = e.tokens.length - 2; r < i; r++) e.tokens[r].level === n && "paragraph_open" === e.tokens[r].type && (e.tokens[r + 2].hidden = !0, e.tokens[r].hidden = !0, r += 2);
  }(e, m), !0;
}, ["paragraph", "reference", "blockquote"]], ["reference", function (e, t, n, r) {
  let i = e.bMarks[t] + e.tShift[t],
    o = e.eMarks[t],
    s = t + 1;
  if (e.sCount[t] - e.blkIndent >= 4) return !1;
  ...
  function l(t) {
    ...
    if (e.sCount[t] - e.blkIndent > 3 && (r = !0), e.sCount[t] < 0 && (r = !0), !r) {
      ...
      let o = !1;
      for (let i = 0, s = r.length; i < s; i++) if (r[i](e, t, n, !0)) {
        o = !0;
        break;
      }
      if (e.parentType = i, o) return null;
    }
    const i = e.bMarks[t] + e.tShift[t],
      o = e.eMarks[t];
    return e.src.slice(i, o + 1);
  }
  let a = e.src.slice(i, o + 1);
  o = a.length;
  let c = -1;
  for (i = 1; i < o; i++) {
    ...
    if (10 === e) {
      const e = l(s);
      null !== e && (a += e, o = a.length, s++);
    } else if (92 === e && (i++, i < o && 10 === a.charCodeAt(i))) {
      const e = l(s);
      null !== e && (a += e, o = a.length, s++);
    }
  }
  ...
  const h = e.md.helpers.parseLinkDestination(a, i, o);
  if (!h.ok) return !1;
  const u = e.md.normalizeLink(h.str);
  ...
  let m,
    g = e.md.helpers.parseLinkTitle(a, i, o);
  for (; g.can_continue;) {
    const t = l(s);
    if (null === t) break;
    a += t, i = o, o = a.length, s++, g = e.md.helpers.parseLinkTitle(a, i, o, g);
  }
  ...
  return !!y && (r || (void 0 === e.env.references && (e.env.references = {}), void 0 === e.env.references[y] && (e.env.references[y] = {
    title: m,
    href: u
  }), e.line = s), !0);
}], ["html_block", function (e, t, n, r) {
  let i = e.bMarks[t] + e.tShift[t],
    o = e.eMarks[t];
  if (e.sCount[t] - e.blkIndent >= 4) return !1;
  ...
  if (r) return Ol[l][2];
  let a = t + 1;
  if (!Ol[l][1].test(s)) for (; a < n && !(e.sCount[a] < e.blkIndent); a++) if (i = e.bMarks[a] + e.tShift[a], o = e.eMarks[a], s = e.src.slice(i, o), Ol[l][1].test(s)) {
    0 !== s.length && a++;
    break;
  }
  e.line = a;
...
}, ["paragraph", "reference", "blockquote"]], ["heading", function (e, t, n, r) {
  let i = e.bMarks[t] + e.tShift[t],
    o = e.eMarks[t];
  if (e.sCount[t] - e.blkIndent >= 4) return !1;
  ...
  let l = 1;
  for (s = e.src.charCodeAt(++i); 35 === s && i < o && l <= 6;) l++, s = e.src.charCodeAt(++i);
  if (l > 6 || i < o && !Ws(s)) return !1;
  if (r) return !0;
  o = e.skipSpacesBack(o, i);
  const a = e.skipCharsBack(o, 35, i);
  a > i && Ws(e.src.charCodeAt(a - 1)) && (o = a), e.line = t + 1;
  const c = e.push("heading_open", "h" + String(l), 1);
  c.markup = "########".slice(0, l), c.map = [t, e.line];
  const h = e.push("inline", "", 0);
  return h.content = e.src.slice(i, o).trim(), h.map = [t, e.line], h.children = [], e.push("heading_close", "h" + String(l), -1).markup = "########".slice(0, l), !0;
}, ["paragraph", "reference", "blockquote"]], ["lheading", function (e, t, n) {
  ...
  for (; l < n && !e.isEmpty(l); l++) {
    ...
    if (e.sCount[l] >= e.blkIndent) {
      ...
      const n = e.eMarks[l];
      if (t < n && (o = e.src.charCodeAt(t), (45 === o || 61 === o) && (t = e.skipChars(t, o), t = e.skipSpaces(t), t >= n))) {
        s = 61 === o ? 1 : 2;
        break;
      }
    }
    ...
    let t = !1;
    for (let i = 0, o = r.length; i < o; i++) if (r[i](e, l, n, !0)) {
      t = !0;
      break;
    }
    if (t) break;
  ...
  if (!s) return !1;
  const a = e.getLines(t, l, e.blkIndent, !1).trim();
  e.line = l + 1;
  const c = e.push("heading_open", "h" + String(s), 1);
  c.markup = String.fromCharCode(o), c.map = [t, e.line];
  const h = e.push("inline", "", 0);
  return h.content = a, h.map = [t, e.line - 1], h.children = [], e.push("heading_close", "h" + String(s), -1).markup = String.fromCharCode(o), e.parentType = i, !0;
}], ["paragraph", function (e, t, n) {
  const r = e.md.block.ruler.getRules("paragraph"),
    i = e.parentType;
  let o = t + 1;
  for (e.parentType = "paragraph"; o < n && !e.isEmpty(o); o++) {
    ...
    let t = !1;
    for (let i = 0, s = r.length; i < s; i++) if (r[i](e, o, n, !0)) {
      t = !0;
      break;
    }
    if (t) break;
  ...
  e.line = o, e.push("paragraph_open", "p", 1).map = [t, e.line];
...
Fl.prototype.tokenize = function (e, t, n) {
  ...
  for (; s < n && (e.line = s = e.skipEmptyLines(s), !(s >= n)) && !(e.sCount[s] < e.blkIndent);) {
    ...
    const t = e.line;
    let a = !1;
    for (let o = 0; o < i; o++) if (a = r[o](e, s, n, !1), a) {
...
}, Fl.prototype.parse = function (e, t, n, r) {
  if (!e) return;
  const i = new this.State(e, t, n, r);
  this.tokenize(i, i.line, i.lineMax);
}, Fl.prototype.State = Cl, Tl.prototype.pushPending = function () {
  const e = new nl("text", "", 0);
...
}, Tl.prototype.scanDelims = function (e, t) {
  const n = this.posMax,
...
function Bl(e, t) {
  ...
  for (let o = 0; o < i; o++) {
    ...
    if (-1 === i.end) continue;
    const s = t[i.end];
    n = e.tokens[i.token], n.type = "s_open", n.tag = "s", n.nesting = 1, n.markup = "~~", n.content = "", n = e.tokens[s.token], n.type = "s_close", n.tag = "s", n.nesting = -1, n.markup = "~~", n.content = "", "text" === e.tokens[s.token - 1].type && "~" === e.tokens[s.token - 1].content && r.push(s.token - 1);
  }
  for (; r.length;) {
    const t = r.pop();
    let i = t + 1;
...
var Pl = {
  tokenize: function (e, t) {
    ...
    if (o < 2) return !1;
    let l;
    o % 2 && (l = e.push("text", "", 0), l.content = s, o--);
    for (let t = 0; t < o; t += 2) l = e.push("text", "", 0), l.content = s + s, e.delimiters.push({
      marker: r,
      length: 0,
  ...
  postProcess: function (e) {
    ...
    Bl(e, e.delimiters);
    for (let r = 0; r < n; r++) t[r] && t[r].delimiters && Bl(e, t[r].delimiters);
  }
};
function Ll(e, t) {
  for (let n = t.length - 1; n >= 0; n--) {
    ...
    if (-1 === r.end) continue;
    const i = t[r.end],
      o = n > 0 && t[n - 1].end === r.end + 1 && t[n - 1].marker === r.marker && t[n - 1].token === r.token - 1 && t[r.end + 1].token === i.token + 1,
    ...
    a.type = o ? "strong_close" : "em_close", a.tag = o ? "strong" : "em", a.nesting = -1, a.markup = o ? s + s : s, a.content = "", o && (e.tokens[t[n - 1].token].content = "", e.tokens[t[r.end + 1].token].content = "", n--);
  }
}
var ql = {
  tokenize: function (e, t) {
    ...
    const i = e.scanDelims(e.pos, 42 === r);
    for (let t = 0; t < i.length; t++) {
      e.push("text", "", 0).content = String.fromCharCode(r), e.delimiters.push({
        marker: r,
        length: i.length,
        token: e.tokens.length - 1,
        end: -1,
  ...
  postProcess: function (e) {
    const t = e.tokens_meta,
      n = e.tokens_meta.length;
    Ll(e, e.delimiters);
    for (let r = 0; r < n; r++) t[r] && t[r].delimiters && Ll(e, t[r].delimiters);
  }
};
const $l = /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
...
function Wl(e) {
  ...
  for (let s = 0; s < n; s++) {
    const n = e[s];
    if (o.push(0), e[r].marker === n.marker && i === n.token - 1 || (r = s), i = n.token, n.length = n.length || 0, !n.close) continue;
    t.hasOwnProperty(n.marker) || (t[n.marker] = [-1, -1, -1, -1, -1, -1]);
    const l = t[n.marker][(n.open ? 3 : 0) + n.length % 3];
    let a = r - o[r] - 1,
      c = a;
    for (; a > l; a -= o[a] + 1) {
      const t = e[a];
      if (t.marker === n.marker && t.open && t.end < 0) {
        ...
        if ((t.close || n.open) && (t.length + n.length) % 3 == 0 && (t.length % 3 == 0 && n.length % 3 == 0 || (r = !0)), !r) {
          const r = a > 0 && !e[a - 1].open ? o[a - 1] + 1 : 0;
          o[s] = s - a + r, o[a] = r, n.open = !1, t.end = s, t.close = !1, c = -1, i = -2;
          break;
        }
      }
    }
    -1 !== c && (t[n.marker][(n.open ? 3 : 0) + (n.length || 0) % 3] = c);
  }
}
const Hl = [["text", function (e, t) {
    let n = e.pos;
    for (; n < e.posMax && !Rl(e.src.charCodeAt(n));) n++;
    ...
    const r = e.pending.match(zl);
    if (!r) return !1;
    const i = r[1],
      o = e.md.linkify.matchAtStart(e.src.slice(n - i.length));
    if (!o) return !1;
    let s = o.url;
    if (s.length <= i.length) return !1;
    s = s.replace(/\*+$/, "");
    const l = e.md.normalizeLink(s);
    ...
    const r = e.pending.length - 1,
      i = e.posMax;
    if (!t) if (r >= 0 && 32 === e.pending.charCodeAt(r)) {
    ...
    for (n++; n < i && Ws(e.src.charCodeAt(n));) n++;
    return e.pos = n, !0;
  }], ["escape", function (e, t) {
    let n = e.pos;
    const r = e.posMax;
    ...
    if (10 === i) {
      for (t || e.push("hardbreak", "br", 0), n++; n < r && (i = e.src.charCodeAt(n), Ws(i));) n++;
      return e.pos = n, !0;
    }
    let o = e.src[n];
    if (i >= 55296 && i <= 56319 && n + 1 < r) {
      const t = e.src.charCodeAt(n + 1);
      t >= 56320 && t <= 57343 && (o += e.src[n + 1], n++);
    }
    const s = "\\" + o;
    if (!t) {
      const t = e.push("text_special", "", 0);
      i < 256 && 0 !== Il[i] ? t.content = o : t.content = s, t.markup = s, t.info = "escape";
    }
    return e.pos = n + 1, !0;
    ...
    const o = e.src.slice(r, n),
      s = o.length;
    if (e.backticksScanned && (e.backticks[s] || 0) <= r) return t || (e.pending += o), e.pos += s, !0;
    let l,
      a = n;
    for (; -1 !== (l = e.src.indexOf("`", a));) {
      for (a = l + 1; a < i && 96 === e.src.charCodeAt(a);) a++;
      const r = a - l;
      if (r === s) {
        if (!t) {
          const t = e.push("code_inline", "code", 0);
          t.markup = o, t.content = e.src.slice(n, l).replace(/\n/g, " ").replace(/^ (.+) $/, "$1");
        }
        return e.pos = a, !0;
      }
      e.backticks[r] = l;
  ...
  }], ["strikethrough", Pl.tokenize], ["emphasis", ql.tokenize], ["link", function (e, t) {
    let n,
      r,
      i,
      o,
    ...
    if (d < 0) return !1;
    let f = d + 1;
    if (f < u && 40 === e.src.charCodeAt(f)) {
      for (c = !1, f++; f < u && (n = e.src.charCodeAt(f), Ws(n) || 10 === n); f++);
      if (f >= u) return !1;
      if (a = f, i = e.md.helpers.parseLinkDestination(e.src, f, e.posMax), i.ok) {
        for (s = e.md.normalizeLink(i.str), e.md.validateLink(s) ? f = i.pos : s = "", a = f; f < u && (n = e.src.charCodeAt(f), Ws(n) || 10 === n); f++);
        if (i = e.md.helpers.parseLinkTitle(e.src, f, e.posMax), f < u && a !== f && i.ok) for (l = i.str, f = i.pos; f < u && (n = e.src.charCodeAt(f), Ws(n) || 10 === n); f++);
      }
      (f >= u || 41 !== e.src.charCodeAt(f)) && (c = !0), f++;
    }
    if (c) {
      if (void 0 === e.env.references) return !1;
      if (f < u && 91 === e.src.charCodeAt(f) ? (a = f + 1, f = e.md.helpers.parseLinkLabel(e, f), f >= 0 ? r = e.src.slice(a, f++) : f = d + 1) : f = d + 1, r || (r = e.src.slice(p, d)), o = e.env.references[Zs(r)], !o) return e.pos = h, !1;
      s = o.href, l = o.title;
    }
    if (!t) {
      e.pos = p, e.posMax = d;
      const t = [["href", s]];
      e.push("link_open", "a", 1).attrs = t, l && t.push(["title", l]), e.linkLevel++, e.md.inline.tokenize(e), e.linkLevel--, e.push("link_close", "a", -1);
    }
    return e.pos = f, e.posMax = u, !0;
  }], ["image", function (e, t) {
    let n,
      r,
      i,
    ...
    if (f < 0) return !1;
    if (o = f + 1, o < p && 40 === e.src.charCodeAt(o)) {
      for (o++; o < p && (n = e.src.charCodeAt(o), Ws(n) || 10 === n); o++);
      if (o >= p) return !1;
      for (c = o, l = e.md.helpers.parseLinkDestination(e.src, o, e.posMax), l.ok && (h = e.md.normalizeLink(l.str), e.md.validateLink(h) ? o = l.pos : h = ""), c = o; o < p && (n = e.src.charCodeAt(o), Ws(n) || 10 === n); o++);
      if (l = e.md.helpers.parseLinkTitle(e.src, o, e.posMax), o < p && c !== o && l.ok) for (a = l.str, o = l.pos; o < p && (n = e.src.charCodeAt(o), Ws(n) || 10 === n); o++);else a = "";
      if (o >= p || 41 !== e.src.charCodeAt(o)) return e.pos = u, !1;
      o++;
    } else {
      if (void 0 === e.env.references) return !1;
      if (o < p && 91 === e.src.charCodeAt(o) ? (c = o + 1, o = e.md.helpers.parseLinkLabel(e, o), o >= 0 ? i = e.src.slice(c, o++) : o = f + 1) : o = f + 1, i || (i = e.src.slice(d, f)), s = e.env.references[Zs(i)], !s) return e.pos = u, !1;
      h = s.href, a = s.title;
    }
    if (!t) {
      r = e.src.slice(d, f);
      ...
      const n = e.push("image", "img", 0),
        i = [["src", h], ["alt", ""]];
      n.attrs = i, n.children = t, n.content = r, a && i.push(["title", a]);
    }
    ...
    if ($l.test(o)) {
      const n = e.md.normalizeLink("mailto:" + o);
      if (!e.md.validateLink(n)) return !1;
      if (!t) {
        const t = e.push("link_open", "a", 1);
        t.attrs = [["href", n]], t.markup = "autolink", t.info = "auto";
    ...
    if (33 !== i && 63 !== i && 47 !== i && !function (e) {
      const t = 32 | e;
      return t >= 97 && t <= 122;
    }(i)) return !1;
    const o = e.src.slice(r).match(Al);
    if (!o) return !1;
    if (!t) {
      const t = e.push("html_inline", "", 0);
      t.content = o[0], s = t.content, /^<a[>\s]/i.test(s) && e.linkLevel++, function (e) {
        return /^<\/a\s*>/i.test(e);
    ...
    if (35 === e.src.charCodeAt(n + 1)) {
      const r = e.src.slice(n).match(jl);
      if (r) {
        if (!t) {
          const t = "x" === r[1][0].toLowerCase() ? parseInt(r[1].slice(1), 16) : parseInt(r[1], 10),
            n = e.push("text_special", "", 0);
          n.content = Ts(t) ? Rs(t) : Rs(65533), n.markup = r[0], n.info = "entity";
        }
  ...
  Ul = [["balance_pairs", function (e) {
    const t = e.tokens_meta,
      n = e.tokens_meta.length;
    Wl(e.delimiters);
    for (let e = 0; e < n; e++) t[e] && t[e].delimiters && Wl(t[e].delimiters);
  }], ["strikethrough", Pl.postProcess], ["emphasis", ql.postProcess], ["fragments_join", function (e) {
    let t,
      n,
      r = 0;
    const i = e.tokens,
...
function Kl() {
  this.ruler = new tl();
  for (let e = 0; e < Hl.length; e++) this.ruler.push(Hl[e][0], Hl[e][1]);
  this.ruler2 = new tl();
  for (let e = 0; e < Ul.length; e++) this.ruler2.push(Ul[e][0], Ul[e][1]);
}
function Zl(e) {
  return Array.prototype.slice.call(arguments, 1).forEach(function (t) {
...
function Ql(e) {
  return "[object Function]" === Gl(e);
}
function Xl(e) {
  return e.replace(/[.?*+^$[\]\\(){}|-]/g, "\\$&");
}
Kl.prototype.skipToken = function (e) {
  const t = e.pos,
    n = this.ruler.getRules(""),
    r = n.length,
    i = e.md.options.maxNesting,
    o = e.cache;
  if (void 0 !== o[t]) return void (e.pos = o[t]);
  let s = !1;
  if (e.level < i) {
    for (let i = 0; i < r; i++) if (e.level++, s = n[i](e, !0), e.level--, s) {
      if (t >= e.pos) throw new Error("inline rule didn't increment state.pos");
      break;
    }
  } else e.pos = e.posMax;
  s || e.pos++, o[t] = e.pos;
}, Kl.prototype.tokenize = function (e) {
  const t = this.ruler.getRules(""),
    n = t.length,
    r = e.posMax,
    i = e.md.options.maxNesting;
  for (; e.pos < r;) {
    const o = e.pos;
    let s = !1;
    if (e.level < i) for (let r = 0; r < n; r++) if (s = t[r](e, !1), s) {
...
}, Kl.prototype.parse = function (e, t, n, r) {
  const i = new this.State(e, t, n, r);
  this.tokenize(i);
...
const ea = {
  ...
  ta = "biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");
function na(e) {
  const t = e.re = function (e) {
      const t = {};
      e = e || {}, t.src_Any = ls.source, t.src_Cc = as.source, t.src_Z = us.source, t.src_P = cs.source, t.src_ZPCc = [t.src_Z, t.src_P, t.src_Cc].join("|"), t.src_ZCc = [t.src_Z, t.src_Cc].join("|");
      const n = "[><｜]";
  ...
  e.__compiled__ = {}, Object.keys(e.__schemas__).forEach(function (t) {
    ...
    if (e.__compiled__[t] = r, "[object Object]" === Gl(n)) return !function (e) {
      return "[object RegExp]" === Gl(e);
    }(n.validate) ? Ql(n.validate) ? r.validate = n.validate : o(t, n) : r.validate = function (e) {
      return function (t, n) {
        const r = t.slice(n);
        return e.test(r) ? r.match(e)[0].length : 0;
      };
    }(n.validate), void (Ql(n.normalize) ? r.normalize = n.normalize : n.normalize ? o(t, n) : r.normalize = function (e, t) {
      t.normalize(e);
    });
    !function (e) {
      return "[object String]" === Gl(e);
    }(n) ? o(t, n) : i.push(t);
  ...
  e.re.schema_test = RegExp("(^|(?!_)(?:[><｜]|" + t.src_ZPCc + "))(" + s + ")", "i"), e.re.schema_search = RegExp("(^|(?!_)(?:[><｜]|" + t.src_ZPCc + "))(" + s + ")", "ig"), e.re.schema_at_start = RegExp("^" + e.re.schema_search.source, "i"), e.re.pretest = RegExp("(" + e.re.schema_test.source + ")|(" + e.re.host_fuzzy_test.source + ")|@", "i"), function (e) {
...
function oa(e, t) {
  ...
  t || (n = e, Object.keys(n || {}).reduce(function (e, t) {
    return e || Yl.hasOwnProperty(t);
  }, !1) && (t = e, e = {})), this.__opts__ = Zl({}, Yl, t), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = Zl({}, ea, e), this.__compiled__ = {}, this.__tlds__ = ta, this.__tlds_replaced__ = !1, this.re = {}, na(this);
}
oa.prototype.add = function (e, t) {
  return this.__schemas__[e] = t, na(this), this;
}, oa.prototype.set = function (e) {
  return this.__opts__ = Zl(this.__opts__, e), this;
}, oa.prototype.test = function (e) {
  if (this.__text_cache__ = e, this.__index__ = -1, !e.length) return !1;
  let t, n, r, i, o, s, l, a, c;
  if (this.re.schema_test.test(e)) for (l = this.re.schema_search, l.lastIndex = 0; null !== (t = l.exec(e));) if (i = this.testSchemaAt(e, t[2], l.lastIndex), i) {
...
}, oa.prototype.pretest = function (e) {
  return this.re.pretest.test(e);
}, oa.prototype.testSchemaAt = function (e, t, n) {
  return this.__compiled__[t.toLowerCase()] ? this.__compiled__[t.toLowerCase()].validate(e, n, this) : 0;
}, oa.prototype.match = function (e) {
  const t = [];
  let n = 0;
  this.__index__ >= 0 && this.__text_cache__ === e && (t.push(ia(this, n)), n = this.__last_index__);
  let r = n ? e.slice(n) : e;
  for (; this.test(r);) t.push(ia(this, n)), r = r.slice(this.__last_index__), n += this.__last_index__;
  return t.length ? t : null;
}, oa.prototype.matchAtStart = function (e) {
  if (this.__text_cache__ = e, this.__index__ = -1, !e.length) return null;
  const t = this.re.schema_at_start.exec(e);
  if (!t) return null;
  const n = this.testSchemaAt(e, t[2], t[0].length);
  return n ? (this.__schema__ = t[2], this.__index__ = t.index + t[1].length, this.__last_index__ = t.index + t[0].length + n, ia(this, 0)) : null;
}, oa.prototype.tlds = function (e, t) {
  return e = Array.isArray(e) ? e : [e], t ? (this.__tlds__ = this.__tlds__.concat(e).sort().filter(function (e, t, n) {
    return e !== n[t - 1];
  }).reverse(), na(this), this) : (this.__tlds__ = e.slice(), this.__tlds_replaced__ = !0, na(this), this);
}, oa.prototype.normalize = function (e) {
...
function ga(e) {
  ...
  for (; n < r;) {
    ...
    if (i >= 55296 && i <= 56319 && n < r) {
      const r = e.charCodeAt(n++);
      56320 == (64512 & r) ? t.push(((1023 & i) << 10) + (1023 & r) + 65536) : (t.push(i), n--);
    } else t.push(i);
  }
  return t;
}
const ya = function (e) {
    return e >= 48 && e < 58 ? e - 48 + 26 : e >= 65 && e < 91 ? e - 65 : e >= 97 && e < 123 ? e - 97 : la;
  },
  ka = function (e, t) {
  ...
  ba = function (e, t, n) {
    let r = 0;
    for (e = n ? pa(e / 700) : e >> 1, e += pa(e / t); e > 455; r += la) e = pa(e / 35);
    return pa(r + 36 * e / (e + 38));
  },
  wa = function (e) {
    const t = [],
      n = e.length;
    let r = 0,
      ...
      s = e.lastIndexOf("-");
    s < 0 && (s = 0);
    for (let n = 0; n < s; ++n) e.charCodeAt(n) >= 128 && fa("not-basic"), t.push(e.charCodeAt(n));
    for (let l = s > 0 ? s + 1 : 0; l < n;) {
      const s = r;
      for (let t = 1, i = la;; i += la) {
        l >= n && fa("invalid-input");
        const s = ya(e.charCodeAt(l++));
        s >= la && fa("invalid-input"), s > pa((sa - r) / t) && fa("overflow"), r += s * t;
        const a = i <= o ? 1 : i >= o + 26 ? 26 : i - o;
        if (s < a) break;
        const c = la - a;
        t > pa(sa / c) && fa("overflow"), t *= c;
      }
      const a = t.length + 1;
      o = ba(r - s, a, 0 == s), pa(r / a) > sa - i && fa("overflow"), i += pa(r / a), r %= a, t.splice(r++, 0, i);
    }
  ...
  Ca = function (e) {
    ...
    let r = 128,
      i = 0,
      o = 72;
    for (const n of e) n < 128 && t.push(da(n));
    const s = t.length;
    let l = s;
    for (s && t.push("-"); l < n;) {
      let n = sa;
      ...
      for (const n of e) if (n < r && ++i > sa && fa("overflow"), n === r) {
        let e = i;
        for (let n = la;; n += la) {
          ...
          const i = e - r,
            s = la - r;
          t.push(da(ka(r + i % s, 0))), e = pa(i / s);
        }
        t.push(da(ka(e, 0))), o = ba(i, a, l === s), i = 0, ++l;
      }
      ++i, ++r;
    }
    return t.join("");
  ...
  xa = function (e) {
    return ma(e, function (e) {
      return ca.test(e) ? "xn--" + Ca(e) : e;
    });
  },
  Da = function (e) {
    return ma(e, function (e) {
      return aa.test(e) ? wa(e.slice(4).toLowerCase()) : e;
    });
  };
const va = {
    default: {
...
function Ea(e) {
  ...
  return !_a.test(t) || Sa.test(t);
}
const Aa = ["http:", "https:", "mailto:"];
function Ma(e) {
  const t = rs(e, !0);
  if (t.hostname && (!t.protocol || Aa.indexOf(t.protocol) >= 0)) try {
    t.hostname = xa(t.hostname);
  } catch (e) {}
  return jo(Jo(t));
}
function Oa(e) {
  const t = rs(e, !0);
  if (t.hostname && (!t.protocol || Aa.indexOf(t.protocol) >= 0)) try {
    t.hostname = Da(t.hostname);
  } catch (e) {}
  return $o(Jo(t), $o.defaultChars + "%");
}
function Na(e, t) {
  if (!(this instanceof Na)) return new Na(e, t);
  t || Ms(e) || (t = e || {}, e = "default"), this.inline = new Kl(), this.block = new Fl(), this.core = new wl(), this.renderer = new el(), this.linkify = new oa(), this.validateLink = Ea, this.normalizeLink = Ma, this.normalizeLinkText = Oa, this.utils = Qs, this.helpers = Ns({}, Xs), this.options = {}, this.configure(e), t && this.set(t);
}
Na.prototype.set = function (e) {
  return Ns(this.options, e), this;
}, Na.prototype.configure = function (e) {
  const t = this;
  if (Ms(e)) {
    const t = e;
    if (!(e = va[t])) throw new Error('Wrong `markdown-it` preset "' + t + '", check name');
  }
  if (!e) throw new Error("Wrong `markdown-it` preset, can't be empty");
  return e.options && t.set(e.options), e.components && Object.keys(e.components).forEach(function (n) {
    e.components[n].rules && t[n].ruler.enableOnly(e.components[n].rules), e.components[n].rules2 && t[n].ruler2.enableOnly(e.components[n].rules2);
  }), this;
}, Na.prototype.enable = function (e, t) {
  let n = [];
  ...
  return this;
}, Na.prototype.disable = function (e, t) {
  let n = [];
  Array.isArray(e) || (e = [e]), ["core", "block", "inline"].forEach(function (t) {
  ...
  return this;
}, Na.prototype.use = function (e) {
  const t = [this].concat(Array.prototype.slice.call(arguments, 1));
  return e.apply(e, t), this;
}, Na.prototype.parse = function (e, t) {
...
}, Na.prototype.parseInline = function (e, t) {
  const n = new this.core.State(e, this, t);
  return n.inlineMode = !0, this.core.process(n), n.tokens;
}, Na.prototype.renderInline = function (e, t) {
...
const Fa = new H({
  nodes: {
    ...
    code_block: {
      ...
      toDOM: e => ["pre", e.attrs.params ? {
        "data-params": e.attrs.params
      } : {}, ["code", 0]]
    },
    ordered_list: {
      content: "list_item+",
...
class Ta {
  ...
  addText(e) {
    ...
    i && (t = function (e, t) {
      if (e.isText && t.isText && l.sameSet(e.marks, t.marks)) return e.withText(e.text + t.text);
    }(i, o)) ? r[r.length - 1] = t : r.push(o);
  }
  openMark(e) {
    let t = this.top();
...
function za(e, t) {
  return e.noCloseToken || "code_inline" == t || "code_block" == t || "fence" == t;
}
function Ia(e) {
...
function Ba() {}
function Pa(e, t) {
  for (; ++t < e.length;) if ("list_item_open" != e[t].type) return e[t].hidden;
  return !1;
}
const La = new class {
  constructor(e, t, n) {
    this.schema = e, this.tokenizer = t, this.tokens = n, this.tokenHandlers = function (e, t) {
      let n = Object.create(null);
      for (let r in t) {
        let i = t[r];
        if (i.block) {
          ...
          za(i, r) ? n[r] = (e, n, r, o) => {
            e.openNode(t, Ra(i, n, r, o)), e.addText(Ia(n.content)), e.closeNode();
          } : (n[r + "_open"] = (e, n, r, o) => e.openNode(t, Ra(i, n, r, o)), n[r + "_close"] = e => e.closeNode());
        } else if (i.node) {
          let t = e.nodeType(i.node);
          n[r] = (e, n, r, o) => e.addNode(t, Ra(i, n, r, o));
        } else if (i.mark) {
          let t = e.marks[i.mark];
          za(i, r) ? n[r] = (e, n, r, o) => {
            e.openMark(t.create(Ra(i, n, r, o))), e.addText(Ia(n.content)), e.closeMark(t);
          } : (n[r + "_open"] = (e, n, r, o) => e.openMark(t.create(Ra(i, n, r, o))), n[r + "_close"] = e => e.closeMark(t));
        } else {
...
function qa(e, {
  ...
  return n => {
    const r = new RegExp(`\\s${e}$`),
      i = t ? new RegExp(`${e}.*?(?=\\s${e}|$)`, "g") : new RegExp(`(?:^)?${e}[^\\s${e}]*`, "g"),
      o = n.before(),
      s = n.end(),
      l = n.doc.textBetween(o, s, "\0", "\0");
    let a;
    for (; a = i.exec(l);) {
      const e = a.input.slice(Math.max(0, a.index - 1), a.index);
      if (!/^[\s\0]?$/.test(e)) continue;
      const i = a.index + n.start();
      let o = i + a[0].length;
      if (t && r.test(l.slice(o - 1, o + 1)) && (a[0] += " ", o++), i < n.pos && o >= n.pos) return {
        range: {
          from: i,
          to: o
        },
...
function $a({
  matcher: e = qa("#"),
  suggestionClass: t = "ProseMirror-suggestion",
  onEnter: n = () => !1,
  onChange: r = () => !1,
  onExit: i = () => !1,
  onKeyDown: o = () => !1,
  ...
  return new mt({
    key: new kt("suggestions"),
    view() {
      return {
        update: (e, t) => {
          const o = this.key.getState(t),
            s = this.key.getState(e.state),
    ...
    props: {
      ...
      decorations(e) {
        ...
        return n ? ao.create(e.doc, [oo.inline(r.from, r.to, {
          nodeName: "span",
          class: t,
...
module.exports = __webpack_require__.p + "ai-chat-message.8ee0560f621c4829ad82.css";
...
/* harmony export */   AssistantMessageWithMarkdown: () => (/* binding */ AssistantMessageWithMarkdown),
...
const AssistantMessageWithMarkdown = Template.bind({});
...
class AIChatMessage extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  getUserMessage() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class=${"message-" + this.role}>
  ...
  render() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      <article>
        ${this.role === "user" ? this.getUserMessage() : this.getAssistantMessage()}
        ${this.role === "assistant" ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`${this.searchTokens.map(token => (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<ai-chat-search-button
                  .query=${token}
                  .label=${token}
                ></ai-chat-search-button>`)}` : null}
      </article>
    `;
  }
}
...
//# sourceMappingURL=components-ai-chat-message-ai-chat-message-stories.f721aab6.iframe.bundle.js.map