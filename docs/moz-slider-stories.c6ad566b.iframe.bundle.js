  ...
  ticksTemplate() {
    if (this.ticks > 0) {
      ...
      for (let i = 0; i < this.ticks; i++) {
        ...
        tickList.push((0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<option
            id=${optionId}
...
/* harmony export */ });
/* harmony import */ var _content_widgets_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11540);
/* harmony import */ var chrome_global_content_reader_moz_slider_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48298);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const Template = ({
  ...
  labelL10nId,
  sliderIcon
}) => (0,_content_widgets_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
  <moz-slider
    min=${min}
    max=${max}
    value=${value}
...
//# sourceMappingURL=moz-slider-stories.c6ad566b.iframe.bundle.js.map