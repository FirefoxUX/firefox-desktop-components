"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4262,8825,9896,4003],{
...
const Template = ({
  ...
  let toggleTemplate = _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`
    <moz-toggle
      ?pressed=${pressed}
      ?disabled=${disabled}
  ...
  `;
  return nestedFields ? _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`<moz-fieldset label="Toggle with nested fields"
...
//# sourceMappingURL=moz-toggle-moz-toggle-stories.68fb6761.iframe.bundle.js.map