...
/* harmony export */ });
/* harmony import */ var _panel_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94759);
  ...
  _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html`
    ...
    >
      ${items.map((item, index) => {
        ...
        return item == "<hr>"
          ? _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html` <hr /> `
          : _vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html`
              <panel-item
                icon=${item.icon ?? ""}
...
//# sourceMappingURL=panel-list-panel-list-stories.e19acf7e.iframe.bundle.js.map