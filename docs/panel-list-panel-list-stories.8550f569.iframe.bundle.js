"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[5118,5865,7752],{
...
const Template = ({
  ...
  return item == "<hr>" ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)` <hr /> ` : (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
            <panel-item
              icon=${(0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(item.icon)}
...
//# sourceMappingURL=panel-list-panel-list-stories.8550f569.iframe.bundle.js.map