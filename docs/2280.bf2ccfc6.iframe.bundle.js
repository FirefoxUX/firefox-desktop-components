"use strict";
(self["webpackChunkbrowser_storybook"] = self["webpackChunkbrowser_storybook"] || []).push([[2280],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n.card-container {\n  padding: 8px;\n  border-radius: 8px;\n  background-color: var(--fxview-background-color-secondary);\n  margin-block-end: 24px;\n  box-shadow: 0 2px 6px rgba(0, 0, 0, 0.15);\n}\n\n@media (prefers-contrast) {\n  .card-container {\n    border: 1px solid CanvasText;\n  }\n}\n\n.card-container-header {\n  display: inline-flex;\n  gap: 16px;\n  width: 100%;\n  align-items: center;\n  cursor: pointer;\n  border-radius: 1px;\n  outline-offset: 4px;\n  padding: 6px;\n  padding-inline-end: 0;\n}\n\n.card-container-header[withViewAll] {\n  width: 83%;\n}\n\n.card-container-header[hidden] {\n  display: none;\n}\n\n.view-all-link {\n  color: var(--fxview-primary-action-background);\n  float: inline-end;\n  outline-offset: 6px;\n  border-radius: 1px;\n  width: 12%;\n  text-align: end;\n  padding: 6px;\n  padding-inline-start: 0;\n}\n\n.card-container-header:focus-visible,\n.view-all-link:focus-visible {\n  outline: 2px solid var(--in-content-focus-outline-color);\n}\n\n.chevron-icon {\n  background-image: url(\"chrome://global/skin/icons/arrow-up.svg\");\n  padding: 2px;\n  display: inline-block;\n  justify-self: start;\n  fill: currentColor;\n  margin-block: 0;\n  width: 16px;\n  height: 16px;\n  background-position: center;\n  -moz-context-properties: fill;\n  border: none;\n  background-color: transparent;\n  background-repeat: no-repeat;\n  border-radius: 4px;\n}\n\n.chevron-icon:hover {\n  background-color: var(--fxview-element-background-hover);\n}\n\n@media (prefers-contrast) {\n  .chevron-icon {\n    border: 1px solid ButtonText;\n    color: ButtonText;\n  }\n\n  .chevron-icon:hover {\n    border: 1px solid SelectedItem;\n    color: SelectedItem;\n  }\n\n  .chevron-icon:active {\n    color: SelectedItem;\n  }\n\n  .chevron-icon,\n  .chevron-icon:hover,\n  .chevron-icon:active {\n    background-color: ButtonFace;\n  }\n}\n\n.card-container:not([open]) .chevron-icon {\n  background-image: url(\"chrome://global/skin/icons/arrow-down.svg\");\n}\n\n.card-container:not([open]) a {\n  display: none;\n}\n\n::slotted([slot=header]) {\n  margin: 0;\n  font-size: 1.13em;\n  font-weight: 600;\n  user-select: none;\n}\n\n.card-container-footer {\n  text-align: center;\n  color: var(--fxview-primary-action-background);\n  cursor: pointer;\n}\n\n::slotted([slot=footer]) {\n  text-decoration: underline;\n  padding-block: 0.5rem;\n}\n\n@media (max-width: 39rem) {\n  .card-container-header[withViewAll] {\n    width: 76%;\n  }\n  .view-all-link {\n    width: 20%;\n  }\n}\n\n.card-container.inner {\n  border: 1px solid var(--fxview-border);\n  box-shadow: none;\n  margin-block: 8px 0;\n}\n", "",{"version":3,"sources":["webpack://./../firefoxview/card-container.css"],"names":[],"mappings":"AAAA;;6DAE6D;;AAE7D;EACE,YAAY;EACZ,kBAAkB;EAClB,0DAA0D;EAC1D,sBAAsB;EACtB,yCAAyC;AAC3C;;AAEA;EACE;IACE,4BAA4B;EAC9B;AACF;;AAEA;EACE,oBAAoB;EACpB,SAAS;EACT,WAAW;EACX,mBAAmB;EACnB,eAAe;EACf,kBAAkB;EAClB,mBAAmB;EACnB,YAAY;EACZ,qBAAqB;AACvB;;AAEA;EACE,UAAU;AACZ;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,8CAA8C;EAC9C,iBAAiB;EACjB,mBAAmB;EACnB,kBAAkB;EAClB,UAAU;EACV,eAAe;EACf,YAAY;EACZ,uBAAuB;AACzB;;AAEA;;EAEE,wDAAwD;AAC1D;;AAEA;EACE,gEAAgE;EAChE,YAAY;EACZ,qBAAqB;EACrB,mBAAmB;EACnB,kBAAkB;EAClB,eAAe;EACf,WAAW;EACX,YAAY;EACZ,2BAA2B;EAC3B,6BAA6B;EAC7B,YAAY;EACZ,6BAA6B;EAC7B,4BAA4B;EAC5B,kBAAkB;AACpB;;AAEA;EACE,wDAAwD;AAC1D;;AAEA;EACE;IACE,4BAA4B;IAC5B,iBAAiB;EACnB;;EAEA;IACE,8BAA8B;IAC9B,mBAAmB;EACrB;;EAEA;IACE,mBAAmB;EACrB;;EAEA;;;IAGE,4BAA4B;EAC9B;AACF;;AAEA;EACE,kEAAkE;AACpE;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,SAAS;EACT,iBAAiB;EACjB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,8CAA8C;EAC9C,eAAe;AACjB;;AAEA;EACE,0BAA0B;EAC1B,qBAAqB;AACvB;;AAEA;EACE;IACE,UAAU;EACZ;EACA;IACE,UAAU;EACZ;AACF;;AAEA;EACE,sCAAsC;EACtC,gBAAgB;EAChB,mBAAmB;AACrB","sourcesContent":["/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n.card-container {\n  padding: 8px;\n  border-radius: 8px;\n  background-color: var(--fxview-background-color-secondary);\n  margin-block-end: 24px;\n  box-shadow: 0 2px 6px rgba(0, 0, 0, 0.15);\n}\n\n@media (prefers-contrast) {\n  .card-container {\n    border: 1px solid CanvasText;\n  }\n}\n\n.card-container-header {\n  display: inline-flex;\n  gap: 16px;\n  width: 100%;\n  align-items: center;\n  cursor: pointer;\n  border-radius: 1px;\n  outline-offset: 4px;\n  padding: 6px;\n  padding-inline-end: 0;\n}\n\n.card-container-header[withViewAll] {\n  width: 83%;\n}\n\n.card-container-header[hidden] {\n  display: none;\n}\n\n.view-all-link {\n  color: var(--fxview-primary-action-background);\n  float: inline-end;\n  outline-offset: 6px;\n  border-radius: 1px;\n  width: 12%;\n  text-align: end;\n  padding: 6px;\n  padding-inline-start: 0;\n}\n\n.card-container-header:focus-visible,\n.view-all-link:focus-visible {\n  outline: 2px solid var(--in-content-focus-outline-color);\n}\n\n.chevron-icon {\n  background-image: url(\"chrome://global/skin/icons/arrow-up.svg\");\n  padding: 2px;\n  display: inline-block;\n  justify-self: start;\n  fill: currentColor;\n  margin-block: 0;\n  width: 16px;\n  height: 16px;\n  background-position: center;\n  -moz-context-properties: fill;\n  border: none;\n  background-color: transparent;\n  background-repeat: no-repeat;\n  border-radius: 4px;\n}\n\n.chevron-icon:hover {\n  background-color: var(--fxview-element-background-hover);\n}\n\n@media (prefers-contrast) {\n  .chevron-icon {\n    border: 1px solid ButtonText;\n    color: ButtonText;\n  }\n\n  .chevron-icon:hover {\n    border: 1px solid SelectedItem;\n    color: SelectedItem;\n  }\n\n  .chevron-icon:active {\n    color: SelectedItem;\n  }\n\n  .chevron-icon,\n  .chevron-icon:hover,\n  .chevron-icon:active {\n    background-color: ButtonFace;\n  }\n}\n\n.card-container:not([open]) .chevron-icon {\n  background-image: url(\"chrome://global/skin/icons/arrow-down.svg\");\n}\n\n.card-container:not([open]) a {\n  display: none;\n}\n\n::slotted([slot=header]) {\n  margin: 0;\n  font-size: 1.13em;\n  font-weight: 600;\n  user-select: none;\n}\n\n.card-container-footer {\n  text-align: center;\n  color: var(--fxview-primary-action-background);\n  cursor: pointer;\n}\n\n::slotted([slot=footer]) {\n  text-decoration: underline;\n  padding-block: 0.5rem;\n}\n\n@media (max-width: 39rem) {\n  .card-container-header[withViewAll] {\n    width: 76%;\n  }\n  .view-all-link {\n    width: 20%;\n  }\n}\n\n.card-container.inner {\n  border: 1px solid var(--fxview-border);\n  box-shadow: none;\n  margin-block: 8px 0;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_card_container_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25283);
...
var update = _storybook_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_card_container_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_card_container_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
//# sourceMappingURL=2280.bf2ccfc6.iframe.bundle.js.map