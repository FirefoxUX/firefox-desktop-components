"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6463],{
...
class SettingGroup extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.MozLitElement {
  ...
  itemTemplate(item) {
    ...
    return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`<setting-control
      .setting=${setting}
      .config=${item}
    ></setting-control>`;
  }
  ...
  render() {
    ...
    if (window.IS_STORYBOOK || Services.prefs.getBoolPref("settings.revamp.design", false)) {
      return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`<moz-fieldset data-l10n-id=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.ifDefined)(this.config.l10nId)}
...
/* harmony export */ });
/* harmony import */ var chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45717);
/* harmony import */ var chrome_browser_content_preferences_widgets_setting_group_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13599);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
//# sourceMappingURL=setting-group-setting-group-stories.2c23f497.iframe.bundle.js.map