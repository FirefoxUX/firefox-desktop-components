...
module.exports = __webpack_require__.p + "ai-website-chip.f3d12a9e4dd38c529fab.css";
...
module.exports = __webpack_require__.p + "applied-memories-button.7be0b72f1d6c4e836dcf.css";
...
module.exports = __webpack_require__.p + "moz-box-item.0b29da91171a9c88d76f.css";
  ...
  #renderToolUI(toolUIData, messageId) {
    ...
    switch (toolUIData.uiType) {
      ...
      case "ai-action-result":
        return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div>confirmation placeholder</div>`;
      case "cancelled-component":
        return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div>cancelled placeholder</div>`;
      default:
        return chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing;
    }
  }
  ...
  #renderMessage(msg, chips) {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <div class=${`chat-bubble chat-bubble-${msg.role}`}>
        ...
        ></ai-chat-message>
        ${msg.role === "assistant" && msg.toolUIData ? this.#renderToolUI(msg.toolUIData, msg.messageId) : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
...
module.exports = __webpack_require__.p + "assistant-message-footer.99496ff76a7d25bfcf86.css";
...
module.exports = __webpack_require__.p + "ai-chat-content.b4ea2ab5548843e1170b.css";
...
class MozBoxItem extends _lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozBoxBase {
  ...
  handleKeydown(event) {
    ...
    let target = isHandleEvent ? this.handleEl : this.#actionEls.find(el => el.contains(event.target));
    if (!target) {
      return;
    }
...
//# sourceMappingURL=components-ai-chat-content-ai-chat-content-stories.82ad2124.iframe.bundle.js.map