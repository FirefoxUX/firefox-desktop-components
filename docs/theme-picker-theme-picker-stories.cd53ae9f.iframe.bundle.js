...
const RESPONSE_EVENTS = ["ThemePickerInitialState", "ThemePickerThemeUpdated", "ThemePickerAppearanceUpdated", "ThemePickerNativeThemeUpdated", "ThemePickerDeviceAppearanceUpdated"];
...
class ThemePickerRemoteController {
  ...
  constructor(host) {
    ...
    window.addEventListener("ThemePickerDeviceAppearanceUpdated", this.deviceAppearanceHandler);
  }
  hostDisconnected() {
    window.removeEventListener("ThemePickerDeviceAppearanceUpdated", this.deviceAppearanceHandler);
  }
...
//# sourceMappingURL=theme-picker-theme-picker-stories.cd53ae9f.iframe.bundle.js.map