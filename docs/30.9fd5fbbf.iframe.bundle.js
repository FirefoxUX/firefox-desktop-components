"use strict";
(self["webpackChunkbrowser_storybook"] = self["webpackChunkbrowser_storybook"] || []).push([[30],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n:host {\n  --fxviewcategorynav-button-padding: 8px;\n  margin-inline-start: 42px;\n  border-inline-end: 1px solid transparent;\n  position: sticky;\n  top: 0;\n  height: 100vh;\n}\n\nnav {\n  display: grid;\n  grid-template-rows: min-content 1fr auto;\n  gap: 25px;\n  margin-block-start: var(--fxview-margin-top);\n}\n\n.category-nav-header {\n  /* Align the header text/icon with the category button icons */\n  margin-inline-start: var(--fxviewcategorynav-button-padding);\n}\n\n::slotted(h2) {\n  font-size: 1.6em;\n  margin: 0;\n}\n\n.category-nav-buttons,\n::slotted(.category-nav-footer) {\n  display: grid;\n  grid-template-columns: 1fr;\n  grid-auto-rows: min-content;\n  gap: 4px;\n}\n\n@media (prefers-contrast) {\n  .category-nav-buttons {\n    gap: 8px;\n  }\n}\n\n@media (prefers-reduced-motion) {\n  /* Setting border-inline-end to add clear differentiation between side navigation and main content area */\n  :host {\n    border-inline-end-color: var(--in-content-border-color);\n  }\n}\n\n@media (max-width: 52rem) {\n  :host {\n    grid-template-rows: 1fr auto;\n  }\n\n  .category-nav-header {\n    display: none;\n  }\n\n  .category-nav-buttons,\n  ::slotted(.category-nav-footer) {\n    justify-content: center;\n    grid-template-columns: min-content;\n  }\n}\n", "",{"version":3,"sources":["webpack://./../firefoxview/fxview-category-navigation.css"],"names":[],"mappings":"AAAA;;6DAE6D;;AAE7D;EACE,uCAAuC;EACvC,yBAAyB;EACzB,wCAAwC;EACxC,gBAAgB;EAChB,MAAM;EACN,aAAa;AACf;;AAEA;EACE,aAAa;EACb,wCAAwC;EACxC,SAAS;EACT,4CAA4C;AAC9C;;AAEA;EACE,8DAA8D;EAC9D,4DAA4D;AAC9D;;AAEA;EACE,gBAAgB;EAChB,SAAS;AACX;;AAEA;;EAEE,aAAa;EACb,0BAA0B;EAC1B,2BAA2B;EAC3B,QAAQ;AACV;;AAEA;EACE;IACE,QAAQ;EACV;AACF;;AAEA;EACE,yGAAyG;EACzG;IACE,uDAAuD;EACzD;AACF;;AAEA;EACE;IACE,4BAA4B;EAC9B;;EAEA;IACE,aAAa;EACf;;EAEA;;IAEE,uBAAuB;IACvB,kCAAkC;EACpC;AACF","sourcesContent":["/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n:host {\n  --fxviewcategorynav-button-padding: 8px;\n  margin-inline-start: 42px;\n  border-inline-end: 1px solid transparent;\n  position: sticky;\n  top: 0;\n  height: 100vh;\n}\n\nnav {\n  display: grid;\n  grid-template-rows: min-content 1fr auto;\n  gap: 25px;\n  margin-block-start: var(--fxview-margin-top);\n}\n\n.category-nav-header {\n  /* Align the header text/icon with the category button icons */\n  margin-inline-start: var(--fxviewcategorynav-button-padding);\n}\n\n::slotted(h2) {\n  font-size: 1.6em;\n  margin: 0;\n}\n\n.category-nav-buttons,\n::slotted(.category-nav-footer) {\n  display: grid;\n  grid-template-columns: 1fr;\n  grid-auto-rows: min-content;\n  gap: 4px;\n}\n\n@media (prefers-contrast) {\n  .category-nav-buttons {\n    gap: 8px;\n  }\n}\n\n@media (prefers-reduced-motion) {\n  /* Setting border-inline-end to add clear differentiation between side navigation and main content area */\n  :host {\n    border-inline-end-color: var(--in-content-border-color);\n  }\n}\n\n@media (max-width: 52rem) {\n  :host {\n    grid-template-rows: 1fr auto;\n  }\n\n  .category-nav-header {\n    display: none;\n  }\n\n  .category-nav-buttons,\n  ::slotted(.category-nav-footer) {\n    justify-content: center;\n    grid-template-columns: min-content;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_fxview_category_navigation_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77224);
...
var update = _storybook_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_fxview_category_navigation_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_storybook_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_8_use_1_fxview_category_navigation_css__WEBPACK_IMPORTED_MODULE_1__["default"].locals || {});
...
//# sourceMappingURL=30.9fd5fbbf.iframe.bundle.js.map