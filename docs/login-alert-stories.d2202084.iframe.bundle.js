...
/* harmony import */ var _login_alert_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(69599);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const VulnerablePasswordAlert = ({ hostname }) =>
...
const LoginBreachAlert = ({ date, hostname }) =>
  lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html`
    <login-breach-alert
      .date=${date}
      .hostname=${hostname}
...
//# sourceMappingURL=login-alert-stories.d2202084.iframe.bundle.js.map