  ...
  >
    ${options.map((option, i) => (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`
        <moz-segmented-control-item
          data-l10n-id=${iconsOnly ? `control-option${i + 1}-icon-only` : `control-option${i + 1}`}
...
module.exports = __webpack_require__.p + "moz-segmented-control.2162c7a97bfcb60be19e.css";
...
//# sourceMappingURL=moz-segmented-control-moz-segmented-control-stories.f11a763b.iframe.bundle.js.map