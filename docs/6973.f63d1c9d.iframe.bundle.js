...
class ThemePickerDirectController {
  ...
  hostConnected() {
    this.themesManagerPromise ??= lazy.getThemesList({
  ...
  updateHost = () => {
    ...
    this.host.deviceAppearance = Services.appinfo.contentThemeDerivedColorSchemeIsDark ? "dark" : "light";
  };
}
...
//# sourceMappingURL=6973.f63d1c9d.iframe.bundle.js.map