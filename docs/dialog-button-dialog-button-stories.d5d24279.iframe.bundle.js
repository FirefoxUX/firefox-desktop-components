"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[6284,8278,9240,9417],{
...
/* harmony import */ var chrome_global_content_elements_moz_button_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79240);
...
/* harmony import */ var chrome_browser_content_preferences_widgets_dialog_button_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(20256);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
window.gSubDialog = {
  open(dialogId = "dialog-id") {
    const dialog = document.querySelector("with-common-styles").shadowRoot.getElementById(dialogId);
    if (!dialog) {
...
//# sourceMappingURL=dialog-button-dialog-button-stories.d5d24279.iframe.bundle.js.map