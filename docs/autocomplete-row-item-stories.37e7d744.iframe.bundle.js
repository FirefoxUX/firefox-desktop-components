  ...
  renderSecondaryActionButton() {
    ...
    if (action) {
      return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<moz-button
        ...
        title=${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.ifDefined)(label)}
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      <div @click=${this.actions?.primary} class="row-item">
        ...
        <div class="labels-container">
          ...
          ${this.type == "smartFormFill" ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
...
module.exports = __webpack_require__.p + "autocomplete-row-item.8db52a364af8690b1df9.css";

/***/ })

}]);
//# sourceMappingURL=autocomplete-row-item-stories.37e7d744.iframe.bundle.js.map