"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2017,6284,9240,9417],{
...
function convertTimestamp(timestamp, fluentStrings, _nowThresholdMs = NOW_THRESHOLD_MS) {
  if (!timestamp) {
  ...
  if (elapsed <= _nowThresholdMs) {
    ...
    formattedTime = fluentStrings.formatValueSync("firefoxview-just-now-timestamp");
  } else {
...
function getLogger(loggerName) {
  if (!loggersByName.has(loggerName)) {
    ...
    logger.addAppender(new lazy.Log.ConsoleAppender(new lazy.Log.BasicFormatter()));
...
/* harmony import */ var _search_helpers_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(42159);
/* harmony import */ var _helpers_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24734);
...
class FxviewTabListBase extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  emptySearchResultsTemplate() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)` <fxview-empty-state
      ...
      .headerArgs=${{
      query: (0,_helpers_mjs__WEBPACK_IMPORTED_MODULE_5__.escapeHtmlEntities)(this.searchQuery)
    }}
      isInnerCard
    >
    </fxview-empty-state>`;
...
class VirtualList extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  constructor() {
    ...
    this.maxRenderCountEstimate = this.itemHeightEstimate > 0 ? Math.max(40, 2 * Math.ceil(window.innerHeight / this.itemHeightEstimate)) : 0;
    ...
    this.childResizeObserver = new ResizeObserver(([entry]) => {
      ...
      if (entry.contentRect?.height > 0 && itemCount > 0 && !this.getItemHeight) {
        ...
        this.parentElement.itemHeightEstimate = entry.contentRect.height / itemCount;
      }
    });
  }
  connectedCallback() {
  ...
  #syncSublistVisibility() {
    ...
    for (const child of this.children) {
      ...
      const inView = childBottom > -buffer && childTop < window.innerHeight + buffer;
  ...
  willUpdate(changedProperties) {
    if (this.isSubList && changedProperties.has("isVisible") && changedProperties.get("isVisible") === true && !this.isVisible) {
    ...
    if (this.isSubList && (changedProperties.has("items") || changedProperties.has("getItemHeight"))) {
  ...
  updateListHeight(changedProperties) {
    if (changedProperties.has("isAlwaysVisible") || changedProperties.has("isVisible") || changedProperties.has("itemHeightEstimate") || changedProperties.has("getItemHeight") || changedProperties.has("items")) {
      this.style.height = this.isAlwaysVisible || this.isVisible ? "auto" : `${this._knownHeight ?? this.#getPlaceholderHeight()}px`;
    }
  }
  #getPlaceholderHeight() {
    if (this.getItemHeight) {
      return this.items.reduce((sum, item) => sum + this.getItemHeight(item, this.itemHeightEstimate), 0);
    }
...
/* harmony import */ var browser_components_firefoxview_fxview_tab_list_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27317);
var _templateObject;
...
module.exports = __webpack_require__.p + "fxview-tab-row.f51841d031efb6c56c13.css";

/***/ })

}]);
//# sourceMappingURL=fxview-tab-list-stories.576eecf9.iframe.bundle.js.map