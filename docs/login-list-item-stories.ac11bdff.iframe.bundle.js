...
/* harmony import */ var _login_list_lit_item_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(69255);
...
const NewLoginListItem = ({ selected }) => {
  return lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html` <new-list-item .selected=${selected}> </new-list-item> `;
};
...
/* harmony export */ });
/* harmony import */ var browser_components_aboutlogins_content_components_login_list_lit_item_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13424);
      ...
      >
        <div class="labels" slot="login-info">
          ...
          ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.when)(
            this.username,
            () => chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html` <span class="subtitle" dir="auto">
              ${this.username}
            </span>`,
            () => chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html`<span
              class="subtitle"
              dir="auto"
          ...
          ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.choose)(
            ...
            [
              [
                "breached",
                () =>
                  chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html`<img
                    class="alert-icon"
            ...
            () => chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html`<img class="alert-icon" title="" src="" />`
          )}
        </div>
      </list-item>
    `;
...
//# sourceMappingURL=login-list-item-stories.ac11bdff.iframe.bundle.js.map