...
module.exports = __webpack_require__.p + "website-chip-container.ddfeac2d4b85dc527a9a.css";
...
module.exports = __webpack_require__.p + "moz-select.dbbadb41f6a8614deeed.css";
...
module.exports = __webpack_require__.p + "chat-assistant-citations.7ed8e0eb06d068c664d7.css";
...
module.exports = __webpack_require__.p + "ai-chat-content.fa1d8ec9ba579b70010d.css";
...
/* harmony import */ var chrome_browser_content_aiwindow_components_smartwindow_panel_list_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(55362);
 ...
 */
class ChatAssistantCitations extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  static properties = {
    citations: {
      type: Array,
      attribute: false
  ...
  #renderPill(citation, {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<ai-website-chip
      type="context-chip"
      size="small"
      role=${itemRole ? "presentation" : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
      .itemRole=${itemRole ?? ""}
      title=${showTitle ? this.#titleText(citation) : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
  ...
  render() {
    ...
    const visibleCount = this.citations.length > this.maxVisible ? this.maxVisible - 1 : this.maxVisible;
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      <div class="citations" role="list">
        ${citationsVisible.map(citation => (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<span role="listitem"
              >${this.#renderPill(citation, {
      showTitle: true
    })}</span
            >`)}
        ${citationsOverflow.length ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
              <moz-button
                type="ghost"
                .ariaHasPopup=${"menu"}
      ...
      count: citationsOverflow.length
              ...
              >
                ${(0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.repeat)(citationsOverflow, citation => citation.url, citation => this.#renderPill(citation, {
      itemRole: "menuitem"
    }))}
              </smartwindow-panel-list>
            ` : chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.nothing}
...
//# sourceMappingURL=components-ai-chat-content-ai-chat-content-stories.3c69be0b.iframe.bundle.js.map