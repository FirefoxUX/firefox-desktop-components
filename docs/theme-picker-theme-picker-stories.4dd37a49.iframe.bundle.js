...
const WINDOW_EVENTS = ["ThemePickerThemeUpdated", "ThemePickerAppearanceUpdated", "ThemePickerNativeThemeUpdated", "ThemePickerDeviceAppearanceUpdated"];
...
class ThemePickerRemoteController {
  ...
  constructor(host) {
    ...
    this.host.addEventListener("themepickershown", () => this.onThemePickerShown());
  ...
  onThemePickerShown() {
    this.dispatchActorEvent("ThemePickerShown", {
      source: this.installSource || this.host.getAttribute("installsource") || "unknown",
...
module.exports = __webpack_require__.p + "theme-picker.3da3f72bc086886b8b0e.css";
...
/* harmony import */ var chrome_global_content_elements_theme_picker_remote_controller_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(64530);
...
function getThemePickerController() {
  if (window.IS_STORYBOOK) {
    return chrome_global_content_elements_theme_picker_storybook_controller_mjs__WEBPACK_IMPORTED_MODULE_3__.ThemePickerStorybookController;
  }
  if (typeof ChromeUtils !== "undefined") {
    if (!ThemePickerDirectControllerClass) {
      ThemePickerDirectControllerClass = ChromeUtils.importESModule("chrome://global/content/elements/theme-picker-direct-controller.mjs", {
        global: "current"
      }).ThemePickerDirectController;
    }
    return ThemePickerDirectControllerClass;
  }
  return chrome_global_content_elements_theme_picker_remote_controller_mjs__WEBPACK_IMPORTED_MODULE_4__.ThemePickerRemoteController;
}
const DEFAULT_THEME_ID = "default-theme@mozilla.org";
...
class ThemePicker extends _lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  shown() {
    this.dispatchEvent(new CustomEvent("themepickershown", {
      bubbles: true,
      composed: true
    }));
  }
   ...
   */
  themeStyle(theme) {
    let effectiveAppearance = this.appearance === "device" ? this.deviceAppearance : this.appearance;
    let colors = effectiveAppearance === "dark" ? theme.themePickerColors.dark : theme.themePickerColors.light;
...
//# sourceMappingURL=theme-picker-theme-picker-stories.4dd37a49.iframe.bundle.js.map