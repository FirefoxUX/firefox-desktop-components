"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4469,6284,6296,9240,9417],{

/***/ 3952:
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "turn-on-scheduled-backups.29de146e1b2e26b33855.css";
...
class BackupSettings extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  restoreFromBackupTemplate() {
    let restoreL10nID = this.backupServiceState.scheduledBackupsEnabled ? "settings-data-backup-restore-scheduled-on" : "settings-data-backup-restore-scheduled-off";
  ...
  handleShowRestoreDialog() {
    if (this.restoreFromBackupDialogEl) {
      this.dispatchEvent(new CustomEvent("BackupUI:PrepareRestoreDialog", {
        bubbles: true,
        composed: true,
        detail: {
          source: "preferences"
  ...
  render() {
    ...
    let scheduledBackupsEnabledL10nID = scheduledBackupsEnabledState ? "settings-data-backup-scheduled-backups-on2" : "settings-data-backup-scheduled-backups-off2";
    let backupToggleL10nID = scheduledBackupsEnabledState ? "settings-data-backup-toggle-off2" : "settings-data-backup-toggle-on2";
    let scheduledBackupsIcon = scheduledBackupsEnabledState ? "chrome://global/skin/icons/check-filled.svg" : "chrome://global/skin/icons/warning.svg";
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`<link
      ...
      <moz-box-group>
        ${this.backupServiceState.archiveEnabledStatus ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`<moz-box-item
      ...
      ${this.backupServiceState.archiveEnabledStatus && this.backupServiceState.scheduledBackupsEnabled ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_2__.html)`${this.backupLocationTemplate()}${this.sensitiveDataTemplate()}` : null}`;
  }
}
...
const ENABLE_ERROR_L10N_IDS = Object.freeze({
  ...
  [chrome_browser_content_backup_backup_constants_mjs__WEBPACK_IMPORTED_MODULE_5__.ERRORS.DEFAULT_DIR_ACCESS_DENIED]: "turn-on-scheduled-backups-error-default-dir-denied",
...
class TurnOnScheduledBackups extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  get showDefaultFilePath() {
    return !this._newPath && !this.backupServiceState?.embeddedComponentPersistentData?.path;
  }
  connectedCallback() {
    super.connectedCallback();
    this.dispatchEvent(new CustomEvent("BackupUI:InitWidget", {
  ...
  handleEvent(event) {
    if (event.type == "BackupUI:SelectNewFilepickerPath") {
      ...
      if (this.enableBackupErrorCode == chrome_browser_content_backup_backup_constants_mjs__WEBPACK_IMPORTED_MODULE_5__.ERRORS.DEFAULT_DIR_ACCESS_DENIED) {
      ...
      if (readAccessGranted) {
        ...
        this.defaultPath = "";
        this.defaultIconURL = "";
        this.enableBackupErrorCode = chrome_browser_content_backup_backup_constants_mjs__WEBPACK_IMPORTED_MODULE_5__.ERRORS.DEFAULT_DIR_ACCESS_DENIED;
      }
      this._pendingConfirmDetail = null;
  ...
  handleConfirm() {
    ...
    if (this.embeddedFxBackupOptIn && this.backupIsEncrypted && !detail.password) {
    ...
    this.dispatchEvent(new CustomEvent("BackupUI:ProbeDefaultBackupDir", {
      bubbles: true,
      composed: true
    }));
  }
  ...
  defaultFilePathInputTemplate() {
    ...
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <input
        ...
        type="text"
        readonly
        data-l10n-id=${hasFilename ? "turn-on-scheduled-backups-location-default-folder" : "turn-on-scheduled-backups-location-choose-folder"}
  ...
  allOptionsTemplate() {
    let locationInputId = this.showDefaultFilePath ? "backup-location-filepicker-input-default" : "backup-location-filepicker-input-custom";
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      <fieldset id="all-controls">
        <div id="backup-location-controls">
          ...
          <div id="backup-location-filepicker">
            ${this.showDefaultFilePath ? this.defaultFilePathInputTemplate() : this.customFilePathInputTemplate()}
            <moz-button
...
module.exports = __webpack_require__.p + "preferences.bd9a3c5a95e01951a4c7.css";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BACKUP_STEPS: () => (/* binding */ BACKUP_STEPS),
/* harmony export */   ERRORS: () => (/* binding */ ERRORS),
/* harmony export */   RESTORE_STEPS: () => (/* binding */ RESTORE_STEPS),
 ...
 * telemetry.
 */
const BACKUP_STEPS = Object.freeze({
  /**
...
module.exports = __webpack_require__.p + "password-rules-tooltip.996056dd27934bb5b6c2.css";
...
module.exports = __webpack_require__.p + "password-validation-inputs.a98838155f216e76cb6d.css";
...
module.exports = __webpack_require__.p + "moz-message-bar.2ad71b1a8dec101b8bb1.css";
...
module.exports = __webpack_require__.p + "backup-settings.69bc0a9a5e0344802698.css";
...
//# sourceMappingURL=backup-settings-stories.fc7a5041.iframe.bundle.js.map