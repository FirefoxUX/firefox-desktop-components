...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n@namespace html url(\"http://www.w3.org/1999/xhtml\");\n\n#sidebar-box {\n  --sidebar-background-color: Field;\n  --sidebar-text-color: FieldText;\n  background-color: var(--sidebar-background-color);\n  color: var(--sidebar-text-color);\n  text-shadow: none;\n}\n\n#sidebar-header {\n  font-size: 1.333em;\n  padding: 8px;\n  border-bottom: 1px solid var(--sidebar-border-color);\n}\n\n#sidebar-spacer {\n  /* To ensure the button doesn't expand unnecessarily for short labels, the\n     spacer should significantly out-flex the button. */\n  -moz-box-flex: 1000;\n}\n\n#sidebar {\n  -moz-box-flex: 1;\n}\n\n@media not (-moz-platform: linux) {\n  /* We don't let the splitter overlap the sidebar on Linux since the sidebar's\n  scrollbar is too narrow on Linux. */\n  .sidebar-splitter {\n    appearance: none;\n    border: 0 solid;\n    border-inline-end-width: 1px;\n    border-color: var(--sidebar-border-color);\n    min-width: 1px;\n    width: 4px;\n    background-image: none !important;\n    background-color: transparent;\n    margin-inline-start: -4px;\n    position: relative;\n  }\n\n  #sidebar-box[positionend] + .sidebar-splitter {\n    border-inline-width: 1px 0;\n    margin-inline: 0 -4px;\n  }\n}\n\n#sidebar-throbber[loading=\"true\"] {\n  list-style-image: url(\"chrome://global/skin/icons/loading.png\");\n}\n\n@media (min-resolution: 2dppx) {\n  #sidebar-throbber[loading=\"true\"] {\n    list-style-image: url(\"chrome://global/skin/icons/loading@2x.png\");\n    width: 16px;\n  }\n}\n\n#sidebar-title {\n  margin: 0;\n  padding: 0;\n  padding-inline: 8px 4px;\n  -moz-box-flex: 1;\n}\n\n#sidebar-switcher-arrow {\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n\n#sidebar-switcher-arrow {\n  list-style-image: url(chrome://global/skin/icons/arrow-down-12.svg);\n  width: 12px;\n  height: 12px;\n}\n\n#sidebar-switcher-target {\n  appearance: none;\n  color: inherit;\n  margin-inline-end: 4px;\n  border-radius: var(--toolbarbutton-border-radius);\n  border: 1px solid transparent;\n  padding: 2px 4px;\n  -moz-box-flex: 1;\n}\n\n#sidebar-switcher-target:hover {\n  background-color: var(--toolbarbutton-hover-background);\n}\n\n#sidebar-switcher-target:hover:active,\n#sidebar-switcher-target.active {\n  background-color: var(--toolbarbutton-active-background);\n}\n\n#sidebar-switcher-target:focus-visible,\n#sidebar-close:focus-visible {\n  outline: var(--focus-outline);\n  outline-offset: 0;\n}\n\n#sidebarMenu-popup .subviewbutton {\n  min-width: 190px;\n}\n\ntoolbarseparator + #sidebar-extensions-separator {\n  display: none;\n}\n\n#sidebar-box[sidebarcommand=\"viewBookmarksSidebar\"] > #sidebar-header > #sidebar-switcher-target > #sidebar-icon {\n  list-style-image: url(chrome://browser/skin/bookmark.svg);\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n\n#sidebar-box[sidebarcommand=\"viewHistorySidebar\"] > #sidebar-header > #sidebar-switcher-target > #sidebar-icon {\n  list-style-image: url(chrome://browser/skin/history.svg);\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n\n#sidebar-box[sidebarcommand=\"viewTabsSidebar\"] > #sidebar-header > #sidebar-switcher-target > #sidebar-icon {\n  list-style-image: url(chrome://browser/skin/synced-tabs.svg);\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n", "",{"version":3,"sources":["webpack://./../../themes/shared/sidebar.css"],"names":[],"mappings":"AAAA;;6DAE6D;;AAE7D,mDAAmD;;AAEnD;EACE,iCAAiC;EACjC,+BAA+B;EAC/B,iDAAiD;EACjD,gCAAgC;EAChC,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,oDAAoD;AACtD;;AAEA;EACE;uDACqD;EACrD,mBAAmB;AACrB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE;qCACmC;EACnC;IACE,gBAAgB;IAChB,eAAe;IACf,4BAA4B;IAC5B,yCAAyC;IACzC,cAAc;IACd,UAAU;IACV,iCAAiC;IACjC,6BAA6B;IAC7B,yBAAyB;IACzB,kBAAkB;EACpB;;EAEA;IACE,0BAA0B;IAC1B,qBAAqB;EACvB;AACF;;AAEA;EACE,+DAA+D;AACjE;;AAEA;EACE;IACE,kEAAkE;IAClE,WAAW;EACb;AACF;;AAEA;EACE,SAAS;EACT,UAAU;EACV,uBAAuB;EACvB,gBAAgB;AAClB;;AAEA;EACE,6BAA6B;EAC7B,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,mEAAmE;EACnE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,cAAc;EACd,sBAAsB;EACtB,iDAAiD;EACjD,6BAA6B;EAC7B,gBAAgB;EAChB,gBAAgB;AAClB;;AAEA;EACE,uDAAuD;AACzD;;AAEA;;EAEE,wDAAwD;AAC1D;;AAEA;;EAEE,6BAA6B;EAC7B,iBAAiB;AACnB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,yDAAyD;EACzD,6BAA6B;EAC7B,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,wDAAwD;EACxD,6BAA6B;EAC7B,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,4DAA4D;EAC5D,6BAA6B;EAC7B,kBAAkB;EAClB,YAAY;AACd","sourcesContent":["/* This Source Code Form is subject to the terms of the Mozilla Public\n * License, v. 2.0. If a copy of the MPL was not distributed with this\n * file, You can obtain one at http://mozilla.org/MPL/2.0/. */\n\n@namespace html url(\"http://www.w3.org/1999/xhtml\");\n\n#sidebar-box {\n  --sidebar-background-color: Field;\n  --sidebar-text-color: FieldText;\n  background-color: var(--sidebar-background-color);\n  color: var(--sidebar-text-color);\n  text-shadow: none;\n}\n\n#sidebar-header {\n  font-size: 1.333em;\n  padding: 8px;\n  border-bottom: 1px solid var(--sidebar-border-color);\n}\n\n#sidebar-spacer {\n  /* To ensure the button doesn't expand unnecessarily for short labels, the\n     spacer should significantly out-flex the button. */\n  -moz-box-flex: 1000;\n}\n\n#sidebar {\n  -moz-box-flex: 1;\n}\n\n@media not (-moz-platform: linux) {\n  /* We don't let the splitter overlap the sidebar on Linux since the sidebar's\n  scrollbar is too narrow on Linux. */\n  .sidebar-splitter {\n    appearance: none;\n    border: 0 solid;\n    border-inline-end-width: 1px;\n    border-color: var(--sidebar-border-color);\n    min-width: 1px;\n    width: 4px;\n    background-image: none !important;\n    background-color: transparent;\n    margin-inline-start: -4px;\n    position: relative;\n  }\n\n  #sidebar-box[positionend] + .sidebar-splitter {\n    border-inline-width: 1px 0;\n    margin-inline: 0 -4px;\n  }\n}\n\n#sidebar-throbber[loading=\"true\"] {\n  list-style-image: url(\"chrome://global/skin/icons/loading.png\");\n}\n\n@media (min-resolution: 2dppx) {\n  #sidebar-throbber[loading=\"true\"] {\n    list-style-image: url(\"chrome://global/skin/icons/loading@2x.png\");\n    width: 16px;\n  }\n}\n\n#sidebar-title {\n  margin: 0;\n  padding: 0;\n  padding-inline: 8px 4px;\n  -moz-box-flex: 1;\n}\n\n#sidebar-switcher-arrow {\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n\n#sidebar-switcher-arrow {\n  list-style-image: url(chrome://global/skin/icons/arrow-down-12.svg);\n  width: 12px;\n  height: 12px;\n}\n\n#sidebar-switcher-target {\n  appearance: none;\n  color: inherit;\n  margin-inline-end: 4px;\n  border-radius: var(--toolbarbutton-border-radius);\n  border: 1px solid transparent;\n  padding: 2px 4px;\n  -moz-box-flex: 1;\n}\n\n#sidebar-switcher-target:hover {\n  background-color: var(--toolbarbutton-hover-background);\n}\n\n#sidebar-switcher-target:hover:active,\n#sidebar-switcher-target.active {\n  background-color: var(--toolbarbutton-active-background);\n}\n\n#sidebar-switcher-target:focus-visible,\n#sidebar-close:focus-visible {\n  outline: var(--focus-outline);\n  outline-offset: 0;\n}\n\n#sidebarMenu-popup .subviewbutton {\n  min-width: 190px;\n}\n\ntoolbarseparator + #sidebar-extensions-separator {\n  display: none;\n}\n\n#sidebar-box[sidebarcommand=\"viewBookmarksSidebar\"] > #sidebar-header > #sidebar-switcher-target > #sidebar-icon {\n  list-style-image: url(chrome://browser/skin/bookmark.svg);\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n\n#sidebar-box[sidebarcommand=\"viewHistorySidebar\"] > #sidebar-header > #sidebar-switcher-target > #sidebar-icon {\n  list-style-image: url(chrome://browser/skin/history.svg);\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n\n#sidebar-box[sidebarcommand=\"viewTabsSidebar\"] > #sidebar-header > #sidebar-switcher-target > #sidebar-icon {\n  list-style-image: url(chrome://browser/skin/synced-tabs.svg);\n  -moz-context-properties: fill;\n  fill: currentColor;\n  opacity: 0.8;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=836.b7763fba.iframe.bundle.js.map