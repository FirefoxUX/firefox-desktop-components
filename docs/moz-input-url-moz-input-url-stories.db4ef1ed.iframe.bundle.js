"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4178,4920,5944],{
...
/* harmony import */ var _moz_input_url_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(24920);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  argTypes: {
    l10nId: {
      options: ["moz-input-url-label", "moz-input-url-placeholder", "moz-input-url-description", "moz-input-url-label-wrapped"],
      control: {
        type: "select"
      }
    }
...
//# sourceMappingURL=moz-input-url-moz-input-url-stories.db4ef1ed.iframe.bundle.js.map