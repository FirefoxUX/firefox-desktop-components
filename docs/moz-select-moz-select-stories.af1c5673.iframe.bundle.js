...
module.exports = __webpack_require__.p + "moz-select.a2277a83388ef1d28183.css";
...
/* harmony export */   WithAriaLabel: () => (/* binding */ WithAriaLabel),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  argTypes: {
    l10nId: {
      options: ["moz-select-label", "moz-select-description", "moz-select-long-label", "moz-select-aria-label"],
      control: {
        type: "select"
      }
    },
...
const Template = ({
  ...
  "text-truncated-ellipsis": ellipsized
    ...
    >
      ...
      ${options.map((opt, i) => (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`${i == 2 && withSeparator ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<hr />` : ""}
            <moz-option
              value=${opt.value}
...
const WithAriaLabel = Template.bind({});
WithAriaLabel.args = {
  ...Default.args,
...
//# sourceMappingURL=moz-select-moz-select-stories.af1c5673.iframe.bundle.js.map