...
class MultilineEditor extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.MozLitElement {
  ...
  updated(changedProps) {
    if (changedProps.has("placeholder") || changedProps.has("placeholderHints") || changedProps.has("plugins") || changedProps.has("readOnly") || MultilineEditor.FORWARDED_ARIA.some(({
      prop
...
//# sourceMappingURL=multiline-editor-stories.ff9c4a72.iframe.bundle.js.map