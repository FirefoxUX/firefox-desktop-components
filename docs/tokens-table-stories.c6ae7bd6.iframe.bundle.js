...
const THEMED_TABLES = ["attention-dot", "background-color", "border", "box-shadow", "border-color", "opacity", "text-color", "color", "outline", "icon-color", "icon-fill", "icon-stroke", "link"];
...
module.exports = __webpack_require__.p + "tokens-table.fe454720fd8304d2587e.css";

/***/ })

}]);
//# sourceMappingURL=tokens-table-stories.c6ae7bd6.iframe.bundle.js.map