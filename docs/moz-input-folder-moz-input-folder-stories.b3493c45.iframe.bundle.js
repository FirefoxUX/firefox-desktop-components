"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3654,3732,5944],{
...
/* harmony export */   WithAdditionalActions: () => (/* binding */ WithAdditionalActions),
...
/* harmony import */ var _moz_input_folder_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13654);
/* This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
...
const Template = ({
  ...
  "text-truncated-ellipsis": ellipsized
    ...
    >
      ...
      ${hasAdditionalAction ? (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-button
            slot="actions"
...
const WithAdditionalActions = Template.bind({});
...
//# sourceMappingURL=moz-input-folder-moz-input-folder-stories.b3493c45.iframe.bundle.js.map