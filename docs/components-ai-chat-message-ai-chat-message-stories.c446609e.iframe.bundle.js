"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[2524,8591],{
...
var is,
  ...
  fs = new Uint16Array("Ȁaglq\tɭ\0\0p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map(t => t.charCodeAt(0)));
...
for (const [element, {
  element: wrapper
}] of Object.entries(CHAT_WRAPPER_ELEMENTS)) {
  md.renderer.rules[`${element}_open`] = (tokens, index, options, _env, renderer) => {
    ...
    const attributesString = [...dataAttributes].map(([key, value]) => `${key}="${md.utils.escapeHtml(value)}"`).join(" ");
...
module.exports = __webpack_require__.p + "ai-chat-message.c4de16ca2ede568f4e4e.css";
...
module.exports = __webpack_require__.p + "ai-chat-table.49ec4ad059a8317ec619.css";
...
module.exports = __webpack_require__.p + "ai-chat-grid.625e5fd9ce2cc7f1a557.css";
...
module.exports = __webpack_require__.p + "moz-card.e4554b9a999fc08c22b5.css";
...
class AIChatTable extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  firstUpdated() {
    this.#scrollContainer = this.renderRoot.querySelector(".table-scroll-container");
  ...
  render() {
    return (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`
      ...
      <div class="table-wrapper">
        ...
        ${this.isOverflowing ? (0,chrome_global_content_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_1__.html)`<div class="table-scroll-indicator">
              <span
...
/* harmony import */ var chrome_browser_content_aiwindow_modules_ClientErrorTelemetry_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(73846);
/* harmony import */ var chrome_browser_content_aiwindow_components_ai_chat_card_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(20564);
/* harmony import */ var chrome_browser_content_aiwindow_components_ai_chat_grid_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(56388);
/* harmony import */ var chrome_browser_content_aiwindow_components_ai_chat_table_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(81338);
...
class AIChatMessage extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
   ...
   */
  willUpdate(changed) {
    if (changed.has("seenUrls") && this.#urlsUnfurledInMessage.intersection(this.seenUrls).size) {
  ...
  updated(changed) {
    if (changed.has("complete") && this.complete && this.role === "assistant") {
      ...
      const text = messageEl ? (messageEl.innerText || messageEl.textContent || "").replace(/\s+/g, " ").trim() : "";
      this.dispatchEvent(new CustomEvent("ai-chat-message:complete", {
        bubbles: true,
        composed: true,
        detail: {
          messageId: this.messageId,
  ...
  #isSettingsURL(parsed) {
    ...
    return parsed.protocol === AIChatMessage.#SETTINGS_URL.protocol && (parsed.pathname === AIChatMessage.#SETTINGS_URL.pathname || parsed.pathname === AIChatMessage.#SETTINGS_ALIAS_URL.pathname);
  }
  ...
  #replaceHistoryResults(root) {
    ...
    const frontierLi = this.complete ? null : allListItems[allListItems.length - 1] ?? null;
    ...
    lists.forEach((list, index) => {
      ...
      if (this.complete) {
        if (items.every(item => this.#isHistoryItem(item))) {
          const listItems = items.map(li => this.historyResults.get(li.querySelector("a[href]").href));
      ...
      const hasSettledNonHistory = items.some(li => li !== frontierLi && !this.#isHistoryItem(li));
  ...
  #getHistoryListGrid(gridItems, index) {
    ...
    const loading = items.some(item => item.thumbnail && item.image === undefined);
    ...
    this.dispatchEvent(new CustomEvent("AIChatContent:HistoryGridRender", {
      bubbles: true,
      composed: true,
      detail: {
  ...
  #requestHistoryAssets(items) {
    ...
    const requestItems = items.filter(item => item?.url).map(({
      url,
      thumbnail
    }) => ({
      url,
   ...
   */
  itemClick(item) {
    this.dispatchEvent(new CustomEvent("AIChatContent:HistoryGridItemClick", {
      bubbles: true,
      composed: true,
      detail: {
        item
  ...
  static {
    ...
    for (const {
      element,
      attributes
    } of Object.values(chrome_browser_content_aiwindow_modules_ChatMarkdownParser_mjs__WEBPACK_IMPORTED_MODULE_3__.CHAT_WRAPPER_ELEMENTS)) {
...
//# sourceMappingURL=components-ai-chat-message-ai-chat-message-stories.c446609e.iframe.bundle.js.map