...
function selectAction() {
  return (0,_vendor_lit_all_mjs__WEBPACK_IMPORTED_MODULE_0__.html)`<moz-select slot="actions" data-l10n-id="moz-box-select-action">
    <moz-option
      value="1"
      label="Option one"
...
//# sourceMappingURL=moz-box-group-moz-box-group-stories.71ca53fc.iframe.bundle.js.map