...
class TurnOnScheduledBackups extends chrome_global_content_lit_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.MozLitElement {
  ...
  handleConfirm() {
    ...
    this.dispatchEvent(new CustomEvent("BackupUI:ProbeDefaultBackupDir", {
      ...
      composed: true,
      detail: {
        parentDirPath: detail.parentDirPath
      }
    }));
  }
...
module.exports = __webpack_require__.p + "restore-from-backup.70bc6a41e7cd4ecf101d.css";
...
module.exports = __webpack_require__.p + "preferences.6fa286400b08d5d66ef2.css";
...
module.exports = __webpack_require__.p + "moz-message-bar.67ec2fc344dfeae164e7.css";
...
//# sourceMappingURL=backup-settings-stories.ba342b8b.iframe.bundle.js.map