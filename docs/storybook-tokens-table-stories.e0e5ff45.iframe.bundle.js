...
const tokensTable = {
  "background-color": [{
    ...
    value: {
      nativeTheme: "light-dark(var(--button-background-color-hover), color-mix(in srgb, currentColor 16%, transparent))",
      default: "light-dark(var(--button-background-color-hover), color-mix(in srgb, currentColor 16%, transparent))",
      browserTheme: {
        light: "white",
        dark: "rgb(66, 65, 77)",
...
//# sourceMappingURL=storybook-tokens-table-stories.e0e5ff45.iframe.bundle.js.map